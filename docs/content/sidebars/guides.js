		...
		items: [
			{
				...
				items: [
					'guides/developer/getting-started/mys-install',
			...
			{
				type: 'category',
				label: 'Your First MySocial dApp',
				link: {
					type: 'doc',
			...
			},
			{
				...
				link: {
					type: 'doc',
					id: 'guides/developer/mys-101',
				},
				items: [
					'guides/developer/mys-101/shared-owned',
					'guides/developer/mys-101/using-events',
					'guides/developer/mys-101/access-time',
					'guides/developer/mys-101/sign-and-send-txn',
					'guides/developer/mys-101/sponsor-txn',
					'guides/developer/mys-101/avoid-equivocation',
					{
						type: 'category',
						label: 'Working with PTBs',
						items: [
							'guides/developer/mys-101/building-ptb',
							'guides/developer/mys-101/coin-mgt',
							'guides/developer/mys-101/simulating-refs',
						],
					},
				],
			},
