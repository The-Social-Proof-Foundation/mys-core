...
Use a `Publisher` object that you own to set `mys::display` for a type. For more information about `Publisher` objects, see [Publisher](https://examples.mys.io/basics/publisher.html) topic in *MySocial Move by Example*.
