...
DeepBook is open for community development. You can use the [MySocial Improvement Proposals](https://github.com/mys-foundation/sips?ref=blog.mys.io) (SIPs) process to suggest changes to make DeepBook better.
