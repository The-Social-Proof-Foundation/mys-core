...
- [dapps](https://github.com/MystenLabs/mys/tree/main/dapps): Contains some examples of decentralized applications built on top of MySocial, such as Sponsored Transactions.
...
- [mys-framework](https://github.com/MystenLabs/mys/tree/main/crates/mys-framework) - Move system packages (0x1, 0x2, 0x3, 0x0b0c).
