---
title: MySocial Storage Cost
description: Historical data and the pricing of your storage solutions provide insights into the cost of your operations on the MySocial network.
---
...
Compute is a relatively fixed cost for MySocial, with hundreds of validators running 24 Core, 128GB RAM machines.

Because MySocial is capable of such high throughput compared to other blockchains, the storage costs of running the MySocial network aren't as precise.
...
- [Custom Indexers](../../guides/developer/advanced/custom-indexer.mdx): Build custom indexers using the MySocial micro-data ingestion framework.
...
- [MySocial Archives](../../guides/operator/archives.mdx): Enable archiving on your Full nodes for a historical record of all transactions on MySocial.