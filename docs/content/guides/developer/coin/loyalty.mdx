...
Using the MySocial [Closed-Loop Token](../../../standards/closed-loop-token.mdx) standard, you can create tokens that are valid only for a specific service, like an airline that wants to grant tokens to frequent flyers to purchase tickets or upgrades. 
...
- [Source code](https://github.com/MystenLabs/mys/blob/main/examples/move/token/sources/loyalty.move): The source code in GitHub for this example.
