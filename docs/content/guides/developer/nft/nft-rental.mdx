...
- [NFT Rental example](https://github.com/MystenLabs/mys/tree/main/examples/move/nft-rental): The source code that this document references.
- [MySocial Kiosk](../../../standards/kiosk.mdx): Kiosk is a decentralized system for commerce applications on MySocial.
- [Kiosk Apps](../../../standards/kiosk-apps.mdx): The Kiosk Apps standard extends the functionality of MySocial Kiosk.  
