...
- Testnet: `https://checkpoints.testnet.mys.io`
- Mainnet: `https://checkpoints.mainnet.mys.io`

The checkpoint files are stored in the following format: `https://checkpoints.testnet.mys.io/<checkpoint_id>.chk`. You can download the checkpoint file by sending an HTTP GET request to the relevant URL. Try it yourself for checkpoint 1 at [https://checkpoints.testnet.mys.io/1.chk](https://checkpoints.testnet.mys.io/1.chk).
...
executor.run(
    ...
    Some("https://checkpoints.testnet.mys.io".to_string()), // Remote Checkpoint Store
