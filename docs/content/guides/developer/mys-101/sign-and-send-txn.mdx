...
import { Secp256k1Keypair } from '@socialproof/mys/keypairs/secp256k1';
import { Secp256r1Keypair } from '@socialproof/mys/keypairs/secp256r1';
...
const kp_derive_with_path_0 = Ed25519Keypair.deriveKeypair('$MNEMONICS', "m/44'/6976'/1'/0'/0'");
const kp_derive_with_path_1 = Secp256k1Keypair.deriveKeypair('$MNEMONICS', "m/54'/6976'/1'/0/0");
const kp_derive_with_path_2 = Secp256r1Keypair.deriveKeypair('$MNEMONICS', "m/74'/6976'/1'/0/0");
