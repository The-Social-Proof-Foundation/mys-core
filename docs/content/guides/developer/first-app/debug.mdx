...
The specific bytecode offsets and the indices of the local variables might vary depending on the version of the MySocial toolchain.

:::

## Related links

- [Publish a Package](./publish.mdx): Publish the example to the MySocial network.
