...
- Concepts: [Shared Object Deletion](https://blog.mys.io/ephemeral-shared-objects/)
...
- Reference: [JSON-RPC](https://docs.mys.io/mys-api-ref)
...
3. Deploy the MySocial package
  ...
  ```sh
  $ mys client new-env --alias testnet --rpc https://fullnode.testnet.mys.io:443
  ```
