...
const config = {
  ...
  tagline:
    "MySocial is a next-generation smart contract platform with high throughput, low latency, and an asset-oriented programming model powered by Move",
  ...
  plugins: [
    ...
    [
      "@graphql-markdown/docusaurus",
      {
        ...
        baseURL: "references/mys-api/mys-graphql/reference",
        loaders: {
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/MystenLabs/mys/tree/main/docs/docs",
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: "MySocial Documentation",
        logo: {
          alt: "MySocial Docs Logo",
          src: "img/mys-logo.svg",
        },
        items: [
          {
            label: "Guides",
