...
const pillStyle =
  "p-2 border border-solid border-mys-blue-dark rounded-lg max-w-max bg-mys-ghost-white dark:bg-mys-gray-90";
...
const AnyOf = (props) => {
  ...
  return (
    <div>
      <p className="p-2 border border-solid border-mys-blue-dark rounded-lg max-w-max font-bold text-white bg-mys-blue-dark">
        Any of
      </p>
      <div className="ml-1 border-0 border-l-4 border-solid border-mys-blue-dark">
        ...
        {names &&
          names.map((name) => {
            return (
              <div
                key={name}
                className="p-4 m-4 mt-8 snap-start scroll-mt-40 border border-mys-gray-50 border-solid rounded-lg"
                id={name.toLowerCase()}
              >
                <h2>{name}</h2>
