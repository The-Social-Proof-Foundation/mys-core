...
export const Parameter = (props) => {
  ...
  return (
    <>
      <div className="grid grid-cols-6 ml-4 odd:bg-mys-ghost-white dark:odd:bg-mys-ghost-dark rounded-lg">
    ...
    <div className="border-b mb-8">
      {hasParams && (
        <div className="grid grid-cols-6 ml-4">
          ...
          <div className="p-2 bg-mys-blue dark:bg-mys-blue-dark text-mys-gray-95 dark:text-mys-gray-50 text-mys-gray-35 font-bold">
            Required
          </div>
          <div className="rounded-tr-lg rounded-br-lg col-span-3 p-2 bg-mys-blue dark:bg-mys-blue-dark text-mys-gray-95 dark:text-mys-gray-50 text-mys-gray-35 font-bold">
            Description
          </div>
        </div>
      )}
