...
const Property = (props) => {
  ...
  return (
    <div
      className={`grid grid-cols-6 ml-4 even:bg-mys-ghost-white dark:even:bg-mys-ghost-dark`}
    >
...
const Result = (props) => {
  ...
  return (
    <div className="ml-4 p-4 text-mys-gray-80 dark:text-mys-gray-50 border dark:border-mys-gray-75 rounded-lg bg-mys-ghost-white dark:bg-mys-ghost-dark">
      <p className="font-bold">
        <PropType proptype={[result.name, result.schema]}></PropType>
      </p>

      {hasDesc && !hasRef && (
        <p className="ml-4 p-2 text-mys-gray-100 dark:text-mys-gray-50 rounded-lg">
      ...
      {hasRef && hasRefProps && (
        <div className="border-b pb-4">
          <p className="font-bold mt-6 mb-2 ml-4 text-mys-gray-80 dark:text-mys-gray-50">
            Properties
          </p>
          <div className={`grid grid-cols-6 ml-4 pb-2`}>
            <div className="rounded-tl-lg rounded-bl-lg col-span-2 p-2 bg-mys-blue dark:bg-mys-blue-dark text-mys-gray-95 dark:text-mys-gray-50 font-bold">
              Name&lt;Type&gt;
            </div>
            <div className="p-2 bg-mys-blue dark:bg-mys-blue-dark text-mys-gray-95 dark:text-mys-gray-50 font-bold">
              Required
            </div>
            <div className="rounded-tr-lg rounded-br-lg col-span-3 p-2 bg-mys-blue dark:bg-mys-blue-dark text-mys-gray-95 dark:text-mys-gray-50 font-bold">
              Description
            </div>
          </div>
