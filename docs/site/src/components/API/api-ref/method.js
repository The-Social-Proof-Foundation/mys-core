        ...
        return (
          ...
          >
            <h2
              ...
              className="border-0 border-b border-solid border-mys-blue-dark dark:border-mys-blue scroll-mt-32 text-3xl text-mys-blue-dark dark:text-mys-blue font-bold mt-12 after:content-['_#'] after:hidden after:hover:inline after:opacity-20 cursor-pointer"
              onClick={handleClick}
                  ...
                  return (
                    <div
                      className={`snap-start scroll-mt-32 ${
                        method.deprecated
                          ? "bg-mys-warning-light p-8 pt-4 rounded-lg mt-8 dark:bg-mys-warning-dark"
                          : "pt-8"
                      }`}
                      key={`div-${api
                        .replaceAll(/\s/g, "-")
                    ...
                    >
                      ...
                      {method.deprecated && (
                        <div className="p-4 bg-mys-issue rounded-lg font-bold mt-4">
                          Deprecated
                        </div>
                      )}
                      <div className="">
                        ...
                        <p className="font-bold mt-4 mb-2 text-xl text-mys-grey-80 dark:text-mys-gray-70">
                          Parameters
                        </p>
                        <Parameters
                          ...
                          schemas={schemas}
                        />
                        <p className="font-bold mb-2 text-xl text-mys-gray-80 dark:text-mys-gray-70">
                          Result
                        </p>
                        <Result result={method.result} json={json} />
                        {method.examples && (
                          <>
                            <p className="mt-4 font-bold text-xl text-mys-gray-80 dark:text-mys-gray-70">
                              Example
                            </p>
