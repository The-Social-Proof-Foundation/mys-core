...
const Examples = (props) => {
  ...
  return (
    <div className="mx-4">
      ...
      {examples[0].params && (
        <div>
          <p className="font-bold mt-4 text-mys-gray-80 dark:text-mys-gray-50">
            Request
          </p>
          <pre className="p-2 pb-0 max-h-96	dark:bg-mys-ghost-dark bg-mys-ghost-white rounded-lg mt-4 overflow-x-auto border dark:border-mys-gray-75">
      ...
      {examples[0].result.value && (
        <div>
          <p className="font-bold mt-6 text-mys-gray-80 dark:text-mys-gray-50">
            Response
          </p>
          <pre className="p-2 pb-0 max-h-96 dark:bg-mys-ghost-dark bg-mys-ghost-white rounded-lg mt-4 overflow-x-auto border dark:border-mys-gray-75">
            <code className="text-base">
