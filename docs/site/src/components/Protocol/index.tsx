...
export default function Protocol(props) {
  ...
  return (
    <div
      className={`max-xl:hidden sticky top-16 py-4 -mx-4 z-10 backdrop-blur-sm border-mys-ghost-white dark:border-mys-ghost-dark ${belowFold ? "border-solid border-x-0 border-t-0 border-b" : ""}`}
    >
      <style>
        {`
          h2, h3 {
      ...
      <label
        className="m-2 text-xs bg-mys-white rounded-lg backdrop-blur-none"
        htmlFor="proto"
      >
        Proto files
      </label>
