...
const BRIDGE_PATH = path.join(
  __dirname,
  "../../../../../crates/mys-framework/docs/bridge",
);
const FRAMEWORK_PATH = path.join(
  __dirname,
  "../../../../../crates/mys-framework/docs/mys",
);
...
const MYSSYS_PATH = path.join(
  __dirname,
  "../../../../../crates/mys-framework/docs/mys_system",
);
                ...
                fs.writeFile(
                  ...
                  JSON.stringify({
                    ...
                    link: {
                      ...
                      description: `Documentation for the modules in the mys/crates/mys-framework/packages/${part} crate. Select a module from the list to see its details.`,
                    },
                  }),
                  "utf8",
                  (err) => {
