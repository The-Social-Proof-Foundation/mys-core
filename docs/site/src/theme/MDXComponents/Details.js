...
export default function MDXDetails(props) {
  ...
  return (
    <div className="relative">
      <span
        className={`absolute rounded -top-3 -left-1 text-xs bg-white dark:bg-mys-gray-95 px-2 py-0.5 border border-mys-gray-65 border-solid ${hover ? "opacity-100" : "opacity-0"} duration-300 transition-opacity`}
      >
      ...
      <Details
        ...
        className={`${props.className || ""} bg-mys-gray-45 !border-mys-gray-65 dark:bg-mys-gray-90 dark:border-mys-gray-65`}
      >
        {children}
      </Details>
    </div>
