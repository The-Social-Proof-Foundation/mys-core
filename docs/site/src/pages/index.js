...
export default function Home() {
  ...
  return (
    <Layout>
      <div className="bg-mys-black overflow-hidden">
        <div className="w-full mt-24 mb-12 mx-auto bg-mys-black">
          <div className={styles.heroText}>
            <h1 className="h1 center-text text-white">MySocial Documentation</h1>
            <h2 className="h2 text-gray center-text h3">
              Discover the power of MySocial through examples, guides, and concepts
            </h2>
          </div>
        </div>
        <div className="flex flex-row flex-wrap justify-center gap-2 max-w-[1066px] mx-auto">
          <HomeCard title="Developers">
            ...
            <Link className={styles.cardLink} to="./guides/developer/mys-101">
              MySocial Developer Basics
            </Link>
            <Link className={styles.cardLink} to="./concepts/mys-move-concepts">
              Move
            </Link>
          </HomeCard>
          <HomeCard title="Validators and Node operators">
            ...
            <Link
              className={styles.cardLink}
              to="./guides/operator/mys-full-node"
            >
              Run a MySocial Full node
            ...
            >
              MySocial Bridge Node configuration
            </Link>
          </HomeCard>
          <HomeCard title="About MySocial">
          ...
          <HomeCard title="References" aux>
            ...
            <Link className={styles.cardLink} to="/references/mys-api">
              MySocial API
            </Link>
            <Link
              className={styles.cardLink}
              to="https://github.com/MystenLabs/mys/tree/main/crates/mys-framework/docs"
            >
              MySocial framework (GitHub)
            </Link>
            <Link
              className={styles.cardLink}
              to="https://github.com/MystenLabs/mys/tree/main/crates/mys-sdk"
            >
              Rust SDK (GitHub)
            </Link>
          </HomeCard>
          <HomeCard title="Resources" aux>
            <Link
              className={styles.cardLink}
              to="https://mys.directory/?_project_type=api%2Cdeveloper-tools%2Cinfrastructure%2Csdk"
            >
          ...
          <HomeCardCTA>
            ...
            >
              <span>Build your dApp on MySocial</span>
              <svg
                width="11"
                height="11"
                viewBox="0 0 11 11"
        ...
        <div className={styles.sectionHeader}>
          <h2 className="h1 text-white font-twkeverett">Why MySocial?</h2>
          <h3 className="h3 text-gray text-center">
            MySocial is the first internet-scale programmable blockchain platform
          </h3>
        </div>
        ...
        <div className={styles.TwoColParagraph}>
          <div className={styles.TwoColItem}>
            ...
            <p>
              MySocial scales horizontally to meet the demands of applications.
              Network capacity grows in proportion to the increase in MySocial
          ...
          <div className={styles.TwoColItem}>
            ...
            <p>
              MySocial aims to be the most accessible smart contract platform,
              empowering developers to create great user experiences in web3. To
              usher in the next billion users, MySocial empowers developers with
              various tools to take advantage of the power of the MySocial
              blockchain. The MySocial Development Kit (SDK) will enable developers
