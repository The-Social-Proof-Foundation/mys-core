...
This script offers backward compatibiltiy, but ideally, you should migrate to mys start instead. Use mys start --help to see all the flags and options. 

To recreate the exact basic functionality of mys-test-validator, you must use the following options:
...
# Basic command that replicates the command line arguments of mys-test-validator
cmd="mys start --with-faucet --force-regenesis"
