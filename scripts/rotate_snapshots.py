...
for example, /opt/mys, it assumes snapshots are staged in /opt/mys/snapshots,
and all symlinks to said snapshots are contained under /opt/mys/instances. It will delete all snapshots that are not
...
def usage():
    ...
    print(
        f'   --dir=<mys-base-dir>   Base directory for mys. Must contain /snapshots and /instances dirs')
