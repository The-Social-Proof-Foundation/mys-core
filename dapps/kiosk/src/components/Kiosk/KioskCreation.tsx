	...
	return (
		<div className="min-h-[70vh] container py-24 gap-4 mt-6">
			<div className="lg:w-7/12 mx-auto">
				<h2 className="font-bold text-3xl mb-6">Create a Mys Kiosk</h2>
				<p className="pb-3">
					<strong>There’s no kiosk for your address yet.</strong> Create a kiosk to store your
					digital assets and list them for sale on the Mys network. Anyone can view your kiosk and
					the assets you place in it.
				</p>
				<p className="pb-3">
					The demo app works only on <strong>Mys Testnet.</strong> Make sure that your wallet
