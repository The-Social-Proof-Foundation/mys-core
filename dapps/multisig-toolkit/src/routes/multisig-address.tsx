...
import { publicKeyFromMysBytes } from '@mysten/mys/verify';
	...
	const onSubmit = (data: FieldValues) => {
		try {
			...
			data.pubKeys.forEach((item: any) => {
				const pk = publicKeyFromMysBytes(item.pubKey);
			...
			const multisigMysAddress = multiSigPublicKey.toMysAddress();
			setMSAddress(multisigMysAddress);
		} catch (e: any) {
	...
	return (
		<div className="flex flex-col gap-4">
			...
			<form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
				<p>The following demo allow you to create Mys MultiSig addresses.</p>
				<code className="overflow-x-auto">
					Mys Pubkeys for playing with
...
/*
➜  multisig-toolkit git:(jnaulty/multisig-create-address) ✗ mys keytool multi-sig-address --pks ABr818VXt+6PLPRoA7QnsHBfRpKJdWZPjt7ppiTl6Fkq ANRdB4M6Hj73R+gRM4N6zUPNidLuatB9uccOzHBc/0bP --weights 1 2 --threshold 2
MultiSig address: 0x27b17213bc702893bb3e92ba84071589a6331f35f066ad15b666b9527a288c16
Participating parties:
                Mys Address                 |                Public Key (Base64)                 | Weight
----------------------------------------------------------------------------------------------------
...
➜  multisig-toolkit git:(jnaulty/multisig-create-address) ✗ mys keytool multi-sig-address --pks ABr818VXt+6PLPRoA7QnsHBfRpKJdWZPjt7ppiTl6Fkq ANRdB4M6Hj73R+gRM4N6zUPNidLuatB9uccOzHBc/0bP --weights 1 1 --threshold 2
...
➜  multisig-toolkit git:(jnaulty/multisig-create-address) ✗ mys keytool multi-sig-address --pks ABr818VXt+6PLPRoA7QnsHBfRpKJdWZPjt7ppiTl6Fkq ANRdB4M6Hj73R+gRM4N6zUPNidLuatB9uccOzHBc/0bP --weights 1 1 --threshold 1
