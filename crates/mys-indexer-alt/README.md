...
diesel setup                                                                       \
    --database-url="postgres://postgres:postgrespw@localhost:5432/mys_indexer_alt" \
    --migration-dir ../mys-indexer-alt-schema/migrations
```
...
cargo nextest run                \
    -p mys-indexer-alt           \
    -p mys-indexer-alt-framework \
    -p mys-indexer-alt-e2e-tests
```
...
```sh
cargo run --bin mys-indexer-alt -- generate-config > indexer_alt_config.toml
```
...
```sh
cargo run --bin mys-indexer-alt -- indexer               \
  --database-url {url}                                   \
