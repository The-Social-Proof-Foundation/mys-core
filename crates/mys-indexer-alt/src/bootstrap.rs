...
use mys_indexer_alt_framework::postgres::Db;
use mys_indexer_alt_framework::types::full_checkpoint_content::Checkpoint;
use mys_indexer_alt_framework::types::mys_system_state::MysSystemStateTrait;
use mys_indexer_alt_framework::types::mys_system_state::get_mys_system_state;
use mys_indexer_alt_framework::types::transaction::TransactionKind;
...
use mys_indexer_alt_schema::schema::kv_genesis;
...
pub async fn bootstrap(
    ...
    let BootstrapGenesis {
        ...
        None => {
            ...
            let mys_system_state = get_mys_system_state(&output_objects.as_slice())
            ...
            let stored_genesis = StoredGenesis {
                ...
                initial_protocol_version: mys_system_state.protocol_version() as i64,
            };
            let stored_epoch_start = StoredEpochStart {
                epoch: 0,
                protocol_version: mys_system_state.protocol_version() as i64,
                cp_lo: 0,
                start_timestamp_ms: mys_system_state.epoch_start_timestamp_ms() as i64,
                reference_gas_price: mys_system_state.reference_gas_price() as i64,
                system_state: bcs::to_bytes(&mys_system_state)
