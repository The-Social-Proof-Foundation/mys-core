...
use mys_indexer_alt_framework::types::effects::TransactionEffects;
...
pub(crate) fn affected_addresses(effects: &TransactionEffects) -> impl Iterator<Item = MysAddress> {
    effects
        .all_changed_objects()
        .into_iter()
