...
use mys_indexer_alt_framework::types::full_checkpoint_content::ExecutedTransaction;
use mys_indexer_alt_framework::types::transaction::TransactionDataAPI;
use mys_indexer_alt_schema::blooms::should_skip_for_bloom;
use mys_indexer_alt_schema::cp_blooms::CpBloomFilter;
use mys_indexer_alt_schema::cp_blooms::MAX_FOLD_DENSITY;
use mys_indexer_alt_schema::cp_blooms::MIN_FOLD_BYTES;
use mys_indexer_alt_schema::cp_blooms::StoredCpBlooms;
use mys_indexer_alt_schema::schema::cp_blooms;
...
mod tests {
    ...
    async fn test_cp_blooms_with_function_calls() {
        ...
        let mut builder = TestCheckpointBuilder::new(0);
        builder = builder
            .start_transaction(1) // Use sender_idx=1 to avoid MysAddress::ZERO which is filtered out
    ...
    async fn test_cp_blooms_filter_accuracy() {
        ...
        let random_addr = MysAddress::random_for_testing_only();
        assert!(
