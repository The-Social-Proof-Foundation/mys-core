...
{%- for instance in mys_event_instances %}

{%- set S = "'" ~ instance.suffix ~ "'" -%}
{%- set T = instance.name -%}

// ----------------------------------------------------------------------------------
// Native MySocial event implementation for object type `{{instance.suffix}}`
...
{%- for instance in mys_types_instances %}

{%- set S = "'" ~ instance.suffix ~ "'" -%}
{%- set T = instance.name -%}

// ----------------------------------------------------------------------------------
// Native MySocial types implementation for object type `{{instance.suffix}}`
...
// ----------------------------------------------------------------------------------
// Native MySocial prover implementation for object type `{{instance.suffix}}`
