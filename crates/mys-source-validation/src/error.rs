...
use mys_json_rpc_types::MysRawMoveObject;
use mys_package_management::PublishedAtError;
use mys_sdk::error::Error as SdkError;
use mys_types::{base_types::ObjectID, error::MysObjectResponseError};
...
pub enum Error {
    ...
    #[error("Dependency ID contains a Mys object, not a Move package: {0}")]
    ObjectFoundWhenPackageExpected(ObjectID, MysRawMoveObject),
    ...
    MysObjectRefFailure(MysObjectResponseError),
