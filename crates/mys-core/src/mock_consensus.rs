...
use mys_types::transaction::{VerifiedCertificate, VerifiedTransaction};
...
impl MockConsensusClient {
    ...
    fn submit_impl(&self, transactions: &[ConsensusTransaction]) -> MysResult<BlockStatusReceiver> {
