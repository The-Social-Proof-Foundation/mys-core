...
use mys_types::crypto::{AccountKeyPair, AuthorityPublicKeyBytes, Signer};
use mys_types::effects::{SignedTransactionEffects, TestEffectsBuilder};
...
pub fn make_transfer_mys_transaction(
...
pub fn make_pay_mys_transaction(
    gas_object: ObjectRef,
    coins: Vec<ObjectRef>,
    ...
    let data = TransactionData::new_pay_mys(
