...
use mys_json_rpc_types::{
    EffectsWithInput, EventFilter, MysTransactionBlockEffects, MysTransactionBlockEvents,
    TransactionFilter,
};
use mys_json_rpc_types::{MysEvent, MysTransactionBlockEffectsAPI};
...
pub struct SubscriptionHandler {
    event_streamer: Streamer<MysEvent, MysEvent, EventFilter>,
    transaction_streamer: Streamer<EffectsWithInput, MysTransactionBlockEffects, TransactionFilter>,
}
...
impl SubscriptionHandler {
    ...
    pub fn subscribe_events(&self, filter: EventFilter) -> impl Stream<Item = MysEvent> {
    ...
    ) -> impl Stream<Item = MysTransactionBlockEffects> {
