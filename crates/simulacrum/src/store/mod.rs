...
use mys_types::transaction::InputObjects;
use mys_types::transaction::ObjectReadResult;
...
pub trait SimulatorStore:
    mys_types::storage::BackingPackageStore
    + mys_types::storage::ObjectStore
    + ParentSync
    + ChildObjectResolver
{
    ...
    ) -> MysResult<(InputObjects, ReceivingObjects)> {
