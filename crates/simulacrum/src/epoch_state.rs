...
use mys_types::{
    ...
    mys_system_state::{
        epoch_start_mys_system_state::{EpochStartSystemState, EpochStartSystemStateTrait},
        MysSystemState, MysSystemStateTrait,
    },
...
impl EpochState {
    pub fn new(system_state: MysSystemState) -> Self {
        let epoch_start_state = system_state.into_epoch_start_state();
        let committee = epoch_start_state.get_mys_committee();
        let protocol_config =
    ...
    pub fn execute_transaction(
        ...
        MysGasStatus,
        TransactionEffects,
        Result<(), mys_types::error::ExecutionError>,
    )> {
        ...
        // for signing
        let (gas_status, checked_input_objects) = mys_transaction_checks::check_transaction_input(
            &self.protocol_config,
            self.epoch_start_state.reference_gas_price(),
