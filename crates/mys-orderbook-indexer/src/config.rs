...
pub struct IndexerConfig {
    ...
    pub orderbook_package_id: String,
    pub orderbook_genesis_checkpoint: u64,
    pub concurrency: u64,
    pub metric_port: u16,
...
impl IndexerConfig {
    ...
    pub fn from_env() -> anyhow::Result<Self> {
        Ok(Self {
            ...
            orderbook_package_id: env::var("ORDERBOOK_PACKAGE_ID")
                .expect("ORDERBOOK_PACKAGE_ID must be set"),
            orderbook_genesis_checkpoint: env::var("ORDERBOOK_GENESIS_CHECKPOINT")
