...
#[derive(Clone, Debug)]
pub struct OrderBookIndexerMetrics {
    pub(crate) total_orderbook_transactions: IntCounter,
...
impl OrderBookIndexerMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            total_orderbook_transactions: register_int_counter_with_registry!(
                "orderbook_indexer_total_orderbook_transactions",
                "Total number of orderbook transactions",
                registry,
            )
            .unwrap(),
            backfill_tasks_remaining_checkpoints: register_int_gauge_vec_with_registry!(
                "orderbook_indexer_backfill_tasks_remaining_checkpoints",
            ...
            tasks_processed_checkpoints: register_int_counter_vec_with_registry!(
                "orderbook_indexer_tasks_processed_checkpoints",
            ...
            inflight_live_tasks: register_int_gauge_vec_with_registry!(
                "orderbook_indexer_inflight_live_tasks",
            ...
            tasks_latest_retrieved_checkpoints: register_int_gauge_vec_with_registry!(
                "orderbook_indexer_tasks_latest_retrieved_checkpoints",
            ...
            timescale_chunks_total: register_int_gauge_vec_with_registry!(
                "orderbook_indexer_timescale_chunks_total",
            ...
            timescale_compressed_chunks: register_int_gauge_vec_with_registry!(
                "orderbook_indexer_timescale_compressed_chunks",
            ...
            timescale_insert_rate: register_int_counter_vec_with_registry!(
                "orderbook_indexer_timescale_insert_rate",
            ...
            timescale_query_performance: register_int_gauge_with_registry!(
                "orderbook_indexer_timescale_query_performance_ms",
...
impl IndexerMetricProvider for OrderBookIndexerMetrics {
