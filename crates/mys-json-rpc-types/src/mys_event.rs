...
use mys_types::event::{Event, EventEnvelope, EventID};
...
pub type EventPage = Page<MysEvent, EventID>;
...
impl From<EventEnvelope> for MysEvent {
...
impl From<MysEvent> for Event {
    fn from(val: MysEvent) -> Self {
        Event {
...
impl Filter<MysEvent> for EventFilter {
    fn matches(&self, item: &MysEvent) -> bool {
