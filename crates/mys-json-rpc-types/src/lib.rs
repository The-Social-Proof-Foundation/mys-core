...
pub struct DynamicFieldInfo {
    pub name: mys_types::dynamic_field::DynamicFieldName,
    #[serde(flatten)]
    pub bcs_name: BcsName,
    pub type_: mys_types::dynamic_field::DynamicFieldType,
    pub object_type: String,
    pub object_id: ObjectID,
    pub version: mys_types::base_types::SequenceNumber,
    pub digest: mys_types::digests::ObjectDigest,
}

impl From<mys_types::dynamic_field::DynamicFieldInfo> for DynamicFieldInfo {
    fn from(
        mys_types::dynamic_field::DynamicFieldInfo {
            name,
            bcs_name,
            type_,
            object_type,
