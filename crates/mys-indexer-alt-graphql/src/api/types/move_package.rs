...
use serde::Serialize;
use mys_indexer_alt_reader::packages::CheckpointBoundedOriginalPackageKey;
use mys_indexer_alt_reader::packages::PackageOriginalIdKey;
use mys_indexer_alt_reader::packages::VersionedOriginalPackageKey;
use mys_indexer_alt_reader::pg_reader::PgReader;
use mys_indexer_alt_schema::packages::StoredPackage;
use mys_indexer_alt_schema::schema::kv_packages;
use mys_package_resolver::Package as ParsedMovePackage;
use mys_pg_db::sql;
use mys_sql_macro::query;
use mys_types::base_types::ObjectID;
use mys_types::base_types::MysAddress as NativeMysAddress;
use mys_types::move_package::MovePackage as NativeMovePackage;
...
impl MovePackage {
    ...
    pub(crate) fn address_impl(&self) -> NativeMysAddress {
        self.super_.super_.address
    }
