...
pub(crate) async fn verify_signature(
    ...
    let jwk_object = DynamicField::by_serialized_name(
        ctx,
        scope,
        MYS_AUTHENTICATOR_STATE_ADDRESS.into(),
