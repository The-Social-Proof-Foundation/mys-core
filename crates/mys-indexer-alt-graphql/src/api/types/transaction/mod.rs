...
/// Description of a transaction, the unit of activity on Mys.
#[Object]
impl Transaction {
...
impl TransactionContents {
    ...
    async fn sender(&self) -> Option<Result<Address, RpcError>> {
        async {
            ...
            Ok((sender != NativeMysAddress::ZERO)
...
async fn tx_affected_address(
    ...
    mut query: Query<'_>,
    page: &Page<CTransaction>,
    affected_address: MysAddress,
    sent_address: Option<MysAddress>,
