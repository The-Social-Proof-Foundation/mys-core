...
use mys_indexer_alt_reader::kv_loader::TransactionContents as NativeTransactionContents;
use mys_indexer_alt_reader::pg_reader::PgReader;
use mys_indexer_alt_reader::tx_balance_changes::TxBalanceChangeKey;
use mys_indexer_alt_schema::transactions::BalanceChange as StoredBalanceChange;
...
use mys_types::execution_status::ExecutionStatus as NativeExecutionStatus;
            ...
            let programmable_tx =
                content
                    ...
                    .and_then(|tx_data| match tx_data.into_kind() {
                        mys_types::transaction::TransactionKind::ProgrammableTransaction(tx) => {
                            Some(tx)
                        }
                        _ => None,
                    });
