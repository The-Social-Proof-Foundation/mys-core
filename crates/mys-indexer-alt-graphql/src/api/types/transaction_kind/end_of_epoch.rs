...
use mys_types::digests::ChainIdentifier as NativeChainIdentifier;
use mys_types::transaction::AuthenticatorStateExpire as NativeAuthenticatorStateExpire;
use mys_types::transaction::EndOfEpochTransactionKind as NativeEndOfEpochTransactionKind;
...
impl EndOfEpochTransactionKind {
    pub fn from(kind: NativeEndOfEpochTransactionKind, scope: Scope) -> Self {
        ...
        match kind {
            ...
            // Variants not yet available in mys-types EndOfEpochTransactionKind
