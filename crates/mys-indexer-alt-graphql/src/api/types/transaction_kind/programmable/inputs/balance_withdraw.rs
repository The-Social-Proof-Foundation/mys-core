...
use mys_types::transaction::FundsWithdrawalArg as NativeFundsWithdrawalArg;
use mys_types::transaction::Reservation as NativeReservation;
use mys_types::transaction::WithdrawFrom as NativeWithdrawFrom;
use mys_types::transaction::WithdrawalTypeArg as NativeWithdrawalTypeArg;
use mys_types::type_input::StructInput;
...
pub struct BalanceWithdraw {
    ...
    /// The type of the funds accumulator to withdraw from (e.g. `0x2::balance::Balance<0x2::mys::MYS>`).
    #[graphql(name = "type")]
