...
use mys_types::messages_consensus::ConsensusCommitPrologue as NativeConsensusCommitPrologueV1;
use mys_types::messages_consensus::ConsensusCommitPrologueV2 as NativeConsensusCommitPrologueV2;
use mys_types::messages_consensus::ConsensusCommitPrologueV3 as NativeConsensusCommitPrologueV3;

// V4 types not yet available in mys-types - using stub type for compilation
type AdditionalConsensusStateDigest = mys_types::digests::Digest;
...
impl ConsensusCommitPrologueTransaction {
    ...
    // V4 not yet available in mys-types TransactionKind
