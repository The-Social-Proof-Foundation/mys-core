...
use mys_types::transaction::TransactionKind as NativeTransactionKind;
...
/// Different types of transactions that can be executed on the Mys network.
#[derive(Union, Clone)]
...
impl TransactionKind {
    pub fn from(kind: NativeTransactionKind, scope: Scope) -> Option<Self> {
        ...
        match kind {
            ...
            // ProgrammableSystemTransaction not yet available in mys-types TransactionKind
