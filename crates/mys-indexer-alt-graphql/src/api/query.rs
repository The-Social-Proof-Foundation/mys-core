...
use mys_indexer_alt_reader::fullnode_client::Error::GrpcExecutionError;
...
impl Query {
    ...
    ///
    /// Accepts a JSON transaction matching the [Mys gRPC API schema](https://docs.mysocial.network/references/fullnode-protocol#mys-rpc-v2-Transaction).
