...
pub struct RpcConfig {
    ...
    /// Configure for MysNS related RPC methods.
...
pub struct NameServiceLayer {
    pub package_address: Option<MysAddress>,
...
impl Limits {
    ...
    pub(crate) fn package_resolver(&self) -> mys_package_resolver::Limits {
    ...
    pub(crate) fn display(&self) -> mys_display::v2::Limits {
        mys_display::v2::Limits {
...
impl Default for Limits {
    fn default() -> Self {
        ...
        let display_limits = mys_display::v2::Limits::default();
        ...
        Self {
            ...
            //
            // <https://github.com/MystenLabs/sui/blob/eaf05fe5d293c06e3a2dfc22c87ba2aef419d8ea/crates/mys-core/src/authority_aggregator.rs#L84-L85>
