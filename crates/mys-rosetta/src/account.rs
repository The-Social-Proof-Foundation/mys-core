...
use mys_sdk::rpc_types::StakeStatus;
...
async fn get_checkpoint(ctx: &OnlineServerContext) -> MysRpcResult<CheckpointSequenceNumber> {
    ctx.client
        .read_api()
