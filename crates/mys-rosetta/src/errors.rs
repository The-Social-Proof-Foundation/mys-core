...
/// Mys-Rosetta specific error types.
/// This contains all the errors returns by the mys-rosetta server.
...
pub enum Error {
    ...
    #[error(transparent)]
    MysRpcError(#[from] mys_sdk::error::Error),
    #[error(transparent)]
