...
pub async fn start_rosetta_test_server(client: MysClient) -> (RosettaClient, Vec<JoinHandle<()>>) {
    let online_server = RosettaOnlineServer::new(MysEnv::LocalNet, client);
    let offline_server = RosettaOfflineServer::new(MysEnv::LocalNet);
...
impl RosettaClient {
    ...
    pub async fn rosetta_flow(
        ...
        let network_identifier = NetworkIdentifier {
            blockchain: "mys".to_string(),
            network: MysEnv::LocalNet,
        };
        // Preprocess
            ...
            .call(
                ...
                &ConstructionCombineRequest {
                    ...
                    signatures: vec![Signature {
                        ...
                        hex_bytes: Hex::from_bytes(MysSignature::signature_bytes(&signature)),
                    }],
                },
            )
            .await;
