...
pub fn mys_rpc_doc(version: &str) -> Project {
    Project::new(
        version,
        "Mys JSON-RPC",
...
impl JsonRpcServerBuilder {
    ...
    pub fn register_module<T: MysRpcModule>(&mut self, module: T) -> Result<(), Error> {
