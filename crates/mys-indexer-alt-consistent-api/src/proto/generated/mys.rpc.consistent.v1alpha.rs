...
pub struct ListBalancesRequest {
    ...
    /// this value.
    ///
    /// Consult `mys.rpc.consistent.v1alpha/ServiceConfig` for default and maximum
    /// page sizes.
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/mys.rpc.consistent.v1alpha.ConsistentService/AvailableRange",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "mys.rpc.consistent.v1alpha.ConsistentService",
                        "AvailableRange",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.rpc.consistent.v1alpha.ConsistentService/BatchGetBalances",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn get_balance(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.rpc.consistent.v1alpha.ConsistentService/GetBalance",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.rpc.consistent.v1alpha.ConsistentService/ListBalances",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.rpc.consistent.v1alpha.ConsistentService/ListObjectsByType",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.rpc.consistent.v1alpha.ConsistentService/ListOwnedObjects",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.rpc.consistent.v1alpha.ConsistentService/ServiceConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod consistent_service_server {
    ...
    pub const SERVICE_NAME: &str = "mys.rpc.consistent.v1alpha.ConsistentService";
