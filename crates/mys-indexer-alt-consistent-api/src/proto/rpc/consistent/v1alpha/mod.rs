...
include!("../../../generated/mys.rpc.consistent.v1alpha.rs");

// Byte encoded `FILE_DESCRIPTOR_SET`.
pub const FILE_DESCRIPTOR_SET: &[u8] =
    include_bytes!("../../../generated/mys.rpc.consistent.v1alpha.fds.bin");
...
pub const CHECKPOINT_METADATA: &str = "x-mys-checkpoint";
