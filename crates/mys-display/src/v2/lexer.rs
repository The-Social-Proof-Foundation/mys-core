...
mod tests {
    ...
    #[test]
    fn test_types() {
        assert_snapshot!(text(r#"{0x2::table::Table<address, 0x2::coin::Coin<0x2::mys::MYS>>}"#), @r###"
        L(false, LBrace, 0, "{")
        L(false, NumHex, 3, "2")
        L(false, CColon, 4, "::")
        ...
        L(false, NumHex, 46, "2")
        L(false, CColon, 47, "::")
        L(false, Ident, 49, "mys")
        L(false, CColon, 52, "::")
        L(false, Ident, 54, "MYS")
        L(false, RAngle, 57, ">")
        L(false, RAngle, 58, ">")
        L(false, RBrace, 59, "}")
        "###);
    ...
    fn test_positional_struct_literals() {
        assert_snapshot!(text(r#"{0x2::balance::Balance<0x2::mys::MYS>(42u64)}"#), @r###"
        L(false, LBrace, 0, "{")
        L(false, NumHex, 3, "2")
        L(false, CColon, 4, "::")
        ...
        L(false, NumHex, 25, "2")
        L(false, CColon, 26, "::")
        L(false, Ident, 28, "mys")
        L(false, CColon, 31, "::")
        L(false, Ident, 33, "MYS")
        L(false, RAngle, 36, ">")
        L(false, LParen, 37, "(")
    ...
    fn test_struct_literals() {
        assert_snapshot!(text(r#"{0x2::coin::Coin<0x2::mys::MYS> { id: @0x123, value: 42u64 }}"#), @r###"
        L(false, LBrace, 0, "{")
        L(false, NumHex, 3, "2")
        L(false, CColon, 4, "::")
        ...
        L(false, NumHex, 19, "2")
        L(false, CColon, 20, "::")
        L(false, Ident, 22, "mys")
        L(false, CColon, 25, "::")
        L(false, Ident, 27, "MYS")
        L(false, RAngle, 30, ">")
        L(true, LBrace, 32, "{")
        L(true, Ident, 34, "id")
        L(false, Colon, 36, ":")
