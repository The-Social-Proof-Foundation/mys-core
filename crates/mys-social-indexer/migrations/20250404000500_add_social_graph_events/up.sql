...
CREATE INDEX IF NOT EXISTS idx_social_graph_events_follower_id ON social_graph_events(follower_id);
CREATE INDEX IF NOT EXISTS idx_social_graph_events_following_id ON social_graph_events(following_id);
