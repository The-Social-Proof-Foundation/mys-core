...
use crate::db::query_types::{ProposalTypeResult, DelegateVoteResult};
use crate::events::governance_event_types::*;
use crate::events::event_utils::parse_json_event;
use crate::models::governance::*;
use crate::{
    GOVERNANCE_STATUS_SUBMITTED, GOVERNANCE_STATUS_COMMUNITY_VOTING,
    GOVERNANCE_STATUS_APPROVED, GOVERNANCE_STATUS_REJECTED, GOVERNANCE_STATUS_IMPLEMENTED, 
    GOVERNANCE_STATUS_OWNER_RESCINDED, NOMINEE_STATUS_PENDING, NOMINEE_STATUS_ELECTED,
};
...
pub async fn process_governance_registry_event(
    ...
    let result = diesel::insert_into(crate::schema::governance_registries::table)
        ...
        .set((
            ...
            crate::schema::governance_registries::delegate_term_epochs.eq(new_registry.delegate_term_epochs),
            crate::schema::governance_registries::proposal_submission_cost.eq(new_registry.proposal_submission_cost),
            crate::schema::governance_registries::min_on_chain_age_days.eq(new_registry.min_on_chain_age_days),
            crate::schema::governance_registries::max_votes_per_user.eq(new_registry.max_votes_per_user),
            crate::schema::governance_registries::quadratic_base_cost.eq(new_registry.quadratic_base_cost),
            crate::schema::governance_registries::voting_period_epochs.eq(new_registry.voting_period_epochs),
    ...
    info!("Processed governance registry event: {} rows affected", result);
...
pub async fn process_delegate_nominated_event(
    ...
    let result = diesel::insert_into(crate::schema::nominated_delegates::table)
        ...
        .set((
            ...
            crate::schema::nominated_delegates::scheduled_term_start_epoch.eq(new_nominee.scheduled_term_start_epoch),
    ...
    info!("Processed delegate nomination event: {} rows affected", result);
        ...
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                diesel::update(crate::schema::nominated_delegates::table)
                    .filter(
                        crate::schema::nominated_delegates::address.eq(&elected_event.address)
                        .and(crate::schema::nominated_delegates::registry_type.eq(elected_event.registry_type as i16))
                    )
                    .set((
                        crate::schema::nominated_delegates::status.eq(NOMINEE_STATUS_ELECTED as i16),
                        crate::schema::nominated_delegates::upvotes.eq(elected_event.upvotes as i64),
                        crate::schema::nominated_delegates::downvotes.eq(elected_event.downvotes as i64),
                    ))
                    .execute(tx_conn)
                    .await?;
                ...
                if voted_event.is_active_delegate {
                    ...
                    if voted_event.upvote {
                        diesel::update(crate::schema::delegates::table)
                            .filter(
                                crate::schema::delegates::address.eq(&voted_event.target_address)
                                .and(crate::schema::delegates::registry_type.eq(voted_event.registry_type as i16))
                            )
                            .set(crate::schema::delegates::upvotes.eq(crate::schema::delegates::upvotes + 1))
                            .execute(tx_conn)
                            .await?;
                    } else {
                        diesel::update(crate::schema::delegates::table)
                            ...
                            .set(crate::schema::delegates::downvotes.eq(crate::schema::delegates::downvotes + 1))
                            .execute(tx_conn)
                            .await?;
                    }
                } else {
                    ...
                    if voted_event.upvote {
                        diesel::update(crate::schema::nominated_delegates::table)
                            .filter(
                                crate::schema::nominated_delegates::address.eq(&voted_event.target_address)
                                .and(crate::schema::nominated_delegates::registry_type.eq(voted_event.registry_type as i16))
                            )
                            .set(crate::schema::nominated_delegates::upvotes.eq(crate::schema::nominated_delegates::upvotes + 1))
                            .execute(tx_conn)
                            .await?;
                    } else {
                        diesel::update(crate::schema::nominated_delegates::table)
                            ...
                            .set(crate::schema::nominated_delegates::downvotes.eq(crate::schema::nominated_delegates::downvotes + 1))
                            .execute(tx_conn)
                            .await?;
                    }
                }
...
pub async fn process_proposal_submitted_event(
    ...
    info!("Processed proposal submitted event: {} rows affected", result);
    
    // Also update the delegate's proposals_submitted count
    diesel::update(crate::schema::delegates::table)
        .filter(
            crate::schema::delegates::address.eq(&proposal_event.submitter)
            .and(crate::schema::delegates::registry_type.eq(proposal_event.proposal_type as i16))
            .and(crate::schema::delegates::is_active.eq(true))
        )
        .set(
            crate::schema::delegates::proposals_submitted.eq(
                crate::schema::delegates::proposals_submitted + 1
            )
        )
        .execute(conn)
        .await?;
            ...
            Box::pin(async move {
                ...
                if vote_event.approve {
                    diesel::update(crate::schema::proposals::table)
                        ...
                        .set(crate::schema::proposals::delegate_approval_count.eq(crate::schema::proposals::delegate_approval_count + 1))
                        .execute(tx_conn)
                        .await?;
                } else {
                    diesel::update(crate::schema::proposals::table)
                        .filter(crate::schema::proposals::id.eq(&vote_event.proposal_id))
                        .set(crate::schema::proposals::delegate_rejection_count.eq(crate::schema::proposals::delegate_rejection_count + 1))
                        .execute(tx_conn)
                        .await?;
                }
                ...
                diesel::update(crate::schema::delegates::table)
                    .filter(
                        crate::schema::delegates::address.eq(&vote_event.delegate_address)
                        .and(crate::schema::delegates::is_active.eq(true))
                    )
                    .set(
                        crate::schema::delegates::proposals_reviewed.eq(
                            crate::schema::delegates::proposals_reviewed + 1
                        )
                    )
                    .execute(tx_conn)
                    .await?;
        ...
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                if vote_event.approve {
                    diesel::update(crate::schema::proposals::table)
                        .filter(crate::schema::proposals::id.eq(&vote_event.proposal_id))
                        .set(crate::schema::proposals::community_votes_for.eq(crate::schema::proposals::community_votes_for + vote_event.vote_weight as i64))
                        .execute(tx_conn)
                        .await?;
                } else {
                    diesel::update(crate::schema::proposals::table)
                        .filter(crate::schema::proposals::id.eq(&vote_event.proposal_id))
                        .set(crate::schema::proposals::community_votes_against.eq(crate::schema::proposals::community_votes_against + vote_event.vote_weight as i64))
                        .execute(tx_conn)
                        .await?;
                }
        ...
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                diesel::update(crate::schema::proposals::table)
                    ...
                    .set((
                        crate::schema::proposals::status.eq(GOVERNANCE_STATUS_COMMUNITY_VOTING as i16),
                        crate::schema::proposals::voting_start_time.eq(approved_event.voting_start_time as i64),
                        crate::schema::proposals::voting_end_time.eq(approved_event.voting_end_time as i64),
                    ))
                    .execute(tx_conn)
                    .await?;
                ...
                if let Some(result) = proposal_type_query.get(0) {
                    ...
                    error!("Failed to find proposal type for proposal ID: {}", approved_event.proposal_id);
                }
        ...
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                for vote in &delegate_votes {
                    if !vote.approve { // For rejected proposals
                        diesel::update(crate::schema::delegates::table)
                            .filter(crate::schema::delegates::address.eq(&vote.delegate_address))
                            .set(crate::schema::delegates::sided_winning_proposals.eq(crate::schema::delegates::sided_winning_proposals + 1))
                            .execute(tx_conn)
                            .await?;
                    } else {
                        diesel::update(crate::schema::delegates::table)
                            .filter(crate::schema::delegates::address.eq(&vote.delegate_address))
                            .set(crate::schema::delegates::sided_losing_proposals.eq(crate::schema::delegates::sided_losing_proposals + 1))
                            .execute(tx_conn)
                            .await?;
                    }
                }
                ...
                if let Some(result) = proposal_type_query.get(0) {
                    ...
                    error!("Failed to find proposal type for proposal ID: {}", rejected_event.proposal_id);
                }
    ...
    conn.build_transaction()
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                diesel::update(crate::schema::proposals::table)
                    .filter(
                        crate::schema::proposals::id.eq(&rescinded_event.proposal_id)
                        .and(crate::schema::proposals::submitter.eq(&rescinded_event.submitter))
                    )
                    .set((
                        crate::schema::proposals::status.eq(GOVERNANCE_STATUS_OWNER_RESCINDED as i16),
                        crate::schema::proposals::rescind_time.eq(rescinded_event.rescind_time as i64),
                ...
                if let Some(result) = proposal_type_query.get(0) {
                    ...
                    error!("Failed to find proposal type for proposal ID: {}", rescinded_event.proposal_id);
                }
...
pub async fn process_proposal_implemented_event(
    ...
    let result = diesel::update(crate::schema::proposals::table)
        ...
        .set((
            ...
            crate::schema::proposals::implementation_time.eq(implemented_event.implementation_time as i64),
            crate::schema::proposals::implemented_description.eq(&implemented_event.implemented_description),
        ))
        .execute(conn)
        .await?;
    
    info!("Processed proposal implemented event: {} rows affected", result);
    ...
    if let Some(result) = proposal_type_query.get(0) {
        ...
        error!("Failed to find proposal type for proposal ID: {}", implemented_event.proposal_id);
    }
...
pub async fn process_rewards_distributed_event(
    ...
    info!("Processed rewards distributed event: {} rows affected", result);
