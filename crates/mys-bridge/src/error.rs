...
pub enum BridgeError {
    ...
    // Found a bridge event but not in a recognized Mys bridge package
    BridgeEventInUnrecognizedMysPackage,
    ...
    // Mys transaction failure due to generic error
    MysTxFailureGeneric(String),
