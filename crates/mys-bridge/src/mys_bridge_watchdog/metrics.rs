...
pub struct WatchdogMetrics {
    ...
    pub mys_bridge_paused: IntGauge,
}
    ...
    pub fn new(registry: &Registry) -> Self {
        Self {
            ...
            total_supplies: register_int_gauge_vec_with_registry!(
                ...
                "Current total supplies of coins on Mys based on Treasury Cap",
                &["token_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            mys_bridge_paused: register_int_gauge_with_registry!(
                "bridge_mys_bridge_paused",
                "Whether the mys bridge is paused",
                registry,
            )
            .unwrap(),
        }
