...
pub struct BridgeMetrics {
    pub(crate) err_build_mys_transaction: IntCounter,
    pub(crate) err_signature_aggregation: IntCounter,
    pub(crate) err_signature_aggregation_too_many_failures: IntCounter,
    pub(crate) err_mys_transaction_submission: IntCounter,
    pub(crate) err_mys_transaction_submission_too_many_failures: IntCounter,
    pub(crate) err_mys_transaction_execution: IntCounter,
    ...
    pub(crate) last_synced_mys_checkpoints: IntGaugeVec,
    pub(crate) last_finalized_eth_block: IntGauge,
    pub(crate) last_synced_eth_blocks: IntGaugeVec,

    pub(crate) mys_watcher_received_events: IntCounter,
    pub(crate) mys_watcher_received_actions: IntCounter,
    pub(crate) mys_watcher_unrecognized_events: IntCounter,
    ...
    pub(crate) mys_rpc_errors: IntCounterVec,
    ...
    pub(crate) mys_eth_token_transfer_approved: IntCounter,
    pub(crate) mys_eth_token_transfer_claimed: IntCounter,
    pub(crate) eth_mys_token_transfer_approved: IntCounter,
    pub(crate) eth_mys_token_transfer_claimed: IntCounter,
}

impl BridgeMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            err_build_mys_transaction: register_int_counter_with_registry!(
                "bridge_err_build_mys_transaction",
                "Total number of errors of building mys transactions",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            err_mys_transaction_submission: register_int_counter_with_registry!(
                "bridge_err_mys_transaction_submission",
                "Total number of errors of submitting mys transactions",
                registry,
            )
            .unwrap(),
            err_mys_transaction_submission_too_many_failures: register_int_counter_with_registry!(
                "bridge_err_mys_transaction_submission_too_many_failures",
                "Total number of continuous failures to submitting mys transactions",
                registry,
            )
            .unwrap(),
            err_mys_transaction_execution: register_int_counter_with_registry!(
                "bridge_err_mys_transaction_execution",
                "Total number of failures of mys transaction execution",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            mys_watcher_received_events: register_int_counter_with_registry!(
                "bridge_mys_watcher_received_events",
                "Total number of received events in mys watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            mys_watcher_received_actions: register_int_counter_with_registry!(
                "bridge_mys_watcher_received_actions",
                "Total number of received actions in mys watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            mys_watcher_unrecognized_events: register_int_counter_with_registry!(
                "bridge_mys_watcher_unrecognized_events",
                "Total number of unrecognized events in mys watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            last_synced_mys_checkpoints: register_int_gauge_vec_with_registry!(
                "bridge_last_synced_mys_checkpoints",
                "The latest mys checkpoints synced for each module",
                &["module_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            mys_rpc_errors: register_int_counter_vec_with_registry!(
                "bridge_mys_rpc_errors",
                "Total number of errors from mys RPC, by RPC method",
                &["method"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            mys_eth_token_transfer_approved: register_int_counter_with_registry!(
                "bridge_mys_eth_token_transfer_approved",
                "Total number of approved mys to eth token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            mys_eth_token_transfer_claimed: register_int_counter_with_registry!(
                "bridge_mys_eth_token_transfer_claimed",
                "Total number of claimed mys to eth token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            eth_mys_token_transfer_approved: register_int_counter_with_registry!(
                "bridge_eth_mys_token_transfer_approved",
                "Total number of approved eth to mys token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            eth_mys_token_transfer_claimed: register_int_counter_with_registry!(
                "bridge_eth_mys_token_transfer_claimed",
                "Total number of claimed eth to mys token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
