...
mod tests {
    ...
    use crate::test_utils::{get_test_authority_and_key, get_test_mys_to_eth_bridge_action};
    ...
    fn test_sign_and_verify_bridge_event_basic() -> anyhow::Result<()> {
        ...
        let mismatched_action: BridgeAction =
            get_test_mys_to_eth_bridge_action(None, Some(2), Some(3), Some(4), None, None, None);
        ...
        let action2: BridgeAction =
            get_test_mys_to_eth_bridge_action(None, Some(3), Some(5), Some(77), None, None, None);
    ...
    fn test_bridge_sig_verification_regression_test() {
        ...
        let action = BridgeAction::MysToEthBridgeAction(MysToEthBridgeAction {
            mys_tx_digest: TransactionDigest::random(),
            mys_tx_event_index: 0,
            mys_bridge_event: EmittedMysToEthTokenBridgeV1 {
                nonce: 1,
                mys_chain_id: BridgeChainId::MysTestnet,
                mys_address: MysAddress::from_str(
