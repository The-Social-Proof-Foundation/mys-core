...
use async_graphql::*;
use mys_json_rpc_types::{DevInspectResults, MysExecutionResult};
use mys_types::effects::TransactionEffects as NativeTransactionEffects;
use mys_types::transaction::TransactionData as NativeTransactionData;
...
impl TryFrom<MysExecutionResult> for DryRunEffect {
    type Error = crate::error::Error;

    fn try_from(result: MysExecutionResult) -> Result<Self, Self::Error> {
