...
use mys_types::digests::ChainIdentifier as MysChainIdentifier;
use mys_types::{
...
impl ChangeEpochTransaction {
    ...
    async fn system_packages(
        ...
        for c in cs {
            ...
            let object = Object::from_native(MysAddress::from(runtime_id), native, c.c, None);
