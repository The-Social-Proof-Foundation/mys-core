...
#[derive(Clone)]
pub struct MysTransactionBlockResponseBuilder<'a> {
    response: MysTransactionBlockResponse,
    full_response: &'a MysTransactionBlockResponse,
}

impl<'a> MysTransactionBlockResponseBuilder<'a> {
    pub fn new(full_response: &'a MysTransactionBlockResponse) -> Self {
        Self {
            response: MysTransactionBlockResponse::default(),
            full_response,
        }
    }

    pub fn with_input(mut self) -> Self {
        self.response = MysTransactionBlockResponse {
    ...
    pub fn build(self) -> MysTransactionBlockResponse {
...
pub async fn set_up_on_mvr_mode(
    ...
    let server_handle = tokio::spawn(async move {
        mys_rpc_api::RpcService::new_without_version(sim)
