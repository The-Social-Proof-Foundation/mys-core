...
use mys_json_rpc_types::{EndOfEpochInfo, EpochInfo};
use mys_types::event::SystemEpochInfoEvent;
use mys_types::messages_checkpoint::CertifiedCheckpointSummary;
...
impl StartOfEpochUpdate {
    pub fn new(
        new_system_state_summary: MysSystemStateSummary,
...
impl StoredEpochInfo {
    pub fn get_json_system_state_summary(&self) -> Result<MysSystemStateSummary, IndexerError> {
