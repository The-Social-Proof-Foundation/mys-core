...
use mys_json_rpc::get_balance_changes_from_effect;
use mys_json_rpc::get_object_changes;
use mys_json_rpc::ObjectProvider;
...
impl TxChangesProcessor {
    ...
    pub(crate) async fn get_changes(
        ...
        Vec<mys_json_rpc_types::BalanceChange>,
...
// This is a struct that is used to extract MysSystemState and its dynamic children
...
impl<'a> mys_types::storage::ObjectStore for EpochEndIndexingObjectStore<'a> {
