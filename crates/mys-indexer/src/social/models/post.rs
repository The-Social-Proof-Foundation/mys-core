...
#[diesel(table_name = crate::social::schema::posts)]
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::comments)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct Comment {
    #[diesel(sql_type = Varchar)]
    pub id: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::reactions)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct Reaction {
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::reaction_counts)]
#[diesel(check_for_backend(diesel::pg::Pg))]
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::reposts)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct Repost {
    #[diesel(sql_type = Varchar)]
    pub id: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::tips)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct Tip {
    #[diesel(sql_type = Int4)]
    pub id: i32,
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::posts_moderation_events)]
#[diesel(check_for_backend(diesel::pg::Pg))]
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::posts_reports)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct Report {
    #[diesel(sql_type = Int4)]
    pub id: i32,
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::posts_deletion_events)]
#[diesel(check_for_backend(diesel::pg::Pg))]
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::promoted_posts)]
#[diesel(check_for_backend(diesel::pg::Pg))]
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::promotion_views)]
#[diesel(check_for_backend(diesel::pg::Pg))]
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::promotion_status_events)]
#[diesel(check_for_backend(diesel::pg::Pg))]
...
#[derive(Debug, Clone, Serialize, Deserialize, QueryableByName, Selectable)]
#[diesel(table_name = crate::social::schema::promotion_budget_events)]
#[diesel(check_for_backend(diesel::pg::Pg))]
...
#[diesel(table_name = crate::social::schema::post_config)]
#[diesel(check_for_backend(diesel::pg::Pg))]
