...
pub struct PlatformCreatedEvent {
    #[serde(default, deserialize_with = "crate::social::events::event_utils::deserialize_platform_id")]
    pub platform_id: String,
    pub name: String,
    pub tagline: String,
    #[serde(default)]
    ...
    pub governance_registry_id: Option<String>,
    #[serde(default, deserialize_with = "crate::social::events::event_utils::deserialize_optional_u64_from_string")]
...
pub struct PlatformStatus {
    #[serde(deserialize_with = "crate::social::events::event_utils::deserialize_status_field")]
    pub status: u8,
}
