...
use crate::social::db::query_types::{DelegateVoteResult, ProposalTypeResult};
...
pub async fn process_governance_registry_created_event(
    ...
    let registry_exists = crate::social::schema::governance_registries::table
        .filter(crate::social::schema::governance_registries::registry_id.eq(&registry_event.registry_id))
        .count()
        .get_result::<i64>(conn)
        .await
        .unwrap_or(0) > 0;
    ...
    let result = diesel::insert_into(crate::social::schema::governance_registries::table)
        .values(&new_registry)
        .on_conflict(crate::social::schema::governance_registries::registry_type)
        .do_update()
        .set((
            crate::social::schema::governance_registries::registry_id.eq(new_registry.registry_id.clone()),
            crate::social::schema::governance_registries::delegate_count.eq(new_registry.delegate_count),
            crate::social::schema::governance_registries::delegate_term_epochs
                .eq(new_registry.delegate_term_epochs),
            crate::social::schema::governance_registries::proposal_submission_cost
                .eq(new_registry.proposal_submission_cost),
            crate::social::schema::governance_registries::max_votes_per_user
    ...
    diesel::insert_into(crate::social::schema::governance_events::table)
...
pub async fn process_delegate_nominated_event(
    ...
    let result = diesel::insert_into(crate::social::schema::nominated_delegates::table)
        .values(&new_nominee)
        .on_conflict((
            crate::social::schema::nominated_delegates::address,
            crate::social::schema::nominated_delegates::registry_type,
        ))
        .do_update()
        .set((
            crate::social::schema::nominated_delegates::upvotes.eq(0),
            crate::social::schema::nominated_delegates::downvotes.eq(0),
            crate::social::schema::nominated_delegates::scheduled_term_start_epoch
                .eq(new_nominee.scheduled_term_start_epoch),
            crate::social::schema::nominated_delegates::nomination_time.eq(new_nominee.nomination_time),
            crate::social::schema::nominated_delegates::status.eq(NOMINEE_STATUS_PENDING as i16),
            crate::social::schema::nominated_delegates::transaction_id.eq(event_id.to_string()),
        ))
        .execute(conn)
        .await?;
    ...
    conn.build_transaction()
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                diesel::update(crate::social::schema::nominated_delegates::table)
                    .filter(
                        crate::social::schema::nominated_delegates::address
                    ...
                    .set(
                        crate::social::schema::nominated_delegates::status
                ...
                diesel::insert_into(crate::social::schema::delegates::table)
                    .values(&new_delegate)
                    .on_conflict((
                        crate::social::schema::delegates::address,
                        crate::social::schema::delegates::registry_type,
                    ))
                    .do_update()
                    .set((
                        // Don't update upvotes/downvotes on conflict - preserve existing values
                        crate::social::schema::delegates::term_start.eq(new_delegate.term_start),
                        crate::social::schema::delegates::term_end.eq(new_delegate.term_end),
                        crate::social::schema::delegates::is_active.eq(true),
                        crate::social::schema::delegates::updated_at.eq(now_unix_ms),
                        crate::social::schema::delegates::transaction_id.eq(event_id.to_string()),
                    ))
                    .execute(tx_conn)
                    .await?;
    ...
    conn.build_transaction()
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                diesel::insert_into(crate::social::schema::delegate_ratings::table)
                    .values(&new_rating)
                    .on_conflict((
                        crate::social::schema::delegate_ratings::target_address,
                        crate::social::schema::delegate_ratings::voter_address,
                        crate::social::schema::delegate_ratings::registry_type,
                    ))
                    .do_update()
                    .set((
                        crate::social::schema::delegate_ratings::upvote.eq(new_rating.upvote),
                        crate::social::schema::delegate_ratings::rated_at.eq(new_rating.rated_at),
                        crate::social::schema::delegate_ratings::transaction_id.eq(event_id.to_string()),
                    ))
                    .execute(tx_conn)
                    .await?;
                ...
                if voted_event.is_active_delegate {
                    ...
                    diesel::update(crate::social::schema::delegates::table)
                        .filter(
                            crate::social::schema::delegates::address
                        ...
                        .set((
                            crate::social::schema::delegates::upvotes.eq(voted_event.new_upvote_count as i64),
                            crate::social::schema::delegates::downvotes.eq(voted_event.new_downvote_count as i64),
                        ))
                        .execute(tx_conn)
                        .await?;
                } else {
                    ...
                    diesel::update(crate::social::schema::nominated_delegates::table)
                        ...
                        .set((
                            crate::social::schema::nominated_delegates::upvotes.eq(voted_event.new_upvote_count as i64),
                            crate::social::schema::nominated_delegates::downvotes.eq(voted_event.new_downvote_count as i64),
                        ))
                        .execute(tx_conn)
                        .await?;
                }
...
pub async fn process_proposal_submitted_event(
    ...
    // Insert the proposal
    let result = diesel::insert_into(crate::social::schema::proposals::table)
        .values(&new_proposal)
        .execute(conn)
        .await?;
    ...
    diesel::update(crate::social::schema::delegates::table)
        .filter(
            crate::social::schema::delegates::address
                ...
                .and(
                    crate::social::schema::delegates::registry_type.eq(proposal_event.proposal_type as i16),
                )
                .and(crate::social::schema::delegates::is_active.eq(true)),
        )
        .set(
            crate::social::schema::delegates::proposals_submitted
                .eq(crate::social::schema::delegates::proposals_submitted + 1),
        )
        .execute(conn)
        .await?;
    ...
    conn.build_transaction()
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                diesel::insert_into(crate::social::schema::delegate_votes::table)
                    .values(&new_vote)
                    .on_conflict((
                        crate::social::schema::delegate_votes::proposal_id,
                        crate::social::schema::delegate_votes::delegate_address,
                    ))
                    .do_update()
                    .set((
                        crate::social::schema::delegate_votes::approve.eq(new_vote.approve),
                        crate::social::schema::delegate_votes::vote_time.eq(new_vote.vote_time),
                        crate::social::schema::delegate_votes::reason.eq(new_vote.reason.clone()),
                        crate::social::schema::delegate_votes::transaction_id.eq(event_id.to_string()),
                    ))
                    .execute(tx_conn)
                    .await?;
                ...
                diesel::update(crate::social::schema::delegates::table)
                    ...
                    .set(
                        crate::social::schema::delegates::proposals_reviewed
                            .eq(crate::social::schema::delegates::proposals_reviewed + 1),
                    )
                    .execute(tx_conn)
                    .await?;
    ...
    conn.build_transaction()
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                diesel::insert_into(crate::social::schema::community_votes::table)
                    .values(&new_vote)
                    .on_conflict((
                        crate::social::schema::community_votes::proposal_id,
                        crate::social::schema::community_votes::voter_address,
                    ))
                    .do_update()
                    .set((
                        crate::social::schema::community_votes::vote_weight.eq(new_vote.vote_weight),
                        crate::social::schema::community_votes::approve.eq(new_vote.approve),
                        crate::social::schema::community_votes::vote_time.eq(new_vote.vote_time),
                        crate::social::schema::community_votes::vote_cost.eq(new_vote.vote_cost),
                        crate::social::schema::community_votes::transaction_id.eq(event_id.to_string()),
                    ))
                    .execute(tx_conn)
                    .await?;
    ...
    conn.build_transaction()
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                diesel::update(crate::social::schema::proposals::table)
                    .filter(crate::social::schema::proposals::id.eq(&approved_event.proposal_id))
                    .set((
                        crate::social::schema::proposals::status
                            .eq(GOVERNANCE_STATUS_COMMUNITY_VOTING as i16),
                        crate::social::schema::proposals::voting_start_time
                            .eq(approved_event.voting_start_time as i64),
                        crate::social::schema::proposals::voting_end_time
...
pub async fn process_proposal_rejected_event(
            ...
            Box::pin(async move {
                ...
                for vote in &delegate_votes {
                    if !vote.approve {
                        ...
                        diesel::update(crate::social::schema::delegates::table)
                            .filter(crate::social::schema::delegates::address.eq(&vote.delegate_address))
                            .set(
                                crate::social::schema::delegates::sided_winning_proposals
                                    .eq(crate::social::schema::delegates::sided_winning_proposals + 1),
                            )
                            .execute(tx_conn)
                            .await?;
                    } else {
                        diesel::update(crate::social::schema::delegates::table)
                            .filter(crate::social::schema::delegates::address.eq(&vote.delegate_address))
                            .set(
                                crate::social::schema::delegates::sided_losing_proposals
                                    .eq(crate::social::schema::delegates::sided_losing_proposals + 1),
                            )
                            .execute(tx_conn)
                            .await?;
                    }
    ...
    if let Ok(submitter) = crate::social::schema::proposals::table
        .filter(crate::social::schema::proposals::id.eq(&proposal_id))
        .select(crate::social::schema::proposals::submitter)
        .first::<String>(conn)
        .await
    {
        let event_data = serde_json::json!({
    ...
    conn.build_transaction()
        .run(|tx_conn| {
            Box::pin(async move {
                ...
                diesel::update(crate::social::schema::proposals::table)
                    .filter(
                        crate::social::schema::proposals::id
                            .eq(&rescinded_event.proposal_id)
                            .and(
                                crate::social::schema::proposals::submitter.eq(&rescinded_event.submitter),
                            ),
                    )
                    .set((
                        crate::social::schema::proposals::status
                            .eq(GOVERNANCE_STATUS_OWNER_RESCINDED as i16),
                        crate::social::schema::proposals::rescind_time
                            .eq(rescinded_event.rescind_time as i64),
                        crate::social::schema::proposals::reward_pool.eq(0),
                    ))
                    .execute(tx_conn)
                    .await?;
                ...
                diesel::insert_into(crate::social::schema::reward_distributions::table)
                    .values(&new_refund)
                    .execute(tx_conn)
                    .await?;
        ...
        .run(|tx_conn| {
            ...
            Box::pin(async move {
                ...
                diesel::update(crate::social::schema::proposals::table)
                    ...
                    .set((
                        crate::social::schema::proposals::status.eq(GOVERNANCE_STATUS_REJECTED as i16),
                        crate::social::schema::proposals::community_votes_for.eq(rejected_event.votes_for as i64),
                        crate::social::schema::proposals::community_votes_against.eq(rejected_event.votes_against as i64),
                    ))
                    .execute(tx_conn)
                    .await?;
        ...
        .run(|tx_conn| {
            ...
            Box::pin(async move {
                ...
                diesel::update(crate::social::schema::proposals::table)
                    .filter(crate::social::schema::proposals::id.eq(&proposal_id))
                    .set((
                        crate::social::schema::proposals::status.eq(GOVERNANCE_STATUS_APPROVED as i16),
                        crate::social::schema::proposals::community_votes_for.eq(approved_event.votes_for as i64),
                        crate::social::schema::proposals::community_votes_against.eq(approved_event.votes_against as i64),
                    ))
                    .execute(tx_conn)
                    .await?;
...
pub async fn process_proposal_implemented_event(
    ...
    let result = diesel::update(crate::social::schema::proposals::table)
        .filter(crate::social::schema::proposals::id.eq(&proposal_id))
        .set((
            crate::social::schema::proposals::status.eq(GOVERNANCE_STATUS_IMPLEMENTED as i16),
            crate::social::schema::proposals::implementation_time
                .eq(implemented_event.implementation_time as i64),
            crate::social::schema::proposals::implemented_description
...
pub async fn process_rewards_distributed_event(
    ...
    let result = diesel::insert_into(crate::social::schema::reward_distributions::table)
...
pub async fn process_anonymous_vote_event(
    ...
    // Parse the event
    let vote_event =
        parse_json_event::<crate::social::events::governance_event_types::AnonymousVoteEvent>(event)?;

    // Create new anonymous vote record
    let new_vote = crate::social::models::governance::NewAnonymousVote {
        proposal_id: vote_event.proposal_id.clone(),
        voter_address: vote_event.voter.clone(),
        encrypted_vote_data: Some(vote_event.encrypted_vote_data.clone()),
        submitted_at: vote_event.vote_time as i64,
        decryption_status: crate::social::ANONYMOUS_VOTE_STATUS_PENDING as i16,
        transaction_id: event_id.to_string(),
    ...
    let result = diesel::insert_into(crate::social::schema::anonymous_votes::table)
        .values(&new_vote)
        .execute(conn)
        .await?;
    ...
    let proposal_type_query =
        diesel::sql_query("SELECT proposal_type FROM proposals WHERE id = $1")
            .bind::<diesel::sql_types::Text, _>(&vote_event.proposal_id)
            .load::<crate::social::db::query_types::ProposalTypeResult>(conn)
            .await?;
...
pub async fn process_vote_decryption_failed_event(
    ...
    let failure_event = parse_json_event::<
        crate::social::events::governance_event_types::VoteDecryptionFailedEvent,
    >(event)?;

    // Create decryption failure record
    let new_failure = crate::social::models::governance::NewVoteDecryptionFailure {
    ...
    let result = diesel::insert_into(crate::social::schema::vote_decryption_failures::table)
        .values(&new_failure)
        .execute(conn)
        .await?;
...
pub async fn process_governance_parameters_updated_event(
    ...
    let registry_exists = crate::social::schema::governance_registries::table
        .filter(crate::social::schema::governance_registries::registry_type.eq(params_event.registry_type as i16))
        .count()
        .get_result::<i64>(conn)
        .await?;
    ...
    let result = diesel::update(crate::social::schema::governance_registries::table)
        .filter(crate::social::schema::governance_registries::registry_type.eq(params_event.registry_type as i16))
        .set((
            crate::social::schema::governance_registries::delegate_count.eq(params_event.delegate_count as i64),
            crate::social::schema::governance_registries::delegate_term_epochs.eq(params_event.delegate_term_epochs as i64),
