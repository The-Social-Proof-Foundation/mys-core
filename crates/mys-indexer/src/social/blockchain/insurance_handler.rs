...
use crate::social::events::InsuranceConfigUpdatedEvent;
use crate::social::events::insurance_event_types::{
...
use crate::social::models::insurance::{UpdateInsurancePolicy, UpdateInsuranceVault};
