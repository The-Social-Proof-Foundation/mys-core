...
use crate::social::events::blocking_events::{process_profile_block_event, process_profile_unblock_event};
    ...
    async fn process_event(&self, event: BlockchainEvent) -> Result<()> {
        ...
        // Fallback: try flexible matching for backwards compatibility
            ...
            if event_type_lower.contains("userblockevent") {
                ...
                let fields = crate::social::events::event_utils::extract_event_fields(&event.data)
