...
impl BaseHandler {
    ...
    pub async fn get_connection(&self) -> Result<crate::social::db::DbConnection> {
...
macro_rules! impl_handler_boilerplate {
    ($handler_type:ty, $handler_name:expr) => {
        #[async_trait]
        impl crate::social::blockchain::handler_trait::BlockchainEventHandler for $handler_type {
            fn name(&self) -> &str {
                $handler_name
            }

            fn stats(&self) -> crate::social::blockchain::handler_trait::HandlerStats {
                self.base.stats.clone()
            }

            async fn health(&self) -> crate::social::blockchain::handler_trait::HandlerHealth {
