...
use crate::social::models::mydata::{MyDataConfig, NewMyDataAccessLog};
...
impl MyDataEventHandler {
    ...
    async fn handle_data_created_from_json(
        ...
        let new_data = crate::social::models::mydata::NewMyDataData {
    ...
    async fn handle_data_purchased_from_json(
        ...
        // Record the purchase
        let purchase = crate::social::models::NewMyDataPurchase {
            mydata_id: mydata_id.to_string(),
            buyer: buyer.to_string(),
            price: price as i64,
            purchase_type: crate::social::models::mydata::PURCHASE_TYPE_ONE_TIME.to_string(),
        ...
        // Record access log
        let access_log = crate::social::models::NewMyDataAccessLog {
            mydata_id: mydata_id.to_string(),
            user_address: buyer.to_string(),
            access_type: crate::social::models::mydata::ACCESS_TYPE_ONE_TIME.to_string(),
    ...
    async fn handle_subscription_created_from_json(
        ...
        let subscription = crate::social::models::NewMyDataSubscription {
            mydata_id: mydata_id.to_string(),
        ...
        let purchase = crate::social::models::NewMyDataPurchase {
            ...
            price: price as i64,
            purchase_type: crate::social::models::mydata::PURCHASE_TYPE_SUBSCRIPTION.to_string(),
        ...
        let access_log = crate::social::models::NewMyDataAccessLog {
            ...
            access_type: crate::social::models::mydata::ACCESS_TYPE_SUBSCRIPTION.to_string(),
    ...
    async fn handle_data_access_granted_from_json(
        ...
        let access_log = crate::social::models::NewMyDataAccessLog {
            ...
            access_type: crate::social::models::mydata::ACCESS_TYPE_GRANT.to_string(),
    ...
    async fn handle_revenue_distributed_from_json(
        ...
        let revenue = crate::social::models::NewMyDataRevenue {
            mydata_id: mydata_id.to_string(),
        ...
        let unified_revenue = crate::social::models::NewUnifiedRevenue::from_myip(
        ...
        diesel::insert_into(crate::social::schema::unified_revenue::table)
    ...
    async fn handle_purchase_from_json(
        ...
        // Record the purchase
        let purchase = crate::social::models::mydata::NewMyDataPurchase {
            mydata_id: event.ip_id.clone(),
        ...
        if event.purchase_type == "subscription" {
            ...
            let subscription = crate::social::models::mydata::NewMyDataSubscription {
                mydata_id: event.ip_id.clone(),
        ...
        let revenue = crate::social::models::mydata::NewMyDataRevenue {
            mydata_id: event.ip_id.clone(),
