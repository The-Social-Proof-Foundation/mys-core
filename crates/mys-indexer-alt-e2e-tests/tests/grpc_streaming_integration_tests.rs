...
use mys_indexer_alt_framework::pipeline::concurrent::{self};
use mys_pg_db::Db;
...
impl concurrent::Handler for TxCounts {
    ...
    async fn commit<'a>(
        ...
        conn: &mut mys_pg_db::Connection<'a>,
    ) -> anyhow::Result<usize> {
...
async fn transfer_coin(
    wallet: &mut mys_sdk::wallet_context::WalletContext,
) -> mys_types::base_types::TransactionDigest {
