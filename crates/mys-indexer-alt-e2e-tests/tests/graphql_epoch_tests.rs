...
use mys_types::mys_system_state::mock;
...
use mys_types::test_checkpoint_data_builder::AdvanceEpochConfig;
use mys_types::test_checkpoint_data_builder::TestCheckpointBuilder;

use mys_indexer_alt_e2e_tests::OffchainCluster;
use mys_indexer_alt_e2e_tests::OffchainClusterConfig;
use mys_indexer_alt_e2e_tests::local_ingestion_client_args;
use mys_indexer_alt_e2e_tests::write_checkpoint;
...
async fn safe_mode_system_state_v1() {
    let mys_system_state = MysSystemState::V1(MysSystemStateInnerV1 {
        safe_mode: ENABLED,
        ...
        ..mock::mys_system_state_inner_v1()
    });
    ...
    let EpochSystemState {
        ...
        SAFE_MODE_QUERY,
        mys_system_state.clone(),
        AdvanceEpochConfig {
            output_objects: mock::system_state_output_objects(mys_system_state),
            ..Default::default()
        },
    )
    .await;
...
async fn safe_mode_system_state_v2() {
    let mys_system_state = MysSystemState::V2(MysSystemStateInnerV2 {
        safe_mode: ENABLED,
        safe_mode_computation_rewards: Balance::new(COMPUTATION_COST),
        safe_mode_storage_rewards: Balance::new(STORAGE_COST),
        safe_mode_storage_rebates: STORAGE_REBATE,
        safe_mode_non_refundable_storage_fee: NON_REFUNDABLE_STORAGE_FEE,
        ..mock::mys_system_state_inner_v2()
    });
...
async fn live_object_set_digest() {
    let mys_system_state = MysSystemState::V2(mock::mys_system_state_inner_v2());
...
async fn test_graphql<T: DeserializeOwned>(
    query: &str,
    genesis_mys_system_state: MysSystemState,
        ...
        OffchainClusterConfig {
            ...
            bootstrap_genesis: Some(BootstrapGenesis {
                ...
                stored_epoch_start: StoredEpochStart {
                    ...
                    system_state: bcs::to_bytes(&genesis_mys_system_state).unwrap(),
                },
            }),
            ..Default::default()
        },
