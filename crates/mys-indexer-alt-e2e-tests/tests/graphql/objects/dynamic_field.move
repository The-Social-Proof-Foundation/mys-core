...
//> mys::bag::add<u64, u64>(Input(0), Input(1), Input(2))

//# create-checkpoint

//# programmable --sender A --inputs object(1,0) 43 object(3,0)
//> mys::bag::add<u64, mys::coin::Coin<mys::mys::MYS>>(Input(0), Input(1), Input(2))

//# programmable --sender A --inputs object(2,0) 44 object(4,0)
//> mys::object_bag::add<u64, mys::coin::Coin<mys::mys::MYS>>(Input(0), Input(1), Input(2))
