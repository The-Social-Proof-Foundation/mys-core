...
//> 1: mys::object::id_address<mys::coin::Coin<mys::mys::MYS>>(Gas);
...
//> 1: mys::object::id_address<mys::coin::Coin<mys::mys::MYS>>(NestedResult(0,0));
//> 2: TransferObjects([NestedResult(0,1)], Result(1));
//> 3: mys::object::id_address<mys::coin::Coin<mys::mys::MYS>>(Gas);
...
{ # ... and for balance point-lookups
  object(address: "@{obj_0_0}", version: 2) {
    balance(coinType: "0x2::mys::MYS") { totalBalance }
  }
}
...
{ # ... and balance multi-gets
  object(address: "@{obj_0_0}", version: 2) {
    multiGetBalances(keys: ["0x2::mys::MYS"]) { totalBalance }
  }
}
...
fragment Owned on IAddressable {
  ...
  mys: balance(coinType: "0x2::mys::MYS") { totalBalance }
