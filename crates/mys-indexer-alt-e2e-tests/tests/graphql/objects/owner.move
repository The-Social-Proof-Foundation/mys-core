...
//> 0: mys::bag::add<u64, u64>(Input(0), Input(1), Input(1))

//# programmable --sender A --inputs 2000
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: mys::transfer::public_share_object<mys::coin::Coin<mys::mys::MYS>>(Result(0));

//# programmable --sender A --inputs 3000
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: mys::transfer::public_freeze_object<mys::coin::Coin<mys::mys::MYS>>(Result(0));

//# programmable --sender A --inputs 4000 @A
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: mys::party::single_owner(Input(1));
//> 2: mys::transfer::public_party_transfer<mys::coin::Coin<mys::mys::MYS>>(Result(0), Result(1));
