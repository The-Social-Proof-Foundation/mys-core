...
//# programmable --sender A --inputs @A
//> 0: mys::object_bag::new();
//> 1: TransferObjects([Result(0)], Input(0))

//# create-checkpoint

//# programmable --sender A --inputs object(1,0) 1u64 object(2,0) 2u64 object(3,0) 3u64 object(4,0)
//> 0: mys::bag::add<u64, mys::bag::Bag>(Input(2), Input(3), Input(4));
//> 1: mys::bag::add<u64, mys::bag::Bag>(Input(2), Input(5), Input(6));
//> 2: mys::bag::add<u64, mys::bag::Bag>(Input(0), Input(1), Input(2));

//# programmable --sender A --inputs object(5,0) 400u64 500u64
//> 0: SplitCoins(Gas, [Input(1), Input(2)]);
//> 1: mys::object_bag::add<u64, mys::coin::Coin<mys::mys::MYS>>(Input(0), Input(1), NestedResult(0,0));
//> 2: mys::object_bag::add<u64, mys::coin::Coin<mys::mys::MYS>>(Input(0), Input(2), NestedResult(0,1));
