...
//# run-graphql
{ # Happy paths
  complex: type(type: "0x2::priority_queue::PriorityQueue<0x2::coin::Coin<0x2::mys::MYS>>") { ...Type }
  coin: type(type: "0x2::coin::Coin<0x2::mys::MYS>") { ...Type }
  token: type(type: "0x2::token::Token<0x2::mys::MYS>") { ...Type }
  balance: type(type: "0x2::balance::Balance<0x2::mys::MYS>") { ...Type }
  primitive: type(type: "u64") { ...Type }
  prim_vector: type(type: "vector<u64>") { ...Type }
  coin_vector: type(type: "vector<0x2::coin::Coin<0x2::mys::MYS>>") { ...Type }
}
...
{ # Multi-get
  multiGetTypes(keys: [
    "0x2::priority_queue::PriorityQueue<0x2::coin::Coin<0x2::mys::MYS>>",
    "0x2::coin::Coin<0x2::mys::MYS>",
    "0x2::token::Token<0x2::mys::MYS>",
    "0x2::balance::Balance<0x2::mys::MYS>",
    "u64",
    "vector<u64>",
    "vector<0x2::coin::Coin<0x2::mys::MYS>>",
...
{ # Unhappy path, type argument arity mismatch
  type(type: "0x2::coin::Coin<0x2::mys::MYS, u64>") {
    abilities
  }
}
