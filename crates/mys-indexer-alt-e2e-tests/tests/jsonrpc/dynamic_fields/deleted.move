...
//# programmable --sender A --inputs object(1,0) 42
//> 0: mys::bag::remove<u64, u64>(Input(0), Input(1))
...
//> 1: mys::object_bag::add<u64, mys::coin::Coin<mys::mys::MYS>>(Input(0), Input(1), Result(0))
...
//# programmable --sender A --inputs object(10,0) 43
//> 0: mys::object_bag::remove<u64, mys::coin::Coin<mys::mys::MYS>>(Input(0), Input(1));
