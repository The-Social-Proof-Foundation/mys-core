...
use mys_indexer_alt::BootstrapGenesis;
use mys_indexer_alt::config::IndexerConfig;
use mys_indexer_alt::setup_indexer;
use mys_indexer_alt_consistent_api::proto::rpc::consistent::v1alpha::AvailableRangeRequest;
use mys_indexer_alt_consistent_api::proto::rpc::consistent::v1alpha::consistent_service_client::ConsistentServiceClient;
use mys_indexer_alt_consistent_store::args::RpcArgs as ConsistentArgs;
use mys_indexer_alt_consistent_store::args::TlsArgs as ConsistentTlsArgs;
use mys_indexer_alt_consistent_store::config::ServiceConfig as ConsistentConfig;
use mys_indexer_alt_consistent_store::start_service as start_consistent_store;
...
use mys_indexer_alt_framework::postgres::schema::watermarks;
use mys_indexer_alt_graphql::RpcArgs as GraphQlArgs;
use mys_indexer_alt_graphql::args::KvArgs as GraphQlKvArgs;
use mys_indexer_alt_graphql::config::RpcConfig as GraphQlConfig;
use mys_indexer_alt_graphql::start_rpc as start_graphql;
use mys_indexer_alt_jsonrpc::NodeArgs as JsonRpcNodeArgs;
use mys_indexer_alt_jsonrpc::RpcArgs as JsonRpcArgs;
use mys_indexer_alt_jsonrpc::config::RpcConfig as JsonRpcConfig;
use mys_indexer_alt_jsonrpc::start_rpc as start_jsonrpc;
use mys_indexer_alt_reader::bigtable_reader::BigtableArgs;
use mys_indexer_alt_reader::consistent_reader::ConsistentReaderArgs;
use mys_indexer_alt_reader::fullnode_client::FullnodeArgs;
...
impl FullCluster {
    ...
    pub fn funded_account(
        &mut self,
        amount: u64,
    ) -> anyhow::Result<(MysAddress, AccountKeyPair, ObjectRef)> {
