...
// MYS_COIN_REGISTRY_OBJECT_ID doesn't exist yet - using placeholder
const MYS_COIN_REGISTRY_OBJECT_ID: mys_types::base_types::ObjectID = mys_types::base_types::ObjectID::from_address(move_core_types::account_address::AccountAddress::from_suffix(0xc));
...
pub async fn publish(
    ...
    package: &str,
) -> (MysAddress, Ed25519KeyPair, TransactionEffects) {
    // Compile the package
        ...
        .move_call(
            ...
            vec![
                CallArg::Object(ObjectArg::SharedObject {
                    id: MYS_COIN_REGISTRY_OBJECT_ID,
