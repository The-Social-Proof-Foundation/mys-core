...
use crate::{MysClient, MysClientBuilder, MYS_DEVNET_URL, MYS_LOCAL_NETWORK_URL, MYS_TESTNET_URL};
...
pub struct MysClientConfig {
    pub keystore: Keystore,
    pub envs: Vec<MysEnv>,
    pub active_env: Option<String>,
    pub active_address: Option<MysAddress>,
}

impl MysClientConfig {
    ...
    pub fn get_env(&self, alias: &Option<String>) -> Option<&MysEnv> {
    ...
    pub fn get_active_env(&self) -> Result<&MysEnv, anyhow::Error> {
    ...
    pub fn add_env(&mut self, env: MysEnv) {
        if !self
            .envs
            .iter()
...
impl MysEnv {
    ...
    ) -> Result<MysClient, anyhow::Error> {
        let mut builder = MysClientBuilder::default();
    ...
    pub fn localnet() -> Self {
        Self {
            ...
            rpc: MYS_LOCAL_NETWORK_URL.into(),
            ws: None,
            basic_auth: None,
        }
    }
...
impl Config for MysClientConfig {}

impl Display for MysClientConfig {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let mut writer = String::new();
