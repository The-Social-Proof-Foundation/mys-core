...
pub use mys_json_rpc_api::{TRANSACTION_EXECUTION_CLIENT_ERROR_CODE, TRANSIENT_ERROR_CODE};
use thiserror::Error;
...
pub struct Error {
    pub code: i32,
    pub message: String,
    // TODO: as this SDK is specialized for the Mys JSON RPC implementation, we should define structured representation for the data field if applicable
