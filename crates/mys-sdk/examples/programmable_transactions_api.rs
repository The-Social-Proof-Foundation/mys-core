...
// 1) finds a coin from the active address that has Mys,
// 2) splits the coin into one coin of 1000 MIST and the rest,
// 3  transfers the split coin to second Mys address,
