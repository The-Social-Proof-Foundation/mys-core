...
/// Data mapper impl
#[derive(Clone)]
pub struct MysDeepBookDataMapper {
    pub metrics: DeepBookIndexerMetrics,
    pub package_id: ObjectID,
}

impl DataMapper<CheckpointTxnData, ProcessedTxnData> for MysDeepBookDataMapper {
    fn map(
        &self,
        ...
        match &data.events {
            Some(events) => {
                ...
                if !processed_mys_events.is_empty() {
                    info!(
                        "MYS: Extracted {} deepbook data entries for tx {}.",
