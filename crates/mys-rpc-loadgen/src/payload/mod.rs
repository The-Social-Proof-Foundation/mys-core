...
use mys_types::{
    base_types::MysAddress, digests::TransactionDigest,
...
impl Command {
    ...
    pub fn new_pay_mys() -> Self {
        Self {
            data: CommandData::PayMys(PayMys {}),
            ..Default::default()
        }
    }
    ...
    pub fn new_get_all_balances(addresses: Vec<MysAddress>, chunk_size: usize) -> Self {
