...
impl ProjectType {
    pub fn create_project(
        ...
        // make sure we're in mysops
        let mysops_path = ensure_in_mysops_repo()?;
        info!("myspop path: {}", mysops_path);
        ...
        let project_subdir = match self {
            ...
            Self::Basic => Text::new("project subdir:")
                .with_initial_value(&format!("{}/pulumi/", mysops_path))
...
fn ensure_in_mysops_repo() -> Result<String> {
