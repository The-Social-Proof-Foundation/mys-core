...
use mys_types::MYS_CLOCK_ADDRESS;
...
const BLOOM_SKIP_ADDRESSES: &[AccountAddress] = &[AccountAddress::ZERO, MYS_CLOCK_ADDRESS];
...
mod tests {
    ...
    fn test_should_skip_for_bloom() {
        ...
        assert!(should_skip_for_bloom(MYS_CLOCK_ADDRESS.as_ref()));
