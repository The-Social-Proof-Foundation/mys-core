...
use mys_indexer_alt_framework::store::CommitterWatermark;
use mys_indexer_alt_framework::store::Store as _;
use mys_indexer_alt_framework::store::{self};
...
mod tests {
    ...
    use mys_indexer_alt_framework::store::Connection as _;
    use mys_indexer_alt_framework::store::TransactionalStore;
