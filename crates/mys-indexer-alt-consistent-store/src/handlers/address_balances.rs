...
use mys_indexer_alt_framework::pipeline::sequential;
use mys_indexer_alt_framework::types::base_types::MysAddress;
use mys_indexer_alt_framework::types::dynamic_field::Field;
...
fn try_extract_balance(obj: &Object) -> anyhow::Result<Option<(Key, u128)>> {
    ...
    let field: Field<MysAddress, u128> = bcs::from_bytes(move_obj.contents())
