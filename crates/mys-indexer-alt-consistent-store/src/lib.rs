...
//!
//! This crate defines a service that combines a [`mys_indexer_alt_framework`] indexer, with a gRPC
...
use mys_indexer_alt_consistent_api::proto::rpc::consistent::v1alpha::consistent_service_server::ConsistentServiceServer;
use mys_indexer_alt_consistent_api::proto::{self};
use mys_indexer_alt_framework::IndexerArgs;
use mys_indexer_alt_framework::ingestion::ClientArgs;
use mys_indexer_alt_framework::pipeline::CommitterConfig;
use mys_indexer_alt_framework::pipeline::sequential::SequentialConfig;
use mys_indexer_alt_framework::service::Service;
