...
//# run 0x3::mys_system::request_add_stake --args object(0x5) object(3,0) @validator_0 --sender C
...
//# run-graphql
{
  objects(filter: {type: "0x3::staking_pool::StakedMys"}) {
    edges {
      node {
        asMoveObject {
          contents {
...
//# run-graphql
# Fetch coins of 0x2::mys::MYS inner type
{
  objects(filter: {type: "0x2::coin::Coin<0x2::mys::MYS>"}) {
    edges {
      node {
        asMoveObject {
          contents {
