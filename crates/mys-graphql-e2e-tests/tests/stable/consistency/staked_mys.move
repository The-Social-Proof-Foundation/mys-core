...
//# run 0x3::mys_system::request_add_stake --args object(0x5) object(2,0) @validator_0 --sender C
...
//# run 0x3::mys_system::request_add_stake --args object(0x5) object(6,0) @validator_0 --sender C
