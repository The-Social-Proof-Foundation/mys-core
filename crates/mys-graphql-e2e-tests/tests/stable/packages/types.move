...
{
    type(type: "0x2::priority_queue::PriorityQueue<0x2::coin::Coin<0x2::mys::MYS>>") {
        repr
        signature
        layout
    }
...
{
    token: type(type: "0x2::token::Token<0x2::mys::MYS>") {
        abilities
    }

    coin: type(type: "0x2::coin::Coin<0x2::mys::MYS>") {
        abilities
    }

    balance: type(type: "0x2::balance::Balance<0x2::mys::MYS>") {
        abilities
    }

    coin_vector: type(type: "vector<0x2::coin::Coin<0x2::mys::MYS>>") {
        abilities
    }
