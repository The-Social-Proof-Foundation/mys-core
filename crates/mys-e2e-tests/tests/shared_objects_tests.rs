...
use mys_macros::{register_fail_point_async, sim_test};
...
/// Send a simple shared object transaction to Mys and ensures the client gets back a response.
#[sim_test]
...
/// End-to-end shared transaction test for a Mys validator. It does not test the client or wallet,
/// but tests the end-to-end flow from Mys to consensus.
#[sim_test]
