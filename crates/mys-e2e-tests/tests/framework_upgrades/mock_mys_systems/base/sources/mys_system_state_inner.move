...
module mys_system::mys_system_state_inner {
    ...
    public(package) fun create(
        ...
        let mut system_state = MysSystemStateInner {
            epoch: 0,
            protocol_version,
    ...
    public(package) fun protocol_version(self: &MysSystemStateInner): u64 { self.protocol_version }
    public(package) fun system_state_version(self: &MysSystemStateInner): u64 { self.system_state_version }
    public(package) fun genesis_system_state_version(): u64 {
        SYSTEM_STATE_VERSION_V1
    }

    public(package) fun add_dummy_inactive_validator_for_testing(self: &mut MysSystemStateInner, ctx: &mut TxContext) {
