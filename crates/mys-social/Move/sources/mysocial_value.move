...
module mysocial::mysocial_value {
    ...
    public struct SocialValue has key, store {
        id: UID,
        value: u64,
        owner: address,
    }
    ...
    // Event definitions
    public struct ValueCreatedEvent has copy, drop {
        value_id: address,
        initial_value: u64,
        owner: address,
    }
    
    public struct ValueUpdatedEvent has copy, drop {
        value_id: address,
        old_value: u64,
        new_value: u64,
        owner: address,
    ...
    public entry fun create_value(
        ...
        transfer::public_transfer(social_value, owner);
    }
