...
use mys_types::move_package;

use crate::consistency::{ConsistentIndexCursor, ConsistentNamedCursor};
use crate::error::Error;
use mys_package_resolver::Module as ParsedMoveModule;
...
use super::{base64::Base64, move_package::MovePackage, mys_address::MysAddress};

#[derive(Clone)]
pub(crate) struct MoveModule {
    pub storage_id: MysAddress,
    pub native: Vec<u8>,
