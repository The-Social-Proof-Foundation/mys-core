...
pub use profile::ProfileReadApiClient;
pub use profile::ProfileReadApiOpenRpc;
pub use profile::ProfileReadApiServer;
...
pub struct JsonRpcMetrics {
    ...
    pub get_stake_mys_result_size: Histogram,
    pub get_stake_mys_result_size_total: IntCounter,

    pub get_stake_mys_latency: Histogram,
    pub get_delegated_mys_latency: Histogram,
...
impl JsonRpcMetrics {
    pub fn new(registry: &prometheus::Registry) -> Self {
        Self {
            ...
            .unwrap(),
            get_stake_mys_result_size: register_histogram_with_registry!(
                "json_rpc_get_stake_mys_result_size",
                "The return size for get_stake_mys",
                mysten_metrics::COUNT_BUCKETS.to_vec(),
                registry,
            )
            .unwrap(),
            get_stake_mys_result_size_total: register_int_counter_with_registry!(
                "json_rpc_get_stake_mys_result_size_total",
                "The total return size for get_stake_mys",
                registry
            )
            .unwrap(),
            get_stake_mys_latency: register_histogram_with_registry!(
                "get_stake_mys_latency",
                "The latency of get stake mys, in ms",
                mysten_metrics::COARSE_LATENCY_SEC_BUCKETS.to_vec(),
                registry,
            )
            .unwrap(),
            get_delegated_mys_latency: register_histogram_with_registry!(
                "get_delegated_mys_latency",
                "The latency of get delegated mys, in ms",
                mysten_metrics::COARSE_LATENCY_SEC_BUCKETS.to_vec(),
                registry,
            )
            .unwrap(),
