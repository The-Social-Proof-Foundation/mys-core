...
use mys_json_rpc_types::{Balance, CoinPage, MysCoinMetadata};
use mys_open_rpc_macros::open_rpc;
use mys_types::balance::Supply;
use mys_types::base_types::MysAddress;

#[open_rpc(namespace = "mysx", tag = "Coin Query API")]
...
pub trait CoinReadApi {
    ...
    async fn get_coins(
        ...
        owner: MysAddress,
        /// optional type name for the coin (e.g., 0x168da5bf1f48dafc111b0a488fa454aca95e0b5e::usdc::USDC), default to 0x2::mys::MYS if not specified.
