...
use mys_json_rpc_types::{
    DynamicFieldPage, EventFilter, EventPage, ObjectsPage, MysEvent, MysObjectResponse,
...
#[open_rpc(namespace = "mysx", tag = "Extended API")]
...
pub trait IndexerApi {
    ...
    #[subscription(name = "subscribeTransaction", item = MysTransactionBlockEffects)]
