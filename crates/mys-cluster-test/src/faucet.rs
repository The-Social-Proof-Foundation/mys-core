...
pub trait FaucetClient {
    async fn request_mys_coins(&self, request_address: MysAddress) -> FaucetResponse;
    async fn batch_request_mys_coins(&self, request_address: MysAddress) -> BatchFaucetResponse;
...
impl FaucetClient for RemoteFaucetClient {
    /// Request test MYS coins from faucet.
