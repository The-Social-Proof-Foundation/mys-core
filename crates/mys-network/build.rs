...
fn main() -> Result<()> {
    ...
    let validator_service = Service::builder()
        .name("Validator")
        .package("mys.validator")
        .comment("The Validator interface")
        .method(
            Method::builder()
                .name("transaction")
                .route_name("Transaction")
                .input_type("mys_types::transaction::Transaction")
                .output_type("mys_types::messages_grpc::HandleTransactionResponse")
        ...
        .method(
            Method::builder()
                ...
                .input_type("mys_types::messages_grpc::HandleTransactionRequestV2")
                .output_type("mys_types::messages_grpc::HandleTransactionResponseV2")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("mys_types::transaction::CertifiedTransaction")
                .output_type("mys_types::messages_grpc::HandleCertificateResponseV2")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("mys_types::messages_grpc::HandleCertificateRequestV3")
                .output_type("mys_types::messages_grpc::HandleCertificateResponseV3")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("mys_types::messages_grpc::HandleSoftBundleCertificatesRequestV3")
                .output_type("mys_types::messages_grpc::HandleSoftBundleCertificatesResponseV3")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("mys_types::transaction::CertifiedTransaction")
                .output_type("mys_types::messages_grpc::SubmitCertificateResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("mys_types::messages_grpc::ObjectInfoRequest")
                .output_type("mys_types::messages_grpc::ObjectInfoResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("mys_types::messages_grpc::TransactionInfoRequest")
                .output_type("mys_types::messages_grpc::TransactionInfoResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("mys_types::messages_checkpoint::CheckpointRequest")
                .output_type("mys_types::messages_checkpoint::CheckpointResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("mys_types::messages_checkpoint::CheckpointRequestV2")
                .output_type("mys_types::messages_checkpoint::CheckpointResponseV2")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("mys_types::messages_grpc::SystemStateRequest")
                .output_type("mys_types::mys_system_state::MysSystemState")
                .codec_path(codec_path)
                .build(),
        )
        .build();
    ...
    let state_sync = anemo_build::manual::Service::builder()
        ...
        .method(
            anemo_build::manual::Method::builder()
                ...
                .request_type("mys_types::messages_checkpoint::CertifiedCheckpointSummary")
                .response_type("()")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            anemo_build::manual::Method::builder()
                ...
                .response_type("Option<mys_types::messages_checkpoint::CertifiedCheckpointSummary>")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            anemo_build::manual::Method::builder()
                ...
                .request_type("mys_types::messages_checkpoint::CheckpointContentsDigest")
                .response_type("Option<mys_types::messages_checkpoint::FullCheckpointContents>")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            anemo_build::manual::Method::builder()
                ...
                .request_type("mys_types::messages_checkpoint::CheckpointContentsDigest")
                .response_type("Option<mys_types::messages_checkpoint::VersionedFullCheckpointContents>")
                .codec_path(codec_path)
                .build(),
        )
        .method(
