...
#[derive(Parser)]
#[command(name = "mys-kvstore-alt")]
#[command(about = "KVStore indexer using mys-indexer-alt-framework")]
struct Args {
...
async fn main() -> Result<()> {
    ...
    info!("Starting mys-kvstore-alt indexer");
    ...
    let metrics_service =
        mys_indexer_alt_metrics::MetricsService::new(args.metrics_args, registry.clone());
