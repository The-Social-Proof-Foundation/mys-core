...
pub use crate::bigtable::progress_store::BigTableProgressStore;
...
pub use crate::CheckpointData as Checkpoint;

pub const CHECKPOINTS_PIPELINE: &str =
    <BigTableHandler<CheckpointsPipeline> as mys_indexer_alt_framework::pipeline::Processor>::NAME;
pub const CHECKPOINTS_BY_DIGEST_PIPELINE: &str =
    <BigTableHandler<CheckpointsByDigestPipeline> as mys_indexer_alt_framework::pipeline::Processor>::NAME;
pub const TRANSACTIONS_PIPELINE: &str =
    <BigTableHandler<TransactionsPipeline> as mys_indexer_alt_framework::pipeline::Processor>::NAME;
pub const OBJECTS_PIPELINE: &str =
    <BigTableHandler<ObjectsPipeline> as mys_indexer_alt_framework::pipeline::Processor>::NAME;
pub const OBJECT_TYPES_PIPELINE: &str =
    <BigTableHandler<ObjectTypesPipeline> as mys_indexer_alt_framework::pipeline::Processor>::NAME;
pub const EPOCH_START_PIPELINE: &str =
    <BigTableHandler<EpochStartPipeline> as mys_indexer_alt_framework::pipeline::Processor>::NAME;
pub const EPOCH_END_PIPELINE: &str =
    <BigTableHandler<EpochEndPipeline> as mys_indexer_alt_framework::pipeline::Processor>::NAME;
pub const EPOCH_LEGACY_PIPELINE: &str =
    <EpochLegacyPipeline as mys_indexer_alt_framework::pipeline::Processor>::NAME;
...
use mys_indexer_alt_framework::ingestion::IngestionConfig;
use mys_indexer_alt_framework::pipeline::concurrent::ConcurrentConfig;
...
pub struct EpochData {
    ...
    pub system_state: Option<mys_types::mys_system_state::MysSystemState>,
...
impl From<mys_indexer_alt_framework_store_traits::CommitterWatermark> for Watermark {
    fn from(w: mys_indexer_alt_framework_store_traits::CommitterWatermark) -> Self {
        Self {
...
impl From<Watermark> for mys_indexer_alt_framework_store_traits::CommitterWatermark {
