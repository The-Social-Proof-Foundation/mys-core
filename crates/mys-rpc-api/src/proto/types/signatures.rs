...
impl From<mys_sdk_types::ValidatorAggregatedSignature> for super::ValidatorAggregatedSignature {
...
impl TryFrom<&super::ValidatorAggregatedSignature> for mys_sdk_types::ValidatorAggregatedSignature {
...
impl From<mys_sdk_types::ValidatorCommitteeMember> for super::ValidatorCommitteeMember {
...
impl TryFrom<&super::ValidatorCommitteeMember> for mys_sdk_types::ValidatorCommitteeMember {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ValidatorCommittee> for super::ValidatorCommittee {
...
impl TryFrom<&super::ValidatorCommittee> for mys_sdk_types::ValidatorCommittee {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Bn254FieldElement> for super::Bn254FieldElement {
    fn from(value: mys_sdk_types::Bn254FieldElement) -> Self {
        Self {
...
impl TryFrom<&super::Bn254FieldElement> for mys_sdk_types::Bn254FieldElement {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::CircomG1> for super::CircomG1 {
...
impl TryFrom<&super::CircomG1> for mys_sdk_types::CircomG1 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::CircomG2> for super::CircomG2 {
...
impl TryFrom<&super::CircomG2> for mys_sdk_types::CircomG2 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Claim> for super::ZkLoginClaim {
    fn from(mys_sdk_types::Claim { value, index_mod_4 }: mys_sdk_types::Claim) -> Self {
        Self {
            value: Some(value),
...
impl TryFrom<&super::ZkLoginClaim> for mys_sdk_types::Claim {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ZkLoginProof> for super::ZkLoginProof {
...
impl TryFrom<&super::ZkLoginProof> for mys_sdk_types::ZkLoginProof {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ZkLoginInputs> for super::ZkLoginInputs {
    fn from(
        mys_sdk_types::ZkLoginInputs {
            proof_points,
            iss_base64_details,
            header_base64,
            address_seed,
...
impl TryFrom<&super::ZkLoginInputs> for mys_sdk_types::ZkLoginInputs {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ZkLoginAuthenticator> for super::ZkLoginAuthenticator {
...
impl TryFrom<&super::ZkLoginAuthenticator> for mys_sdk_types::ZkLoginAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&mys_sdk_types::ZkLoginPublicIdentifier> for super::ZkLoginPublicIdentifier {
...
impl TryFrom<&super::ZkLoginPublicIdentifier> for mys_sdk_types::ZkLoginPublicIdentifier {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::SignatureScheme> for super::SignatureScheme {
    fn from(value: mys_sdk_types::SignatureScheme) -> Self {
...
impl TryFrom<&super::SignatureScheme> for mys_sdk_types::SignatureScheme {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::SimpleSignature> for super::SimpleSignature {
...
impl TryFrom<&super::SimpleSignature> for mys_sdk_types::SimpleSignature {
    type Error = TryFromProtoError;

    fn try_from(value: &super::SimpleSignature) -> Result<Self, Self::Error> {
        use super::SignatureScheme;
        use super::SignatureScheme::*;
        use mys_sdk_types::{Ed25519PublicKey, Ed25519Signature};
        use mys_sdk_types::{
...
impl From<mys_sdk_types::PasskeyAuthenticator> for super::PasskeyAuthenticator {
...
impl TryFrom<&super::PasskeyAuthenticator> for mys_sdk_types::PasskeyAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&mys_sdk_types::MultisigMemberPublicKey> for super::MultisigMemberPublicKey {
...
impl TryFrom<&super::MultisigMemberPublicKey> for mys_sdk_types::MultisigMemberPublicKey {
    type Error = TryFromProtoError;

    fn try_from(value: &super::MultisigMemberPublicKey) -> Result<Self, Self::Error> {
        use super::multisig_member_public_key::Scheme;
        use mys_sdk_types::{Ed25519PublicKey, Secp256k1PublicKey, Secp256r1PublicKey};
...
impl From<&mys_sdk_types::MultisigMember> for super::MultisigMember {
...
impl TryFrom<&super::MultisigMember> for mys_sdk_types::MultisigMember {
    type Error = TryFromProtoError;
...
impl From<&mys_sdk_types::MultisigCommittee> for super::MultisigCommittee {
...
impl TryFrom<&super::MultisigCommittee> for mys_sdk_types::MultisigCommittee {
    type Error = TryFromProtoError;
...
impl From<&mys_sdk_types::MultisigMemberSignature> for super::MultisigMemberSignature {
...
impl TryFrom<&super::MultisigMemberSignature> for mys_sdk_types::MultisigMemberSignature {
    type Error = TryFromProtoError;

    fn try_from(value: &super::MultisigMemberSignature) -> Result<Self, Self::Error> {
        use super::multisig_member_signature::Signature;
        use mys_sdk_types::{Ed25519Signature, Secp256k1Signature, Secp256r1Signature};
...
impl From<&mys_sdk_types::MultisigAggregatedSignature> for super::MultisigAggregatedSignature {
...
impl TryFrom<&super::MultisigAggregatedSignature> for mys_sdk_types::MultisigAggregatedSignature {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::UserSignature> for super::UserSignature {
...
impl TryFrom<&super::UserSignature> for mys_sdk_types::UserSignature {
    type Error = TryFromProtoError;
