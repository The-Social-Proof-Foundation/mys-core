...
impl From<mys_sdk_types::CheckpointSummary> for super::CheckpointSummary {
    fn from(
        mys_sdk_types::CheckpointSummary {
            epoch,
            sequence_number,
...
impl TryFrom<&super::CheckpointSummary> for mys_sdk_types::CheckpointSummary {
...
impl From<mys_sdk_types::GasCostSummary> for super::GasCostSummary {
    fn from(
...
impl TryFrom<&super::GasCostSummary> for mys_sdk_types::GasCostSummary {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::CheckpointCommitment> for super::CheckpointCommitment {
...
impl TryFrom<&super::CheckpointCommitment> for mys_sdk_types::CheckpointCommitment {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::EndOfEpochData> for super::EndOfEpochData {
    fn from(
...
impl TryFrom<&super::EndOfEpochData> for mys_sdk_types::EndOfEpochData {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::CheckpointTransactionInfo> for super::CheckpointedTransactionInfo {
...
impl TryFrom<&super::CheckpointedTransactionInfo> for mys_sdk_types::CheckpointTransactionInfo {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::CheckpointContents> for super::CheckpointContents {
...
impl TryFrom<&super::CheckpointContents> for mys_sdk_types::CheckpointContents {
    type Error = TryFromProtoError;
