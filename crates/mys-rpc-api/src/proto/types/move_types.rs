...
impl From<mys_sdk_types::Identifier> for super::Identifier {
    fn from(value: mys_sdk_types::Identifier) -> Self {
        Self {
...
impl TryFrom<&super::Identifier> for mys_sdk_types::Identifier {
...
impl From<mys_sdk_types::StructTag> for super::StructTag {
    fn from(value: mys_sdk_types::StructTag) -> Self {
        Self {
...
impl TryFrom<&super::StructTag> for mys_sdk_types::StructTag {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TypeTag> for super::TypeTag {
...
impl TryFrom<&super::TypeTag> for mys_sdk_types::TypeTag {
    type Error = TryFromProtoError;
