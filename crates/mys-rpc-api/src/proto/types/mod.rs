...
include!("../generated/mys.types.rs");

/// Byte encoded FILE_DESCRIPTOR_SET.
pub const FILE_DESCRIPTOR_SET: &[u8] = include_bytes!("../generated/mys.types.fds.bin");
...
impl From<mys_sdk_types::Address> for Address {
    fn from(value: mys_sdk_types::Address) -> Self {
        Self {
...
impl TryFrom<&Address> for mys_sdk_types::Address {
...
impl From<mys_sdk_types::ObjectId> for ObjectId {
    fn from(value: mys_sdk_types::ObjectId) -> Self {
        Self {
...
impl TryFrom<&ObjectId> for mys_sdk_types::ObjectId {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Digest> for Digest {
    fn from(value: mys_sdk_types::Digest) -> Self {
        Self {
...
impl TryFrom<&Digest> for mys_sdk_types::Digest {
    type Error = TryFromProtoError;
...
macro_rules! impl_digest_proto {
    ($t:ident) => {
        impl From<mys_sdk_types::$t> for Digest {
            fn from(value: mys_sdk_types::$t) -> Self {
                mys_sdk_types::Digest::from(value).into()
            }
        }

        impl TryFrom<&Digest> for mys_sdk_types::$t {
            type Error = TryFromProtoError;

            fn try_from(digest: &Digest) -> Result<Self, Self::Error> {
                mys_sdk_types::Digest::try_from(digest).map(Into::into)
            }
        }
    };
}
