...
impl From<mys_sdk_types::TransactionEffects> for super::TransactionEffects {
    fn from(value: mys_sdk_types::TransactionEffects) -> Self {
        use super::transaction_effects::Version;
        use mys_sdk_types::TransactionEffects::*;
...
impl TryFrom<&super::TransactionEffects> for mys_sdk_types::TransactionEffects {
...
impl From<mys_sdk_types::TransactionEffectsV1> for super::TransactionEffectsV1 {
    fn from(
...
impl TryFrom<&super::TransactionEffectsV1> for mys_sdk_types::TransactionEffectsV1 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TransactionEffectsV2> for super::TransactionEffectsV2 {
    fn from(
...
impl TryFrom<&super::TransactionEffectsV2> for mys_sdk_types::TransactionEffectsV2 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ModifiedAtVersion> for super::ModifiedAtVersion {
    fn from(value: mys_sdk_types::ModifiedAtVersion) -> Self {
        Self {
...
impl TryFrom<&super::ModifiedAtVersion> for mys_sdk_types::ModifiedAtVersion {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ObjectReferenceWithOwner> for super::ObjectReferenceWithOwner {
    fn from(value: mys_sdk_types::ObjectReferenceWithOwner) -> Self {
        Self {
...
impl TryFrom<&super::ObjectReferenceWithOwner> for mys_sdk_types::ObjectReferenceWithOwner {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ChangedObject> for super::ChangedObject {
...
impl TryFrom<&super::ChangedObject> for mys_sdk_types::ChangedObject {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ObjectIn> for super::changed_object::InputState {
    fn from(value: mys_sdk_types::ObjectIn) -> Self {
        match value {
            mys_sdk_types::ObjectIn::NotExist => Self::NotExist(()),
...
impl TryFrom<&super::changed_object::InputState> for mys_sdk_types::ObjectIn {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ObjectOut> for super::changed_object::OutputState {
    fn from(value: mys_sdk_types::ObjectOut) -> Self {
        use mys_sdk_types::ObjectOut::*;
        match value {
...
impl TryFrom<&super::changed_object::OutputState> for mys_sdk_types::ObjectOut {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::IdOperation> for super::changed_object::IdOperation {
...
impl TryFrom<&super::changed_object::IdOperation> for mys_sdk_types::IdOperation {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::UnchangedSharedObject> for super::UnchangedSharedObject {
    fn from(value: mys_sdk_types::UnchangedSharedObject) -> Self {
        Self {
            object_id: Some(value.object_id.into()),
...
impl TryFrom<&super::UnchangedSharedObject> for mys_sdk_types::UnchangedSharedObject {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::UnchangedSharedKind> for super::unchanged_shared_object::Kind {
    fn from(value: mys_sdk_types::UnchangedSharedKind) -> Self {
        use mys_sdk_types::UnchangedSharedKind::*;
...
impl TryFrom<&super::unchanged_shared_object::Kind> for mys_sdk_types::UnchangedSharedKind {
    type Error = TryFromProtoError;
