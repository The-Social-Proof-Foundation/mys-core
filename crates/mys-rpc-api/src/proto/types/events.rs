...
impl From<mys_sdk_types::Event> for super::Event {
...
impl TryFrom<&super::Event> for mys_sdk_types::Event {
...
impl From<mys_sdk_types::TransactionEvents> for super::TransactionEvents {
...
impl TryFrom<&super::TransactionEvents> for mys_sdk_types::TransactionEvents {
    type Error = TryFromProtoError;
