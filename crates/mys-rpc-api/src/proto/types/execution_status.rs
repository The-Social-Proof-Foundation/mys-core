...
impl From<mys_sdk_types::ExecutionStatus> for super::ExecutionStatus {
    fn from(value: mys_sdk_types::ExecutionStatus) -> Self {
        match value {
            ...
            mys_sdk_types::ExecutionStatus::Failure { error, command } => Self {
                success: Some(false),
...
impl TryFrom<&super::ExecutionStatus> for mys_sdk_types::ExecutionStatus {
...
impl From<mys_sdk_types::ExecutionError> for super::failure_status::ExecutionError {
    fn from(value: mys_sdk_types::ExecutionError) -> Self {
        use mys_sdk_types::ExecutionError::*;
        match value {
...
impl TryFrom<&super::failure_status::ExecutionError> for mys_sdk_types::ExecutionError {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::CommandArgumentError> for super::command_argument_error::Kind {
    fn from(value: mys_sdk_types::CommandArgumentError) -> Self {
        use mys_sdk_types::CommandArgumentError::*;
...
impl TryFrom<&super::command_argument_error::Kind> for mys_sdk_types::CommandArgumentError {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TypeArgumentError> for super::type_argument_error::Kind {
...
impl TryFrom<&super::type_argument_error::Kind> for mys_sdk_types::TypeArgumentError {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::PackageUpgradeError> for super::package_upgrade_error::Kind {
    fn from(value: mys_sdk_types::PackageUpgradeError) -> Self {
        use mys_sdk_types::PackageUpgradeError::*;
...
impl TryFrom<&super::package_upgrade_error::Kind> for mys_sdk_types::PackageUpgradeError {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::MoveLocation> for super::MoveLocation {
...
impl TryFrom<&super::MoveLocation> for mys_sdk_types::MoveLocation {
    type Error = TryFromProtoError;
