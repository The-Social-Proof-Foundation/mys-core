...
impl From<mys_sdk_types::Transaction> for super::Transaction {
...
impl TryFrom<&super::Transaction> for mys_sdk_types::Transaction {
...
impl From<mys_sdk_types::Transaction> for super::transaction::TransactionV1 {
    fn from(value: mys_sdk_types::Transaction) -> Self {
        Self {
...
impl TryFrom<&super::transaction::TransactionV1> for mys_sdk_types::Transaction {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::GasPayment> for super::GasPayment {
...
impl TryFrom<&super::GasPayment> for mys_sdk_types::GasPayment {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TransactionExpiration> for super::TransactionExpiration {
...
impl TryFrom<&super::TransactionExpiration> for mys_sdk_types::TransactionExpiration {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TransactionKind> for super::TransactionKind {
...
impl TryFrom<&super::TransactionKind> for mys_sdk_types::TransactionKind {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ConsensusCommitPrologue> for super::ConsensusCommitPrologue {
...
impl TryFrom<&super::ConsensusCommitPrologue> for mys_sdk_types::ConsensusCommitPrologue {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ConsensusCommitPrologueV2> for super::ConsensusCommitPrologue {
...
impl TryFrom<&super::ConsensusCommitPrologue> for mys_sdk_types::ConsensusCommitPrologueV2 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ConsensusCommitPrologueV3> for super::ConsensusCommitPrologue {
...
impl TryFrom<&super::ConsensusCommitPrologue> for mys_sdk_types::ConsensusCommitPrologueV3 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::CancelledTransaction> for super::CancelledTransaction {
    fn from(value: mys_sdk_types::CancelledTransaction) -> Self {
        Self {
...
impl TryFrom<&super::CancelledTransaction> for mys_sdk_types::CancelledTransaction {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::VersionAssignment> for super::VersionAssignment {
...
impl TryFrom<&super::VersionAssignment> for mys_sdk_types::VersionAssignment {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::GenesisTransaction> for super::GenesisTransaction {
...
impl TryFrom<&super::GenesisTransaction> for mys_sdk_types::GenesisTransaction {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::RandomnessStateUpdate> for super::RandomnessStateUpdate {
...
impl TryFrom<&super::RandomnessStateUpdate> for mys_sdk_types::RandomnessStateUpdate {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::AuthenticatorStateUpdate> for super::AuthenticatorStateUpdate {
...
impl TryFrom<&super::AuthenticatorStateUpdate> for mys_sdk_types::AuthenticatorStateUpdate {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Jwk> for super::Jwk {
...
impl TryFrom<&super::Jwk> for mys_sdk_types::Jwk {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::JwkId> for super::JwkId {
...
impl TryFrom<&super::JwkId> for mys_sdk_types::JwkId {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ActiveJwk> for super::ActiveJwk {
...
impl TryFrom<&super::ActiveJwk> for mys_sdk_types::ActiveJwk {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ChangeEpoch> for super::ChangeEpoch {
...
impl TryFrom<&super::ChangeEpoch> for mys_sdk_types::ChangeEpoch {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::SystemPackage> for super::SystemPackage {
...
impl TryFrom<&super::SystemPackage> for mys_sdk_types::SystemPackage {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::EndOfEpochTransactionKind> for super::EndOfEpochTransactionKind {
    fn from(value: mys_sdk_types::EndOfEpochTransactionKind) -> Self {
        use super::end_of_epoch_transaction_kind::Kind;
        use mys_sdk_types::EndOfEpochTransactionKind::*;
...
impl TryFrom<&super::EndOfEpochTransactionKind> for mys_sdk_types::EndOfEpochTransactionKind {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::AuthenticatorStateExpire> for super::AuthenticatorStateExpire {
...
impl TryFrom<&super::AuthenticatorStateExpire> for mys_sdk_types::AuthenticatorStateExpire {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ProgrammableTransaction> for super::ProgrammableTransaction {
...
impl TryFrom<&super::ProgrammableTransaction> for mys_sdk_types::ProgrammableTransaction {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Input> for super::Input {
...
impl TryFrom<&super::Input> for mys_sdk_types::Input {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Argument> for super::Argument {
...
impl From<mys_sdk_types::Command> for super::Command {
...
impl TryFrom<&super::Command> for mys_sdk_types::Command {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::MoveCall> for super::MoveCall {
...
impl TryFrom<&super::MoveCall> for mys_sdk_types::MoveCall {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TransferObjects> for super::TransferObjects {
...
impl TryFrom<&super::TransferObjects> for mys_sdk_types::TransferObjects {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::SplitCoins> for super::SplitCoins {
...
impl TryFrom<&super::SplitCoins> for mys_sdk_types::SplitCoins {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::MergeCoins> for super::MergeCoins {
...
impl TryFrom<&super::MergeCoins> for mys_sdk_types::MergeCoins {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Publish> for super::Publish {
...
impl TryFrom<&super::Publish> for mys_sdk_types::Publish {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::MakeMoveVector> for super::MakeMoveVector {
...
impl TryFrom<&super::MakeMoveVector> for mys_sdk_types::MakeMoveVector {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Upgrade> for super::Upgrade {
...
impl TryFrom<&super::Upgrade> for mys_sdk_types::Upgrade {
    type Error = TryFromProtoError;
