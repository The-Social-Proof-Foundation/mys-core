...
impl From<mys_sdk_types::ObjectReference> for super::ObjectReference {
...
impl TryFrom<&super::ObjectReference> for mys_sdk_types::ObjectReference {
...
impl From<mys_sdk_types::Object> for super::Object {
...
impl TryFrom<&super::Object> for mys_sdk_types::Object {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Owner> for super::Owner {
...
impl TryFrom<&super::Owner> for mys_sdk_types::Owner {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ObjectData> for super::ObjectData {
    fn from(value: mys_sdk_types::ObjectData) -> Self {
        use super::object_data::Kind;
        use mys_sdk_types::ObjectData::*;
...
impl TryFrom<&super::ObjectData> for mys_sdk_types::ObjectData {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::MoveStruct> for super::MoveStruct {
    fn from(value: mys_sdk_types::MoveStruct) -> Self {
        Self {
            object_id: Some(value.object_id().into()),
...
impl TryFrom<&super::MoveStruct> for mys_sdk_types::MoveStruct {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::MovePackage> for super::MovePackage {
    fn from(value: mys_sdk_types::MovePackage) -> Self {
        let modules = value
            .modules
            .into_iter()
...
impl TryFrom<&super::MovePackage> for mys_sdk_types::MovePackage {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TypeOrigin> for super::TypeOrigin {
...
impl TryFrom<&super::TypeOrigin> for mys_sdk_types::TypeOrigin {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::GenesisObject> for super::GenesisObject {
...
impl TryFrom<&super::GenesisObject> for mys_sdk_types::GenesisObject {
    type Error = TryFromProtoError;
