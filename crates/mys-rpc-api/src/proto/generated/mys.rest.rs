...
/// Mys `TransactionData` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Transaction {
    #[prost(bytes = "bytes", tag = "1")]
    pub transaction: ::prost::bytes::Bytes,
}
/// Mys `TransactionEffects` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct TransactionEffects {
    #[prost(bytes = "bytes", tag = "1")]
    pub effects: ::prost::bytes::Bytes,
}
/// Mys `TransactionEvents` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct TransactionEvents {
    #[prost(bytes = "bytes", tag = "1")]
    pub events: ::prost::bytes::Bytes,
}
/// Mys `Object` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Object {
    #[prost(bytes = "bytes", tag = "1")]
    pub object: ::prost::bytes::Bytes,
}
/// Mys `CheckpointSummary` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CheckpointSummary {
    #[prost(bytes = "bytes", tag = "1")]
    pub summary: ::prost::bytes::Bytes,
}
/// Mys `CheckpointContents` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CheckpointContents {
    #[prost(bytes = "bytes", tag = "1")]
    pub contents: ::prost::bytes::Bytes,
}
/// Mys `UserSignature` type serialized as bytes
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UserSignature {
    #[prost(bytes = "bytes", tag = "1")]
    pub signature: ::prost::bytes::Bytes,
}
/// Mys `ValidatorAggregatedSignature` type serialized as Bcs
#[derive(Clone, PartialEq, ::prost::Message)]
