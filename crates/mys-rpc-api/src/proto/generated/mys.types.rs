...
pub struct Bcs {
    ...
    #[prost(bytes = "vec", optional, tag = "1")]
    pub bcs: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
}
...
pub mod checkpoint_commitment {
    ...
    pub enum Commitment {
        ...
        /// state of the MySocial blockchain.
        #[prost(message, tag = "1")]
...
pub mod multisig_member_public_key {
    ...
    pub enum Scheme {
        ...
        #[prost(bytes, tag = "3")]
        Secp256r1(::prost::alloc::vec::Vec<u8>),
...
pub struct Bn254FieldElement {
    ...
    #[prost(bytes = "vec", optional, tag = "1")]
    pub element: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
}
