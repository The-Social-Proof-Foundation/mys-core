...
pub struct ListAuthenticatedEventsRequest {
    /// Required. Stream identifier (Mys address) of the event stream.
...
pub struct AuthenticatedEvent {
    ...
    pub event: ::core::option::Option<::mys_rpc::proto::mys::rpc::v2::Event>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/mys.rpc.alpha.EventService/ListAuthenticatedEvents",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "mys.rpc.alpha.EventService",
...
pub mod event_service_server {
    ...
    pub const SERVICE_NAME: &str = "mys.rpc.alpha.EventService";
...
pub struct GetObjectInclusionProofResponse {
    ...
    pub object_ref: ::core::option::Option<
        ::mys_rpc::proto::mys::rpc::v2::ObjectReference,
    >,
...
pub mod proof_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.rpc.alpha.ProofService/GetObjectInclusionProof",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "mys.rpc.alpha.ProofService",
...
pub mod proof_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "mys.rpc.alpha.ProofService";
