...
pub struct DynamicField {
    ...
    pub name_value: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2alpha.NodeService/GetCoinInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mys.node.v2alpha.NodeService", "GetCoinInfo"));
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2alpha.NodeService/ListDynamicFields",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("mys.node.v2alpha.NodeService", "ListDynamicFields"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2alpha.NodeService/ListAccountObjects",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("mys.node.v2alpha.NodeService", "ListAccountObjects"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2alpha.NodeService/GetProtocolConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("mys.node.v2alpha.NodeService", "GetProtocolConfig"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2alpha.NodeService/GetGasInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mys.node.v2alpha.NodeService", "GetGasInfo"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2alpha.NodeService/SimulateTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "mys.node.v2alpha.NodeService",
                        "SimulateTransaction",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2alpha.NodeService/ResolveTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("mys.node.v2alpha.NodeService", "ResolveTransaction"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod node_service_server {
    ...
    pub const SERVICE_NAME: &str = "mys.node.v2alpha.NodeService";
...
pub mod subscription_service_client {
    ...
    use tonic::codegen::*;
    use tonic::codegen::http::Uri;
    /// Service for subscribing to data from a MySocial Fullnode
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// mys.node.v2.NodeService.GetFullCheckpoint) in order to request data for
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2alpha.SubscriptionService/SubscribeCheckpoints",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "mys.node.v2alpha.SubscriptionService",
...
pub mod subscription_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "mys.node.v2alpha.SubscriptionService";
