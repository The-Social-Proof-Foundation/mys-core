...
pub struct GetNodeInfoResponse {
    ...
    /// Software version of the `mys-node` binary.
...
pub struct GetCommitteeRequest {
    /// Optional. Request the mys.types.ValidatorCommittee corresponding to the
...
pub struct GetTransactionOptions {
    /// Include the `mys.types.Transaction` message in the response.
    ///
    ...
    /// Include the set of `mys.types.UserSignature`s in the response.
    ///
    /// Defaults to `false` if not included.
    ...
    /// Include the `mys.types.TransactionEffects` message in the response.
    ///
    /// Defaults to `false` if not included.
    ...
    /// Include the `mys.types.TransactionEvents` message in the response.
    ///
    /// Defaults to `false` if not included.
...
pub struct GetTransactionResponse {
    /// The digest of this [Transaction](<https://docs.rs/mys-sdk-types/latest/mys_sdk_types/struct.Transaction.html>).
    #[prost(message, optional, tag = "1")]
    pub digest: ::core::option::Option<super::super::types::Digest>,
    ...
    /// Optional. The
    /// [Transaction](<https://docs.rs/mys-sdk-types/latest/mys_sdk_types/struct.Transaction.html>)
    ...
    /// Optional. List of
    /// [UserSignature](<https://docs.rs/mys-sdk-types/latest/mys_sdk_types/struct.UserSignature.html>)s
    /// encoded as bytes.
    #[prost(bytes = "vec", repeated, tag = "11")]
    pub signatures_bytes: ::prost::alloc::vec::Vec<::prost::alloc::vec::Vec<u8>>,
    /// Optional. The `TransactionEffects` for this transaction.
    #[prost(message, optional, tag = "5")]
    pub effects: ::core::option::Option<super::super::types::TransactionEffects>,
    /// Optional. The
    /// [TransactionEffects](<https://docs.rs/mys-sdk-types/latest/mys_sdk_types/struct.TransactionEffects.html>)
    ...
    /// Optional. The
    /// [TransactionEvents](<https://docs.rs/mys-sdk-types/latest/mys_sdk_types/struct.TransactionEvents.html>)
    /// for this transaction encoded as BCS bytes.
...
pub struct GetObjectOptions {
    /// Include the `mys.types.Object` message in the response.
    ///
    /// Defaults to `false` if not included.
    #[prost(bool, optional, tag = "1")]
...
pub struct GetObjectResponse {
    ...
    /// Optional. The
    /// [Object](<https://docs.rs/mys-sdk-types/latest/mys_sdk_types/struct.Object.html>)
    /// encoded as BCS bytes.
    #[prost(message, optional, tag = "5")]
...
pub struct GetCheckpointOptions {
    /// Include the `mys.types.CheckpointSummary` in the response.
    ///
    /// Defaults to `false` if not included.
    #[prost(bool, optional, tag = "3")]
    ...
    /// Include the `mys.types.ValidatorAggregatedSignature` in the response.
    ///
    /// Defaults to `false` if not included.
    #[prost(bool, optional, tag = "5")]
    pub signature: ::core::option::Option<bool>,
    /// Include the `mys.types.CheckpointContents` message in the response.
    ///
    /// Defaults to `false` if not included.
    #[prost(bool, optional, tag = "6")]
...
pub struct GetCheckpointResponse {
    ...
    /// Optional. The
    /// [CheckpointSummary](<https://docs.rs/mys-sdk-types/latest/mys_sdk_types/struct.CheckpointSummary.html>)
    ...
    /// Optional. The
    /// [CheckpointContents](<https://docs.rs/mys-sdk-types/latest/mys_sdk_types/struct.CheckpointContents.html>)
    /// for this checkpoint encoded as BCS bytes.
    #[prost(message, optional, tag = "7")]
...
pub mod node_service_client {
    ...
    /// Service for reading data from a MySocial Fullnode.
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2.NodeService/GetNodeInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mys.node.v2.NodeService", "GetNodeInfo"));
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2.NodeService/GetCommittee",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mys.node.v2.NodeService", "GetCommittee"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2.NodeService/GetObject",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mys.node.v2.NodeService", "GetObject"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2.NodeService/GetTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mys.node.v2.NodeService", "GetTransaction"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2.NodeService/GetCheckpoint",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mys.node.v2.NodeService", "GetCheckpoint"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2.NodeService/GetFullCheckpoint",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mys.node.v2.NodeService", "GetFullCheckpoint"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mys.node.v2.NodeService/ExecuteTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("mys.node.v2.NodeService", "ExecuteTransaction"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod node_service_server {
    ...
    pub const SERVICE_NAME: &str = "mys.node.v2.NodeService";
