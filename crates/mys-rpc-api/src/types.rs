...
pub const X_MYS_CHAIN_ID: &str = "x-mys-chain-id";

/// Chain name of the current chain
pub const X_MYS_CHAIN: &str = "x-mys-chain";

/// Current checkpoint height
pub const X_MYS_CHECKPOINT_HEIGHT: &str = "x-mys-checkpoint-height";
...
///  - effects
///  - events
pub const X_MYS_LOWEST_AVAILABLE_CHECKPOINT: &str = "x-mys-lowest-available-checkpoint";
...
/// available.
pub const X_MYS_LOWEST_AVAILABLE_CHECKPOINT_OBJECTS: &str =
    "x-mys-lowest-available-checkpoint-objects";

/// Current epoch of the chain
pub const X_MYS_EPOCH: &str = "x-mys-epoch";
...
pub const X_MYS_CURSOR: &str = "x-mys-cursor";

/// Current timestamp of the chain - represented as number of milliseconds from the Unix epoch
pub const X_MYS_TIMESTAMP_MS: &str = "x-mys-timestamp-ms";
...
pub struct NodeInfo {
    ...
    pub chain_id: mys_sdk_types::CheckpointDigest,

    /// Human readable name of the chain that this Node is on
    pub chain: std::borrow::Cow<'static, str>,

    /// Current epoch of the Node based on its highest executed checkpoint
    #[serde_as(as = "mys_types::mys_serde::BigInt<u64>")]
    pub epoch: u64,
    ...
    #[serde_as(as = "Option<mys_types::mys_serde::BigInt<u64>>")]
...
pub struct ObjectResponse {
    pub object_id: mys_sdk_types::ObjectId,
    #[serde_as(as = "mys_types::mys_serde::BigInt<u64>")]
    pub version: mys_sdk_types::Version,
    pub digest: mys_sdk_types::ObjectDigest,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub object: Option<mys_sdk_types::Object>,
...
pub struct CheckpointResponse {
    #[serde_as(as = "mys_types::mys_serde::BigInt<u64>")]
    pub sequence_number: mys_sdk_types::CheckpointSequenceNumber,

    pub digest: mys_sdk_types::CheckpointDigest,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub summary: Option<mys_sdk_types::CheckpointSummary>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub signature: Option<mys_sdk_types::ValidatorAggregatedSignature>,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub contents: Option<mys_sdk_types::CheckpointContents>,
...
pub struct TransactionResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub transaction: Option<mys_sdk_types::Transaction>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub signatures: Option<Vec<mys_sdk_types::UserSignature>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub effects: Option<mys_sdk_types::TransactionEffects>,
    ...
    #[serde_as(
        as = "Option<mys_types::mys_serde::Readable<mys_types::mys_serde::BigInt<u64>, _>>"
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct ExecuteTransactionResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub balance_changes: Option<Vec<mys_sdk_types::BalanceChange>>,
    // pub input_objects: Option<Vec<mys_sdk_types::Object>>,
    // pub output_objects: Option<Vec<mys_sdk_types::Object>>,
}
...
pub enum EffectsFinality {
    Certified {
        ...
        signature: mys_sdk_types::ValidatorAggregatedSignature,
    },
    Checkpointed {
        #[serde_as(as = "mys_types::mys_serde::Readable<mys_types::mys_serde::BigInt<u64>, _>")]
        checkpoint: mys_sdk_types::CheckpointSequenceNumber,
    },
    QuorumExecuted,
}
