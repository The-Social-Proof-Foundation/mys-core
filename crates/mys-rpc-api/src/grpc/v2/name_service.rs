...
use mys_name_service::Domain;
use mys_name_service::NameRecord;
use mys_name_service::NameServiceConfig;
use mys_rpc::proto::timestamp_ms_to_proto;
...
use mys_rpc::proto::mys::rpc::v2::LookupNameRequest;
use mys_rpc::proto::mys::rpc::v2::LookupNameResponse;
use mys_rpc::proto::mys::rpc::v2::ReverseLookupNameRequest;
use mys_rpc::proto::mys::rpc::v2::ReverseLookupNameResponse;
use mys_rpc::proto::mys::rpc::v2::name_service_server::NameService;
...
fn name_service_config(service: &RpcService) -> Result<NameServiceConfig> {
    match service.chain_id.chain() {
        mys_protocol_config::Chain::Mainnet => Ok(NameServiceConfig::mainnet()),
        mys_protocol_config::Chain::Testnet => Ok(NameServiceConfig::testnet()),
        mys_protocol_config::Chain::Unknown => Err(RpcError::new(
            tonic::Code::Unimplemented,
            "MysNS not configured for this network",
        )),
    }
}
...
fn lookup_name(service: &RpcService, request: LookupNameRequest) -> Result<LookupNameResponse> {
    ...
    if is_valid {
        let mut record = mys_rpc::proto::mys::rpc::v2::NameRecord::default();
...
fn reverse_lookup_name(
    ...
    let domain = field_reverse_record_object
        .to_rust::<mys_types::dynamic_field::Field<Address, Domain>>()
        .ok_or_else(|| {
            RpcError::new(
                tonic::Code::Internal,
