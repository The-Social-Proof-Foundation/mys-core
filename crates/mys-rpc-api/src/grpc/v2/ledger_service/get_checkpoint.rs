...
use mys_rpc::proto::mys::rpc::v2::Checkpoint;
use mys_rpc::proto::mys::rpc::v2::Event;
...
use mys_rpc::proto::mys::rpc::v2::TransactionEvents;
use mys_rpc::proto::mys::rpc::v2::get_checkpoint_request::CheckpointId;
...
pub fn get_checkpoint(
        ...
        || read_mask.contains(Checkpoint::OBJECTS_FIELD.name)
    {
        ...
        if read_mask.contains(Checkpoint::CONTENTS_FIELD.name) {
            checkpoint.merge(&core_contents, &read_mask);
        }
                ...
                checkpoint.transactions = checkpoint_data
                    ...
                    .map(|t| {
                        ...
                        transaction.timestamp = submask
                            ...
                            .then(|| mys_rpc::proto::timestamp_ms_to_proto(timestamp_ms));
