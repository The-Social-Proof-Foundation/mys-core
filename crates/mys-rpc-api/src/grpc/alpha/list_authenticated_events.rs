...
use mys_rpc::proto::mys::rpc::v2::{Bcs, Event};
...
fn to_grpc_event(ev: &mys_types::event::Event) -> Event {
...
pub fn list_authenticated_events(
    ...
    let stream_addr = MysAddress::from_str(&stream_id).map_err(|e| {
        RpcError::new(
            tonic::Code::InvalidArgument,
