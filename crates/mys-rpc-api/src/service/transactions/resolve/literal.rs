...
use mys_sdk_transaction_builder::unresolved::Value;
use mys_sdk_types::Command;
use mys_sdk_types::ObjectId;
use mys_types::base_types::ObjectID;
use mys_types::base_types::STD_ASCII_MODULE_NAME;
use mys_types::base_types::STD_ASCII_STRUCT_NAME;
use mys_types::base_types::STD_OPTION_MODULE_NAME;
use mys_types::base_types::STD_OPTION_STRUCT_NAME;
use mys_types::base_types::STD_UTF8_MODULE_NAME;
use mys_types::base_types::STD_UTF8_STRUCT_NAME;
        ...
        match (command, idx) {
            ...
            (Command::MakeMoveVector(make_move_vector), Some(_)) => {
                if let Some(ty) = &make_move_vector.type_ {
                    let ty =
                        mys_types::mys_sdk_types_conversions::type_tag_sdk_to_core(ty.clone())?;
