...
fn called_packages(
    ...
    let binary_config = mys_types::execution_config_utils::to_binary_config(protocol_config);
...
fn resolve_arg(
    ...
    use mys_sdk_transaction_builder::unresolved::InputKind::*;
...
fn resolve_object(
    ...
    digest: Option<mys_sdk_types::ObjectDigest>,
