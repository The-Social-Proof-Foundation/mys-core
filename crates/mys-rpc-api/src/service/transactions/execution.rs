...
impl RpcService {
    pub async fn execute_transaction(
        ...
        let request = mys_types::quorum_driver_types::ExecuteTransactionRequestV3 {
        ...
        let (effects, finality) = {
            let mys_types::quorum_driver_types::FinalizedEffects {
                effects,
                finality_info,
            } = effects;
            let finality = match finality_info {
                mys_types::quorum_driver_types::EffectsFinalityInfo::Certified(sig) => {
                    EffectsFinality::Certified {
                        signature: sig.into(),
                    }
                }
                mys_types::quorum_driver_types::EffectsFinalityInfo::Checkpointed(
                    _epoch,
                    checkpoint,
                ) => EffectsFinality::Checkpointed { checkpoint },
                mys_types::quorum_driver_types::EffectsFinalityInfo::QuorumExecuted(_) => {
