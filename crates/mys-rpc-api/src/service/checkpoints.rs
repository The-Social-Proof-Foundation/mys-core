...
use mys_sdk_types::CheckpointContents;
use mys_sdk_types::CheckpointDigest;
use mys_sdk_types::CheckpointSequenceNumber;
use mys_sdk_types::SignedCheckpointSummary;
use tap::Pipe;
...
pub(crate) fn checkpoint_data_to_full_checkpoint_response(
    mys_types::full_checkpoint_content::CheckpointData {
        checkpoint_summary,
        checkpoint_contents,
        transactions,
    }: mys_types::full_checkpoint_content::CheckpointData,
