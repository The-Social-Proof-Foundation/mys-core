...
pub const DEFAULT_CONFIG_PATH: &str = "~/.mys-replay/network-config.yaml";
...
impl Default for ReplayableNetworkConfigSet {
    fn default() -> Self {
        let testnet = ReplayableNetworkBaseConfig {
            ...
            epoch_zero_rgp: 0,
            public_full_node: url_from_str("https://fullnode.testnet.mysocial.network:8082")
        ...
        let devnet = ReplayableNetworkBaseConfig {
            ...
            epoch_zero_start_timestamp: 0,
            epoch_zero_rgp: 0,
            public_full_node: url_from_str("https://fullnode.devnet.mysocial.network:8082")
                .expect("invalid socket address")
                .to_string(),
        };
        let mainnet = ReplayableNetworkBaseConfig {
            ...
            epoch_zero_start_timestamp: 0,
            epoch_zero_rgp: 0,
            public_full_node: url_from_str("https://fullnode.mainnet.mysocial.network:8082")
                .expect("invalid socket address")
                .to_string(),
        };
