...
mod tests {
    ...
    fn test_parse_types() {
        let inputs = vec![
            ...
            "mys::object::ID",
            "0x2::object::UID",
            "3::staking_pool::StakedMys",
            // Generic types
            "0x2::coin::Coin<2::mys::MYS>",
            "mys::table::Table<mys::object::ID, vector<0x1::option::Option<u32>>>",
        ];
        let mut parsed = Vec::new();
        for input in inputs {
            let mut x = shlex::split(input).unwrap();
    ...
    fn test_parse_commands() {
        let inputs = vec![
            ...
            // Move Call
            "--move-call 0x3::mys_system::request_add_stake system coins.0 validator",
