...
pub struct FrameworkPackage {
    /// The name of the package, e.g. "Mys"
    pub package_name: String,

    /// The path to the package in the mys monorepo
    /// e.g. "crates/mys-framework/packages/mys-framework"
...
fn test_exact_version() {
    ...
    assert!(framework.packages.iter().any(|p| p.package_name == "Mys"));
}
