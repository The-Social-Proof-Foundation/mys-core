...
use mys_types::{base_types::ObjectID, Identifier};
...
///
/// This function is used to render Clever Errors for on-chain errors only within the Mys CLI. This
...
pub(crate) async fn render_clever_error_opt(
    ...
    let error = 'error: {
        ...
        let MysRawData::Package(package) = read_api
