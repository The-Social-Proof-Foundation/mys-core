...
// 1. Run `cargo insta test --review` under `./mys-config`.
...
fn populated_genesis_snapshot_matches() {
    ...
    let genesis = Builder::new()
        ...
        .build();
    assert_yaml_snapshot!(genesis.mys_system_wrapper_object());
