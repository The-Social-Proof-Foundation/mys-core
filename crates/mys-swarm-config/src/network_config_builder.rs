...
use mys_types::base_types::{AuthorityName, MysAddress};
use mys_types::committee::{Committee, ProtocolVersion};
use mys_types::crypto::{get_key_pair_from_rng, AccountKeyPair, KeypairTraits, PublicKey};
    ...
    pub fn build(self) -> NetworkConfig {
        ...
        let token_distribution_schedule = {
            ...
            for validator in &validators {
                ...
                let address = MysAddress::from(&account_key);
        ...
        let genesis = {
            let mut builder = mys_genesis_builder::Builder::new()
...
mod test {
    ...
    fn genesis_transaction() {
        ...
        let genesis = network_config.genesis;
        let protocol_version = ProtocolVersion::new(genesis.mys_system_object().protocol_version());
