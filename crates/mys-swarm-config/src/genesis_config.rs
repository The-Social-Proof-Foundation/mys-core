...
use mys_genesis_builder::validator_info::{GenesisValidatorInfo, ValidatorInfo};
...
pub struct ValidatorGenesisConfig {
    ...
    #[serde(default = "default_mys_key_pair")]
    pub account_key_pair: MysKeyPair,
    #[serde(default = "default_ed25519_key_pair")]
...
impl ValidatorGenesisConfig {
    pub fn to_validator_info(&self, name: String) -> GenesisValidatorInfo {
        ...
        let info = ValidatorInfo {
            ...
            worker_key,
            network_key,
            account_address: MysAddress::from(&account_key),
...
impl ValidatorGenesisConfigBuilder {
    ...
    pub fn build<R: rand::RngCore + rand::CryptoRng>(self, rng: &mut R) -> ValidatorGenesisConfig {
        ...
        ValidatorGenesisConfig {
            ...
            narwhal_worker_address,
            consensus_address,
            stake: mys_types::governance::VALIDATOR_LOW_STAKE_THRESHOLD_MIST,
            name: None,
        }
    }
}
...
fn default_mys_key_pair() -> MysKeyPair {
    MysKeyPair::Ed25519(get_key_pair_from_rng(&mut rand::rngs::OsRng).1)
}
...
impl GenesisConfig {
    ...
    pub fn for_local_testing_with_addresses(addresses: Vec<MysAddress>) -> Self {
    ...
    pub fn benchmark_gas_keys(n: usize) -> Vec<MysKeyPair> {
        let mut rng = StdRng::seed_from_u64(Self::BENCHMARKS_RNG_SEED);
        (0..n)
            .map(|_| MysKeyPair::Ed25519(NetworkKeyPair::generate(&mut rng)))
            .collect()
    }
