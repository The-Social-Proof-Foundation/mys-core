...
const PRIMARY_COIN_VALUE: u64 = 100 * MIST_PER_MYS;
...
impl Payload for BatchPaymentTestPayload {
    ...
    fn make_transaction(&mut self) -> Transaction {
        let addrs = self.state.addresses().cloned().collect::<Vec<MysAddress>>();
