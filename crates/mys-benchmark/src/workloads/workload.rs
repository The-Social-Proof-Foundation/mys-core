...
pub const MAX_GAS_FOR_TESTING: u64 = 1_000 * MIST_PER_MYS;

// TODO: get this information from protocol config
// This is the maximum budget that can be set for a transaction. 50 MYS.
pub const MAX_BUDGET: u64 = 50 * MIST_PER_MYS;
