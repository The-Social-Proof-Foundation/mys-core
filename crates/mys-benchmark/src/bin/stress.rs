...
use mys_benchmark::workloads::workload_configuration::WorkloadConfiguration;
...
/// it something like:
/// ```cargo run  --release  --package mys-benchmark
...
/// ```cargo run  --release  --package mys-benchmark --bin stress -- --num-client-threads 12 \
/// --num-server-threads 10 \
/// --num-transfer-accounts 2 \
/// --primary-gas-id 0x59931dcac57ba20d75321acaf55e8eb5a2c47e9f \
/// --genesis-blob-path /tmp/genesis.blob \
/// --keystore-path /tmp/mys.keystore bench \
/// --target-qps 100 \
/// --in-flight-ratio 2 \
/// --shared-counter 50 \
/// --transfer-object 50```
