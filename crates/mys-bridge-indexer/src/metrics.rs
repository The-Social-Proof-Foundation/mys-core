...
pub struct BridgeIndexerMetrics {
    pub(crate) total_mys_bridge_transactions: IntCounter,
    pub(crate) total_mys_token_deposited: IntCounter,
    pub(crate) total_mys_token_transfer_approved: IntCounter,
    pub(crate) total_mys_token_transfer_claimed: IntCounter,
    pub(crate) total_mys_bridge_txn_other: IntCounter,
    ...
    pub(crate) last_committed_mys_checkpoint: IntGauge,
...
impl BridgeIndexerMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            total_mys_bridge_transactions: register_int_counter_with_registry!(
                "bridge_indexer_total_mys_bridge_transactions",
                "Total number of mys bridge transactions",
                registry,
            )
            .unwrap(),
            total_mys_token_deposited: register_int_counter_with_registry!(
                "bridge_indexer_total_mys_token_deposited",
                "Total number of mys token deposited transactions",
                registry,
            )
            .unwrap(),
            total_mys_token_transfer_approved: register_int_counter_with_registry!(
                "bridge_indexer_total_mys_token_transfer_approved",
                "Total number of mys token approved transactions",
                registry,
            )
            .unwrap(),
            total_mys_token_transfer_claimed: register_int_counter_with_registry!(
                "bridge_indexer_total_mys_token_transfer_claimed",
                "Total number of mys token claimed transactions",
                registry,
            )
            .unwrap(),
            total_mys_bridge_txn_other: register_int_counter_with_registry!(
                "bridge_indexer_total_mys_bridge_txn_other",
                "Total number of other mys bridge transactions",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            last_committed_mys_checkpoint: register_int_gauge_with_registry!(
                "bridge_indexer_last_committed_mys_checkpoint",
                "The latest mys checkpoint that indexer committed to DB",
                registry,
            )
            .unwrap(),
