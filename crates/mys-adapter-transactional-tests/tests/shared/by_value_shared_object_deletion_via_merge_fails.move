...
module t2::o2 {
    ...
    public fun mint_shared_coin(ctx: &mut TxContext) {
        transfer::public_share_object(coin::zero<MYS>(ctx))
    }
    ...
    public fun mint_owned_coin(ctx: &mut TxContext) {
        transfer::public_transfer(coin::zero<MYS>(ctx), @A)
    }

    public fun deleter(o2: Coin<MYS>) {
        coin::destroy_zero(o2);
    }

    public fun freezer(o2: Coin<MYS>) {
        transfer::public_freeze_object(o2);
    }

    public fun dofer(parent: &mut Obj2, o2: Coin<MYS>) {
        dof::add(&mut parent.id, 0, o2);
    }

    public fun dfer(parent: &mut Obj2, o2: Coin<MYS>) {
        df::add(&mut parent.id, 0, o2);
    }

    public fun transferer(o2: Coin<MYS>) {
        transfer::public_transfer(o2, @0x0);
    }

    public fun sharer(o2: Coin<MYS>) {
