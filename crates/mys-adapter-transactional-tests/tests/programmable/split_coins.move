...
module test::m1 {
    ...
    public fun transfer_(v: vector<coin::Coin<mys::mys::MYS>>, r: address) {
        v.do!(|c| {
...
//# run mys::pay::split_and_transfer --type-args mys::mys::MYS --args object(2,0) 1000 @A --sender A
...
//> 0: test::m1::ret_one_amount();
//> 1: SplitCoins(Input(0), [Result(0), Input(1)]);
//> 2: MakeMoveVec<mys::coin::Coin<mys::mys::MYS>>([NestedResult(1,0), NestedResult(1,1)]);
