...
//> 0: MakeMoveVec<mys::transfer::Receiving<tto::M1::B>>([Input(1), Input(2), Input(3), Input(4)]);
...
//> 1: MakeMoveVec<mys::transfer::Receiving<tto::M1::B>>([Input(1), Input(2), Input(3), Input(4), Result(0)]);

//# programmable --inputs object(2,0) receiving(2,1) receiving(2,2) receiving(2,3) receiving(2,4)
//> 0: tto::M1::make_recv_spoof_b();
//> 1: tto::M1::spoof_bytes(Result(0));
//> 2: MakeMoveVec<mys::transfer::Receiving<tto::M1::B>>([Input(1), Input(2), Input(3), Input(4), Result(1)]);
