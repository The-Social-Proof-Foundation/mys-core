...
module Test_DepDepV1::DepDepM1 {
    ...
    public struct Obj has key, store { id: mys::object::UID, v: u64 }

    public fun foo(ctx: &mut mys::tx_context::TxContext) {
        mys::transfer::share_object(Obj { id: mys::object::new(ctx), v: 42 })
    }
}
...
module Test_DepDepV2::DepDepM1 {
    ...
    public fun foo(ctx: &mut mys::tx_context::TxContext) {
        mys::transfer::share_object(Obj { id: mys::object::new(ctx), v: 7 })
    }
}
...
module Test_DepDepV3::DepDepM1 {
    ...
    public fun foo(ctx: &mut mys::tx_context::TxContext) {
        mys::transfer::share_object(Obj { id: mys::object::new(ctx), v: 0 })
    }
}
...
module Test_DepV1::DepM1 {
    ...
    public fun bar(ctx: &mut mys::tx_context::TxContext) { DepDepM1::foo(ctx) }
}
...
module Test_V1::M1 {
    ...
    public entry fun baz(ctx: &mut mys::tx_context::TxContext) { DepM1::bar(ctx) }
}
