...
module Test_DepV1::DepM1 {
    ...
    public struct DepObj has key, store { id: mys::object::UID, v: u64 }

    public fun foo(ctx: &mut mys::tx_context::TxContext) {
        mys::transfer::share_object(DepObj { id: mys::object::new(ctx), v: 42 });
    }
...
module Test_DepV2::DepM1 {
    ...
    public fun foo(ctx: &mut mys::tx_context::TxContext) {
        mys::transfer::share_object(DepObj { id: mys::object::new(ctx), v: 7 });
    }
...
module Test_V1::M1 {
    ...
    public entry fun bar(ctx: &mut mys::tx_context::TxContext) {
        DepM1::foo(ctx);
    }
