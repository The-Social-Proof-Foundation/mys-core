...
//# run mys::package::only_additive_upgrades --args object(1,1) --sender A
...
//# run mys::package::only_dep_upgrades --args object(1,1) --sender A
...
//# run mys::package::make_immutable --args object(1,1) --sender A
