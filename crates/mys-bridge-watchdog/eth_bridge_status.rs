...
impl EthBridgeStatus {
    pub fn new(
        ...
        let bridge_contract = EthMysBridge::new(bridge_address, provider.clone());
        Self {
            bridge_contract,
            metric,
        }
