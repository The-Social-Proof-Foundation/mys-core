...
#[test_only]
module mys_system::validator_tests {
    use mys::bag;
    use mys::balance;
    ...
    fun test_validator_owner_flow() {
        ...
        let scenario = &mut scenario_val;
        {
            ...
            assert!(validator.mys_address() == sender);
    ...
    fun test_pending_validator_flow() {
        ...
        scenario.next_tx(sender);
        {
            let coin_ids = scenario.ids_for_sender<StakedMys>();
            let stake = scenario.take_from_sender_by_id<StakedMys>(coin_ids[0]);
            let ctx = scenario.ctx();
        ...
        scenario.next_tx(sender);
        {
            ...
            let withdraw = scenario.take_from_sender_by_id<Coin<MYS>>(coin_ids[0]);
    ...
    #[expected_failure(abort_code = mys_system::validator::EInvalidProofOfPossession)]
    #[test]
    ...
    #[expected_failure(abort_code = mys_system::validator::EMetadataInvalidNetPubkey)]
    #[test]
    ...
    #[expected_failure(abort_code = mys_system::validator::EMetadataInvalidWorkerPubkey)]
    #[test]
    ...
    #[expected_failure(abort_code = mys_system::validator::EMetadataInvalidNetAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = mys_system::validator::EMetadataInvalidPrimaryAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = mys_system::validator::EMetadataInvalidWorkerAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = mys_system::validator::EMetadataInvalidP2pAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = mys_system::validator::EValidatorMetadataExceedingLengthLimit)]
    #[test]
