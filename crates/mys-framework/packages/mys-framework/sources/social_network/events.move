...
module mys::events {
    ...
    struct BaseEvent has copy, drop {
        timestamp: u64,
    ...
    struct EntityCreatedEvent has copy, drop {
        base: BaseEvent,
        entity_type: String,
        entity_id: ID,
        creator: address,
    ...
    struct EntityDeletedEvent has copy, drop {
        base: BaseEvent,
        entity_type: String,
        entity_id: ID,
        deleter: address,
    ...
    struct ReputationChangedEvent has copy, drop {
        base: BaseEvent,
        entity_id: ID,
    ...
    struct TokenTransferEvent has copy, drop {
        base: BaseEvent,
        token_id: address,
        from: address,
        to: address,
    ...
    struct TokenTradeEvent has copy, drop {
        base: BaseEvent,
    ...
    struct PostEngagementEvent has copy, drop {
        base: BaseEvent,
        post_id: ID,
        user: address,
