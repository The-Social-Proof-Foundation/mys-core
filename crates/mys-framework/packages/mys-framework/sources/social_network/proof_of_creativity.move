module mys_framework::proof_of_creativity {
    ...
    use mys_framework::my_ip::{Self, MyIP};
    ...
    struct ProofOfCreativity has key, store {
        id: UID,
    ...
    struct VerificationProviderRegistry has key {
        id: UID,
    ...
    struct ProofCreatedEvent has copy, drop {
        poc_id: address,
        creator: address,
        title: String,
        proof_type: u8,
    ...
    struct ProofVerifiedEvent has copy, drop {
        poc_id: address,
        creator: address,
        provider: address,
        verification_state: u8,
    ...
    struct VerificationRequestedEvent has copy, drop {
        request_id: address,
        poc_id: address,
        creator: address,
        provider: address,
