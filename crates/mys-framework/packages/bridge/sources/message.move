...
module bridge::message {
    ...
    public struct AddTokenOnMys has drop {
        native_token: bool,
        token_ids: vector<u8>,
    ...
    public fun extract_add_tokens_on_mys(message: &BridgeMessage): AddTokenOnMys {
        let mut bcs = bcs::new(message.payload);
    ...
    /// [token_prices:vector<u64>]
    public fun create_add_tokens_on_mys_message(
        source_chain: u8,
        seq_num: u64,
        native_token: bool,
        token_ids: vector<u8>,
        ...
        BridgeMessage {
            message_type: message_types::add_tokens_on_mys(),
            message_version: CURRENT_MESSAGE_VERSION,
            seq_num,
            source_chain,
            payload,
    ...
    public fun is_native(self: &AddTokenOnMys): bool {
        self.native_token
    }

    public fun token_ids(self: &AddTokenOnMys): vector<u8> {
        self.token_ids
    }

    public fun token_type_names(self: &AddTokenOnMys): vector<String> {
        self.token_type_names
    }

    public fun token_prices(self: &AddTokenOnMys): vector<u64> {
        self.token_prices
    }
    ...
    #[test_only]
    public(package) fun make_add_token_on_mys(
        native_token: bool,
        token_ids: vector<u8>,
        token_type_names: vector<String>,
        token_prices: vector<u64>,
