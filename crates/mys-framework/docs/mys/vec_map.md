...
<dl>
<dt>
<code>contents: vector&lt;<a href="../mys/vec_map.md#mys_vec_map_Entry">mys::vec_map::Entry</a>&lt;K, V&gt;&gt;</code>
</dt>
<dd>
</dd>
</dl>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_empty">empty</a>&lt;K: <b>copy</b>, V&gt;(): <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt; {
    <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a> { contents: vector[] }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_insert">insert</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: K, value: V) {
    <b>assert</b>!(!self.<a href="../mys/vec_map.md#mys_vec_map_contains">contains</a>(&key), <a href="../mys/vec_map.md#mys_vec_map_EKeyAlreadyExists">EKeyAlreadyExists</a>);
    self.contents.push_back(<a href="../mys/vec_map.md#mys_vec_map_Entry">Entry</a> { key, value })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_remove">remove</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): (K, V) {
    <b>let</b> idx = self.<a href="../mys/vec_map.md#mys_vec_map_get_idx">get_idx</a>(key);
    <b>let</b> <a href="../mys/vec_map.md#mys_vec_map_Entry">Entry</a> { key, value } = self.contents.<a href="../mys/vec_map.md#mys_vec_map_remove">remove</a>(idx);
    (key, value)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_pop">pop</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): (K, V) {
    <b>assert</b>!(self.contents.length() != 0, <a href="../mys/vec_map.md#mys_vec_map_EMapEmpty">EMapEmpty</a>);
    <b>let</b> <a href="../mys/vec_map.md#mys_vec_map_Entry">Entry</a> { key, value } = self.contents.pop_back();
    (key, value)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_get_mut">get_mut</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): &<b>mut</b> V {
    <b>let</b> idx = self.<a href="../mys/vec_map.md#mys_vec_map_get_idx">get_idx</a>(key);
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_get">get</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): &V {
    <b>let</b> idx = self.<a href="../mys/vec_map.md#mys_vec_map_get_idx">get_idx</a>(key);
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_try_get">try_get</a>&lt;K: <b>copy</b>, V: <b>copy</b>&gt;(self: &<a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): Option&lt;V&gt; {
    <b>if</b> (self.<a href="../mys/vec_map.md#mys_vec_map_contains">contains</a>(key)) {
        option::some(*<a href="../mys/vec_map.md#mys_vec_map_get">get</a>(self, key))
    } <b>else</b> {
        option::none()
    }
}
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_contains">contains</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): bool {
    <a href="../mys/vec_map.md#mys_vec_map_get_idx_opt">get_idx_opt</a>(self, key).is_some()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_size">size</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): u64 {
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_is_empty">is_empty</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): bool {
    self.<a href="../mys/vec_map.md#mys_vec_map_size">size</a>() == 0
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_destroy_empty">destroy_empty</a>&lt;K: <b>copy</b>, V&gt;(self: <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;) {
    <b>let</b> <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a> { contents } = self;
    <b>assert</b>!(contents.<a href="../mys/vec_map.md#mys_vec_map_is_empty">is_empty</a>(), <a href="../mys/vec_map.md#mys_vec_map_EMapNotEmpty">EMapNotEmpty</a>);
    contents.<a href="../mys/vec_map.md#mys_vec_map_destroy_empty">destroy_empty</a>()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_into_keys_values">into_keys_values</a>&lt;K: <b>copy</b>, V&gt;(self: <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): (vector&lt;K&gt;, vector&lt;V&gt;) {
    <b>let</b> <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a> { <b>mut</b> contents } = self;
    // reverse the vector so the output <a href="../mys/vec_map.md#mys_vec_map_keys">keys</a> and values will appear in insertion order
    contents.reverse();
    <b>let</b> <b>mut</b> i = 0;
    <b>let</b> n = contents.length();
    <b>let</b> <b>mut</b> <a href="../mys/vec_map.md#mys_vec_map_keys">keys</a> = vector[];
    <b>let</b> <b>mut</b> values = vector[];
    <b>while</b> (i &lt; n) {
        <b>let</b> <a href="../mys/vec_map.md#mys_vec_map_Entry">Entry</a> { key, value } = contents.pop_back();
        <a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>.push_back(key);
        values.push_back(value);
        i = i + 1;
    };
    contents.<a href="../mys/vec_map.md#mys_vec_map_destroy_empty">destroy_empty</a>();
    (<a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>, values)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_from_keys_values">from_keys_values</a>&lt;K: <b>copy</b>, V&gt;(<b>mut</b> <a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>: vector&lt;K&gt;, <b>mut</b> values: vector&lt;V&gt;): <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt; {
    <b>assert</b>!(<a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>.length() == values.length(), <a href="../mys/vec_map.md#mys_vec_map_EUnequalLengths">EUnequalLengths</a>);
    <a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>.reverse();
    values.reverse();
    <b>let</b> <b>mut</b> map = <a href="../mys/vec_map.md#mys_vec_map_empty">empty</a>();
    <b>while</b> (<a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>.length() != 0) map.<a href="../mys/vec_map.md#mys_vec_map_insert">insert</a>(<a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>.pop_back(), values.pop_back());
    <a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>.<a href="../mys/vec_map.md#mys_vec_map_destroy_empty">destroy_empty</a>();
    values.<a href="../mys/vec_map.md#mys_vec_map_destroy_empty">destroy_empty</a>();
    map
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;): vector&lt;K&gt; {
    <b>let</b> <b>mut</b> i = 0;
    <b>let</b> n = self.contents.length();
    <b>let</b> <b>mut</b> <a href="../mys/vec_map.md#mys_vec_map_keys">keys</a> = vector[];
    <b>while</b> (i &lt; n) {
        <b>let</b> <b>entry</b> = self.contents.<a href="../mys/borrow.md#mys_borrow">borrow</a>(i);
        <a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>.push_back(<b>entry</b>.key);
        i = i + 1;
    };
    <a href="../mys/vec_map.md#mys_vec_map_keys">keys</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_get_idx_opt">get_idx_opt</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): Option&lt;u64&gt; {
    <b>let</b> <b>mut</b> i = 0;
    <b>let</b> n = <a href="../mys/vec_map.md#mys_vec_map_size">size</a>(self);
    <b>while</b> (i &lt; n) {
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_get_idx">get_idx</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, key: &K): u64 {
    <b>let</b> idx_opt = self.<a href="../mys/vec_map.md#mys_vec_map_get_idx_opt">get_idx_opt</a>(key);
    <b>assert</b>!(idx_opt.is_some(), <a href="../mys/vec_map.md#mys_vec_map_EKeyDoesNotExist">EKeyDoesNotExist</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_get_entry_by_idx">get_entry_by_idx</a>&lt;K: <b>copy</b>, V&gt;(self: &<a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, idx: u64): (&K, &V) {
    <b>assert</b>!(idx &lt; <a href="../mys/vec_map.md#mys_vec_map_size">size</a>(self), <a href="../mys/vec_map.md#mys_vec_map_EIndexOutOfBounds">EIndexOutOfBounds</a>);
    <b>let</b> <b>entry</b> = &self.contents[idx];
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_get_entry_by_idx_mut">get_entry_by_idx_mut</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, idx: u64): (&K, &<b>mut</b> V) {
    <b>assert</b>!(idx &lt; <a href="../mys/vec_map.md#mys_vec_map_size">size</a>(self), <a href="../mys/vec_map.md#mys_vec_map_EIndexOutOfBounds">EIndexOutOfBounds</a>);
    <b>let</b> <b>entry</b> = &<b>mut</b> self.contents[idx];
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/vec_map.md#mys_vec_map_remove_entry_by_idx">remove_entry_by_idx</a>&lt;K: <b>copy</b>, V&gt;(self: &<b>mut</b> <a href="../mys/vec_map.md#mys_vec_map_VecMap">VecMap</a>&lt;K, V&gt;, idx: u64): (K, V) {
    <b>assert</b>!(idx &lt; <a href="../mys/vec_map.md#mys_vec_map_size">size</a>(self), <a href="../mys/vec_map.md#mys_vec_map_EIndexOutOfBounds">EIndexOutOfBounds</a>);
    <b>let</b> <a href="../mys/vec_map.md#mys_vec_map_Entry">Entry</a> { key, value } = self.contents.<a href="../mys/vec_map.md#mys_vec_map_remove">remove</a>(idx);
    (key, value)
}
