...
<dl>
<dt>
<code><a href="../mys/linked_table.md#mys_linked_table_prev">prev</a>: <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;K&gt;</code>
</dt>
<dd>
 the previous key
</dd>
<dt>
<code><a href="../mys/linked_table.md#mys_linked_table_next">next</a>: <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;K&gt;</code>
</dt>
<dd>
 the next key
</dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_new">new</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(ctx: &<b>mut</b> TxContext): <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt; {
    <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a> {
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_front">front</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): &Option&lt;K&gt; {
    &<a href="../mys/table.md#mys_table">table</a>.head
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_back">back</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): &Option&lt;K&gt; {
    &<a href="../mys/table.md#mys_table">table</a>.tail
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_push_front">push_front</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(
    <a href="../mys/table.md#mys_table">table</a>: &<b>mut</b> <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;,
    k: K,
    value: V,
) {
    <b>let</b> old_head = <a href="../mys/table.md#mys_table">table</a>.head.swap_or_fill(k);
    <b>if</b> (<a href="../mys/table.md#mys_table">table</a>.tail.is_none()) <a href="../mys/table.md#mys_table">table</a>.tail.fill(k);
    <b>let</b> <a href="../mys/linked_table.md#mys_linked_table_prev">prev</a> = option::none();
    <b>let</b> <a href="../mys/linked_table.md#mys_linked_table_next">next</a> = <b>if</b> (old_head.is_some()) {
        <b>let</b> old_head_k = old_head.destroy_some();
        field::borrow_mut&lt;K, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../mys/table.md#mys_table">table</a>.id, old_head_k).<a href="../mys/linked_table.md#mys_linked_table_prev">prev</a> = option::some(k);
        option::some(old_head_k)
    } <b>else</b> {
        option::none()
    };
    field::add(&<b>mut</b> <a href="../mys/table.md#mys_table">table</a>.id, k, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a> { <a href="../mys/linked_table.md#mys_linked_table_prev">prev</a>, <a href="../mys/linked_table.md#mys_linked_table_next">next</a>, value });
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_push_back">push_back</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(
    <a href="../mys/table.md#mys_table">table</a>: &<b>mut</b> <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;,
    k: K,
    value: V,
) {
    <b>if</b> (<a href="../mys/table.md#mys_table">table</a>.head.is_none()) <a href="../mys/table.md#mys_table">table</a>.head.fill(k);
    <b>let</b> old_tail = <a href="../mys/table.md#mys_table">table</a>.tail.swap_or_fill(k);
    <b>let</b> <a href="../mys/linked_table.md#mys_linked_table_prev">prev</a> = <b>if</b> (old_tail.is_some()) {
        <b>let</b> old_tail_k = old_tail.destroy_some();
        field::borrow_mut&lt;K, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../mys/table.md#mys_table">table</a>.id, old_tail_k).<a href="../mys/linked_table.md#mys_linked_table_next">next</a> = option::some(k);
        option::some(old_tail_k)
    } <b>else</b> {
        option::none()
    };
    <b>let</b> <a href="../mys/linked_table.md#mys_linked_table_next">next</a> = option::none();
    field::add(&<b>mut</b> <a href="../mys/table.md#mys_table">table</a>.id, k, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a> { <a href="../mys/linked_table.md#mys_linked_table_prev">prev</a>, <a href="../mys/linked_table.md#mys_linked_table_next">next</a>, value });
    <a href="../mys/table.md#mys_table">table</a>.size = <a href="../mys/table.md#mys_table">table</a>.size + 1;
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/borrow.md#mys_borrow">borrow</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): &V {
    &field::borrow&lt;K, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<a href="../mys/table.md#mys_table">table</a>.id, k).value
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_borrow_mut">borrow_mut</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(
    <a href="../mys/table.md#mys_table">table</a>: &<b>mut</b> <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;,
    k: K,
): &<b>mut</b> V {
    &<b>mut</b> field::borrow_mut&lt;K, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../mys/table.md#mys_table">table</a>.id, k).value
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_prev">prev</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): &Option&lt;K&gt; {
    &field::borrow&lt;K, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<a href="../mys/table.md#mys_table">table</a>.id, k).<a href="../mys/linked_table.md#mys_linked_table_prev">prev</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_next">next</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): &Option&lt;K&gt; {
    &field::borrow&lt;K, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<a href="../mys/table.md#mys_table">table</a>.id, k).<a href="../mys/linked_table.md#mys_linked_table_next">next</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_remove">remove</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<b>mut</b> <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): V {
    <b>let</b> <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a>&lt;K, V&gt; { <a href="../mys/linked_table.md#mys_linked_table_prev">prev</a>, <a href="../mys/linked_table.md#mys_linked_table_next">next</a>, value } = field::remove(&<b>mut</b> <a href="../mys/table.md#mys_table">table</a>.id, k);
    <a href="../mys/table.md#mys_table">table</a>.size = <a href="../mys/table.md#mys_table">table</a>.size - 1;
    <b>if</b> (<a href="../mys/linked_table.md#mys_linked_table_prev">prev</a>.is_some()) {
        field::borrow_mut&lt;K, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../mys/table.md#mys_table">table</a>.id, *<a href="../mys/linked_table.md#mys_linked_table_prev">prev</a>.<a href="../mys/borrow.md#mys_borrow">borrow</a>()).<a href="../mys/linked_table.md#mys_linked_table_next">next</a> = <a href="../mys/linked_table.md#mys_linked_table_next">next</a>
    };
    <b>if</b> (<a href="../mys/linked_table.md#mys_linked_table_next">next</a>.is_some()) {
        field::borrow_mut&lt;K, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="../mys/table.md#mys_table">table</a>.id, *<a href="../mys/linked_table.md#mys_linked_table_next">next</a>.<a href="../mys/borrow.md#mys_borrow">borrow</a>()).<a href="../mys/linked_table.md#mys_linked_table_prev">prev</a> = <a href="../mys/linked_table.md#mys_linked_table_prev">prev</a>
    };
    <b>if</b> (<a href="../mys/table.md#mys_table">table</a>.head.<a href="../mys/borrow.md#mys_borrow">borrow</a>() == &k) <a href="../mys/table.md#mys_table">table</a>.head = <a href="../mys/linked_table.md#mys_linked_table_next">next</a>;
    <b>if</b> (<a href="../mys/table.md#mys_table">table</a>.tail.<a href="../mys/borrow.md#mys_borrow">borrow</a>() == &k) <a href="../mys/table.md#mys_table">table</a>.tail = <a href="../mys/linked_table.md#mys_linked_table_prev">prev</a>;
    value
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_pop_front">pop_front</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<b>mut</b> <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): (K, V) {
    <b>assert</b>!(<a href="../mys/table.md#mys_table">table</a>.head.is_some(), <a href="../mys/linked_table.md#mys_linked_table_ETableIsEmpty">ETableIsEmpty</a>);
    <b>let</b> head = *<a href="../mys/table.md#mys_table">table</a>.head.<a href="../mys/borrow.md#mys_borrow">borrow</a>();
    (head, <a href="../mys/table.md#mys_table">table</a>.<a href="../mys/linked_table.md#mys_linked_table_remove">remove</a>(head))
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_pop_back">pop_back</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<b>mut</b> <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): (K, V) {
    <b>assert</b>!(<a href="../mys/table.md#mys_table">table</a>.tail.is_some(), <a href="../mys/linked_table.md#mys_linked_table_ETableIsEmpty">ETableIsEmpty</a>);
    <b>let</b> tail = *<a href="../mys/table.md#mys_table">table</a>.tail.<a href="../mys/borrow.md#mys_borrow">borrow</a>();
    (tail, <a href="../mys/table.md#mys_table">table</a>.<a href="../mys/linked_table.md#mys_linked_table_remove">remove</a>(tail))
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_contains">contains</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): bool {
    field::exists_with_type&lt;K, <a href="../mys/linked_table.md#mys_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<a href="../mys/table.md#mys_table">table</a>.id, k)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_length">length</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): u64 {
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_is_empty">is_empty</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: &<a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): bool {
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_destroy_empty">destroy_empty</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: store&gt;(<a href="../mys/table.md#mys_table">table</a>: <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;) {
    <b>let</b> <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a> { id, size, head: _, tail: _ } = <a href="../mys/table.md#mys_table">table</a>;
    <b>assert</b>!(size == 0, <a href="../mys/linked_table.md#mys_linked_table_ETableNotEmpty">ETableNotEmpty</a>);
    id.delete()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a>&lt;K: <b>copy</b> + <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store, V: <a href="../mys/linked_table.md#mys_linked_table_drop">drop</a> + store&gt;(<a href="../mys/table.md#mys_table">table</a>: <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;) {
    <b>let</b> <a href="../mys/linked_table.md#mys_linked_table_LinkedTable">LinkedTable</a> { id, size: _, head: _, tail: _ } = <a href="../mys/table.md#mys_table">table</a>;
    id.delete()
}
</code></pre>
