...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../orderbook/custodian.md#orderbook_custodian_new">new</a>&lt;T&gt;(ctx: &<b>mut</b> <a href="../mys/tx_context.md#mys_tx_context_TxContext">mys::tx_context::TxContext</a>): <a href="../orderbook/custodian.md#orderbook_custodian_Custodian">orderbook::custodian::Custodian</a>&lt;T&gt;
</code></pre>
