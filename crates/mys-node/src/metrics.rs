...
/// is configured.
pub fn start_metrics_push_task(config: &mys_config::NodeConfig, registry: RegistryService) {
    use fastcrypto::traits::KeyPair;
    use mys_config::node::MetricsConfig;
...
mod tests {
    ...
    pub async fn test_metrics_endpoint_with_multiple_registries_add_remove() {
        ...
        assert!(result.contains(
            "# HELP mys_counter_2 a sample counter 2
# TYPE mys_counter_2 counter
mys_counter_2 0"
        ));
