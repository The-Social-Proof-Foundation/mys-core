...
pub fn gen_gas_data(sender: MysAddress) -> impl Strategy<Value = GasData> {
    (
...
pub fn transaction_data_gen(sender: MysAddress) -> impl Strategy<Value = TransactionData> {
...
{
    pub fn new(sender: MysAddress) -> Self {
        Self {
            kind: None,
            sender,
            gas_data: None,
