...
fn test_struct_tag_serde() {
    let tag = parse_mys_struct_tag("0x7f89cdffd8968affa0b47bef91adc5314e19509080470c45bfd434cd83a766b::mysfrens::MysFren<0x7f89cdffd8968affa0b47bef91adc5314e19509080470c45bfd434cd83a766b::capy::Capy>").unwrap();
    #[serde_as]
    #[derive(Serialize)]
    struct TestStructTag(#[serde_as(as = "MysStructTag")] StructTag);
    ...
    assert_eq!(json, "0x07f89cdffd8968affa0b47bef91adc5314e19509080470c45bfd434cd83a766b::mysfrens::MysFren<0x07f89cdffd8968affa0b47bef91adc5314e19509080470c45bfd434cd83a766b::capy::Capy>");

    let tag2 = parse_mys_struct_tag(&json).unwrap();
    assert_eq!(tag, tag2);
}
