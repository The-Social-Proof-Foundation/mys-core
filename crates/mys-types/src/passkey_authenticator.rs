...
impl<'de> Deserialize<'de> for PasskeyAuthenticator {
        ...
        D: Deserializer<'de>,
    {
        ...
        serializable
            .try_into()
            .map_err(|e: MysError| Error::custom(e.to_string()))
    }
}
...
impl Serialize for PasskeyAuthenticator {
    ...
    {
        let mut bytes = Vec::with_capacity(Secp256r1MysSignature::LENGTH);
        ...
        let raw = RawPasskeyAuthenticator {
            ...
            user_signature: Signature::Secp256r1MysSignature(
                Secp256r1MysSignature::from_bytes(&bytes).unwrap(),
            ),
        };
...
impl PasskeyAuthenticator {
    ...
    pub fn get_pk(&self) -> MysResult<PublicKey> {
...
impl AuthenticatorTrait for PasskeyAuthenticator {
        ...
        T: Serialize,
    {
        ...
        if author != MysAddress::from(&self.get_pk()?) {
            return Err(MysError::InvalidSignature {
