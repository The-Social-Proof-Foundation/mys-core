...
mod checked {
    ...
    use crate::gas::{self, GasCostSummary, MysGasStatusAPI};
    ...
    /// A list of constant costs of various operations in Mys.
    pub struct MysCostTable {
    ...
    pub struct PerObjectStorage {
        ...
        /// storage_rebate is the storage rebate (in Mys) for in this object.
    ...
    impl MysGasStatus {
        ...
        pub fn new_unmetered() -> MysGasStatus {
            Self::new(
    ...
    impl MysGasStatusAPI for MysGasStatus {
