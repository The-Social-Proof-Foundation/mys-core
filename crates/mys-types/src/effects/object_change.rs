...
use crate::{
    base_types::{MysAddress, VersionDigest},
...
impl AccumulatorAddress {
    pub fn new(address: MysAddress, ty: TypeTag) -> Self {
        Self { address, ty }
    }
}
...
mod tests {
    ...
    fn test_accumulator_address() -> AccumulatorAddress {
        AccumulatorAddress::new(
            ...
            "0x2::balance::Balance<0x2::mys::MYS>".parse().unwrap(),
        )
    }
    ...
    fn test_merge_mismatched_types() {
        let addr = MysAddress::random_for_testing_only();
