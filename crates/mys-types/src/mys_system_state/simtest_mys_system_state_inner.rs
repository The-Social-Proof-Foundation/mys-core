...
use crate::mys_system_state::mys_system_state_summary::{
...
pub struct SimTestMysSystemStateInnerV1 {
    pub epoch: u64,
...
impl MysSystemStateTrait for SimTestMysSystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn into_mys_system_state_summary(self) -> MysSystemStateSummary {
        MysSystemStateSummary::default()
    }
}

#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestMysSystemStateInnerShallowV2 {
...
impl MysSystemStateTrait for SimTestMysSystemStateInnerShallowV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
...
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestMysSystemStateInnerDeepV2 {
    pub new_dummy_field: u64,
    pub epoch: u64,
    pub protocol_version: u64,
    pub system_state_version: u64,
...
impl MysSystemStateTrait for SimTestMysSystemStateInnerDeepV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
