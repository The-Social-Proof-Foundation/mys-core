...
use super::mys_system_state_summary::{MysSystemStateSummary, MysValidatorSummary};
use super::{get_validators_from_table_vec, AdvanceEpochParams, MysSystemStateTrait};
...
/// Rust version of the Move mys::mys_system::SystemParameters type
...
impl VerifiedValidatorMetadataV1 {
    pub fn mys_pubkey_bytes(&self) -> AuthorityPublicKeyBytes {
...
impl ValidatorMetadataV1 {
    ...
    pub fn verify(&self) -> Result<VerifiedValidatorMetadataV1, u64> {
        ...
        verify_proof_of_possession(&pop, &protocol_pubkey, self.mys_address)
            .map_err(|_| E_METADATA_INVALID_POP)?;
...
/// Rust version of the Move mys::validator::Validator type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
...
impl ValidatorV1 {
    ...
    pub fn into_mys_validator_summary(self) -> MysValidatorSummary {
        let Self {
            metadata:
                ValidatorMetadataV1 {
                    mys_address,
            ...
            staking_pool:
                StakingPoolV1 {
                    ...
                    mys_balance: staking_pool_mys_balance,
                    rewards_pool,
                    pool_token_balance,
                    exchange_rates:
                        Table {
...
/// Rust version of the Move mys_system::staking_pool::StakingPool type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct StakingPoolV1 {
    ...
    pub pending_total_mys_withdraw: u64,
    pub pending_pool_token_withdraw: u64,
    pub extra_fields: Bag,
}

/// Rust version of the Move mys_system::validator_set::ValidatorSet type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct ValidatorSetV1 {
    ...
    pub at_risk_validators: VecMap<MysAddress, u64>,
    pub extra_fields: Bag,
}

/// Rust version of the Move mys_system::storage_fund::StorageFund type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
...
/// Rust version of the Move mys_system::mys_system::MysSystemStateInner type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct MysSystemStateInnerV1 {
    pub epoch: u64,
    ...
    pub validator_report_records: VecMap<MysAddress, VecSet<MysAddress>>,
...
impl MysSystemStateTrait for MysSystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn get_current_epoch_committee(&self) -> CommitteeWithNetworkMetadata {
        let validators = self
            ...
            .map(|validator| {
                ...
                let name = verified_metadata.mys_pubkey_bytes();
                (
                    name,
                    (
    ...
    fn into_mys_system_state_summary(self) -> MysSystemStateSummary {
        // If you are making any changes to MysSystemStateV1 or any of its dependent types before
        // mainnet, please also update MysSystemStateSummary and its corresponding TS type.
...
/// Rust version of the Move mys_system::validator_cap::UnverifiedValidatorOperationCap type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct UnverifiedValidatorOperationCapV1 {
    pub id: ObjectID,
    pub authorizer_validator_address: MysAddress,
}
