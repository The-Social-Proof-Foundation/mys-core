...
use super::mys_system_state_inner_v1::ValidatorV1;
use super::mys_system_state_summary::{MysSystemStateSummary, MysValidatorSummary};
use super::{AdvanceEpochParams, MysSystemStateTrait};
...
/// Rust version of the Move mys_system::mys_system::MysSystemStateInnerV2 type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct MysSystemStateInnerV2 {
    pub epoch: u64,
...
impl MysSystemStateTrait for MysSystemStateInnerV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
