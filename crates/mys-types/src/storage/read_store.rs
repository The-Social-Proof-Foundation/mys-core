...
use crate::base_types::{EpochId, ObjectID, ObjectType, SequenceNumber, MysAddress};
...
pub trait RpcIndexes: Send + Sync {
    ...
    fn get_balance(&self, owner: &MysAddress, coin_type: &StructTag)
    -> Result<Option<BalanceInfo>>;

    fn balance_iter(
        &self,
        owner: &MysAddress,
        cursor: Option<(MysAddress, StructTag)>,
...
pub struct EpochInfo {
    ...
    pub system_state: Option<crate::mys_system_state::MysSystemState>,
    // pub end_of_epoch_transaction: Option<TransactionDigest>,
    // pub epoch_commitments: Vec<mys_types::messages_checkpoint::CheckpointCommitment>,
}
