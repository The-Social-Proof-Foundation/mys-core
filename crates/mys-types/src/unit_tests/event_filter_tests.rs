...
use crate::base_types::{ObjectDigest, MysAddress, TransactionDigest};
use crate::event::{Event, EventEnvelope};
use crate::filter::{EventFilter, Filter};
use crate::gas_coin::GasCoin;
use crate::object::OBJECT_START_VERSION;
use crate::{ObjectID, MOVE_STDLIB_ADDRESS, MYS_FRAMEWORK_ADDRESS};
...
fn test_move_event_filter() {
    ...
    let move_event = Event {
        package_id: ObjectID::from(MYS_FRAMEWORK_ADDRESS),
    ...
    let filters = vec![
        ...
        EventFilter::Package(ObjectID::from(MYS_FRAMEWORK_ADDRESS)),
...
fn test_transfer_filter() {
    ...
    let recipient = Owner::AddressOwner(MysAddress::random_for_testing_only());
