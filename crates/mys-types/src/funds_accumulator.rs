...
//! Rust bindings for `mys::funds_accumulator`
...
/// Rust bindings for the Move struct `mys::funds_accumulator::Withdrawal`.
...
impl Withdrawal {
    pub fn new(owner: MysAddress, limit: U256) -> Self {
        Self { owner, limit }
    }
