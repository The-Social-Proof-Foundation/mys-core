...
impl CheckpointSummary {
    ...
    pub fn verify_epoch(&self, epoch: EpochId) -> MysResult {
        fp_ensure!(
            self.epoch == epoch,
            MysError::WrongEpoch {
...
impl CertifiedCheckpointSummary {
    pub fn verify_authority_signatures(&self, committee: &Committee) -> MysResult {
    ...
    pub fn try_into_verified(self, committee: &Committee) -> MysResult<VerifiedCheckpoint> {
    ...
    pub fn verify_with_contents(
        ...
        if let Some(contents) = contents {
            ...
            fp_ensure!(
                ...
                MysError::GenericAuthorityError{error:format!("Checkpoint contents digest mismatch: summary={:?}, received content digest {:?}, received {} transactions", self.data(), content_digest, contents.size())}
            );
        }
...
impl SignedCheckpointSummary {
    ...
    pub fn try_into_verified(
        self,
        committee: &Committee,
    ) -> MysResult<VerifiedEnvelope<CheckpointSummary, AuthoritySignInfo>> {
        self.verify_authority_signatures(committee)?;
...
impl CheckpointSignatureMessage {
    pub fn verify(&self, committee: &Committee) -> MysResult {
