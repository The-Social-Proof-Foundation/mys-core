...
/// The value should be the same in Mys committee.
...
pub struct ConsensusTransaction {
    /// Encodes an u64 unique tracking id to allow us trace a message between Mys and consensus.
...
impl AuthorityCapabilitiesV1 {
    pub fn new(
        ...
        let generation = SystemTime::now()
            ...
            .expect("Mys did not exist prior to 1970")
            .as_millis()
            .try_into()
            .expect("This build of mys is not supported in the year 500,000,000");
        Self {
            authority,
            generation,
            supported_protocol_versions,
...
impl ExecutionTimeObservation {
    pub fn new(
        ...
        let generation = SystemTime::now()
            ...
            .as_micros()
            .try_into()
            .expect("This build of mys is not supported in the year 500,000");
        Self {
            authority,
            generation,
            estimates,
