...
pub enum ExecutionFailureStatus {
    ...
    InsufficientGas,
    #[error("Invalid Gas Object. Possibly not address-owned or possibly not a MYS coin.")]
    InvalidGasObject,
    ...
    #[error(
        "Mys Move Bytecode Verification Error. \
        Please run the Mys Move Verifier for more information."
    )]
    MysMoveVerificationError,
    ...
    #[error(
        "Mys Move Bytecode Verification Timeout. \
        Please run the Mys Move Verifier for more information."
    )]
    MysMoveVerificationTimedout,
