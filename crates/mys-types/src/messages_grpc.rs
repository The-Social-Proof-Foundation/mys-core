...
pub struct ObjectInfoResponse {
    ...
    /// This should be only used for debugging purpose, such as from mys-tool. No prod clients should
    /// rely on it.
...
/// Soft Bundle request.  See [SIP-19](https://github.com/mys-foundation/sips/blob/main/sips/sip-19.md).
#[derive(Clone, Debug, Serialize, Deserialize)]
