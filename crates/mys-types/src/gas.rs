...
pub mod checked {
    ...
    #[enum_dispatch(MysGasStatusAPI)]
    #[derive(Debug)]
    pub enum MysGasStatus {
    ...
    impl MysGasStatus {
        pub fn new(
            ...
            Ok(Self::V2(MysGasStatusV2::new_with_budget(
                gas_budget,
                gas_price,
                reference_gas_price,
                config,
        ...
        pub fn new_unmetered() -> Self {
            Self::V2(MysGasStatusV2::new_unmetered())
        }

        // This is the only public API on MysGasStatus, all other gas related operations should
