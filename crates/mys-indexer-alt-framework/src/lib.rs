...
use mys_indexer_alt_framework_store_traits::Connection;
use mys_indexer_alt_framework_store_traits::Store;
use mys_indexer_alt_framework_store_traits::TransactionalStore;
use mys_indexer_alt_framework_store_traits::pipeline_task;
use tracing::info;
...
pub use mys_futures::service;
/// External users access the store trait through framework::store
pub use mys_indexer_alt_framework_store_traits as store;
...
mod tests {
    ...
    use clap::Parser;
    use mys_indexer_alt_framework_store_traits::PrunerWatermark;
    use mys_synthetic_ingestion::synthetic_ingestion;
    ...
    impl Processor for ControllableHandler {
        ...
        async fn process(
            &self,
            checkpoint: &Arc<mys_types::full_checkpoint_content::Checkpoint>,
