...
use prost::Message;
use mys_futures::future::with_slow_future_monitor;
use mys_rpc::Client;
use mys_rpc::client::HeadersInterceptor;
use mys_rpc::proto::mys::rpc::v2::Checkpoint as ProtoCheckpoint;
use tracing::debug;
use tracing::error;
use tracing::warn;
use url::Url;
...
pub struct IngestionClientArgs {
    ...
    /// Mys fullnode gRPC url to fetch checkpoints from.
    #[arg(long, group = "source")]
