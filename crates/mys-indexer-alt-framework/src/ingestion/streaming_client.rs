...
use mys_rpc::proto::mys::rpc::v2::subscription_service_client::SubscriptionServiceClient;
use tonic::Status;
    ...
    async fn connect(&mut self) -> Result<CheckpointStream> {
        ...
        request.read_mask = Some(prost_types::FieldMask {
            paths: vec![
                ...
                "transactions.transaction.bcs".to_string(),
                "transactions.effects.bcs".to_string(),
                "transactions.effects.unchanged_loaded_runtime_objects".to_string(),
                "transactions.events.bcs".to_string(),
                "objects.objects.bcs".to_string(),
            ],
        });
