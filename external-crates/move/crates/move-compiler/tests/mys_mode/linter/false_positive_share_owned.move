...
module a::cannot_determine_to_be_new {
    ...
    fun make_obj(o: Obj2, ctx: &mut mys::tx_context::TxContext): Obj {
        transfer::transfer(o, @0);
        Obj { id: mys::object::new(ctx) }
    }

    public fun transfer(o2: Obj2, ctx: &mut mys::tx_context::TxContext) {
        let o = make_obj(o2, ctx);
        transfer::transfer(o, mys::tx_context::sender(ctx));
    }

    public fun share(o2: Obj2, ctx: &mut mys::tx_context::TxContext) {
