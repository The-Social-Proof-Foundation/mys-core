...
//! Implements lint to warn against freezing capability-like types in Mys, identifying function calls that may incorrectly freeze such types.
...
const FREEZE_FUNCTIONS: &[(AccountAddress, &str, &str)] = &[
    (MYS_ADDR_VALUE, TRANSFER_MOD_NAME, PUBLIC_FREEZE_FUN),
    (MYS_ADDR_VALUE, TRANSFER_MOD_NAME, FREEZE_FUN),
];
