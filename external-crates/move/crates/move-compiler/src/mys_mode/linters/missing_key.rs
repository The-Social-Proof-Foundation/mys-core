...
use crate::{
    ...
    parser::ast::Ability_,
    mys_mode::{ID_FIELD_NAME, OBJECT_MODULE_NAME, MYS_ADDR_VALUE, UID_TYPE_NAME},
...
simple_visitor!(
    ...
    fn visit_struct_custom(
        ...
        if first_field_has_id_field_of_type_uid(sdef) && lacks_key_ability(sdef) {
            let uid_msg =
                "Struct's first field has an 'id' field of type 'mys::object::UID' but is missing the 'key' ability.";
