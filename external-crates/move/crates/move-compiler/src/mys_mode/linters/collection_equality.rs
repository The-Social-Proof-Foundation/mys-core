...
//! This analysis flags situations when instances of a mys::table::Table or mys::table_vec::TableVec
//! or mys::bag::Bag are being compared for (in)equality at this type of comparison is not very
...
use crate::{
    ...
    parser::ast as P,
    mys_mode::{MYS_ADDR_NAME, MYS_ADDR_VALUE},
...
const COLLECTION_TYPES: &[(Symbol, AccountAddress, &str, &str)] = &[
    (MYS_ADDR_NAME, MYS_ADDR_VALUE, BAG_MOD_NAME, BAG_STRUCT_NAME),
    (
        MYS_ADDR_NAME,
        MYS_ADDR_VALUE,
        OBJECT_BAG_MOD_NAME,
