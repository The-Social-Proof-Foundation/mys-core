...
use crate::{
    ...
    parser::ast::Ability_,
    mys_mode::{MYS_ADDR_VALUE, TX_CONTEXT_MODULE_NAME},
};
...
const TRANSFER_FUNCTIONS: &[(AccountAddress, &str, &str)] = &[
    (MYS_ADDR_VALUE, TRANSFER_MOD_NAME, PUBLIC_TRANSFER_FUN),
    (MYS_ADDR_VALUE, TRANSFER_MOD_NAME, TRANSFER_FUN),
];
...
impl SimpleAbsInt for SelfTransferVerifierAI {
    ...
    fn call_custom(
        ...
        if f.is(&MYS_ADDR_VALUE, TX_CONTEXT_MODULE_NAME, "sender") {
