...
pub const MYS_SOCIAL_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x50c1);
...
pub const MYS_ADDR_NAME: Symbol = symbol!("mys");
...
pub const MYS_MODULE_NAME: Symbol = symbol!("mys");
pub const MYS_OTW_NAME: Symbol = symbol!("MYS");

pub const MYS_SYSTEM_ADDR_NAME: Symbol = symbol!("mys_system");
pub const MYS_SYSTEM_MODULE_NAME: Symbol = symbol!("mys_system");
pub const MYS_SYSTEM_CREATE: Symbol = symbol!("create");
pub const CLOCK_MODULE_NAME: Symbol = symbol!("clock");
pub const CLOCK_TYPE_NAME: Symbol = symbol!("Clock");
pub const MYS_CLOCK_CREATE: Symbol = symbol!("create");
...
pub const MYS_DIAG_PREFIX: &str = "Mys ";
