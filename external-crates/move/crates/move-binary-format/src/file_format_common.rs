...
const _: () = {
    ...
    assert!(BinaryFlavor::mask_and_shift_to_unflavor(x) == BinaryFlavor::MYS_FLAVOR);
};
...
impl BinaryFlavor {
    ...
    // The Mys flavor is 0x05
    pub const MYS_FLAVOR: u8 = 0x05;
    ...
    const fn shift_and_flavor(unflavored: u32) -> u32 {
        (Self::MYS_FLAVOR as u32) << Self::SHIFT_AMOUNT | unflavored
    }
}
