...
language [documentation](https://docs.mysocial.network/concepts/mys-move-concepts). It also provides early-stage
...
your machine - see [here](https://docs.mysocial.network/guides/developer/getting-started/mys-install) for
...
[instructions](https://docs.mysocial.network/guides/developer/getting-started/mys-install#install-mys-binaries-from-source).
...
[here](https://docs.mysocial.network/guides/developer/getting-started/mys-install#additional-prerequisites-by-operating-system)
...
Check [MySocial Developer Forum](https://forums.mysocial.network/c/technical-support) to see if the problem
