...
module prettier::other {
    fun other() {
        let mut fungible_staked_mys_1 = staking_pool.create_fungible_staked_mys_for_testing(
            100_000_000_000,
            scenario.ctx(),
        );
        let fungible_staked_mys_2 = staking_pool.create_fungible_staked_mys_for_testing(
            200_000_000_000,
            scenario.ctx(),
        );
