...
use mys::{balance::{Self, Balance}, coin::{Self, Coin}, event, mys::MYS};
...
/// you pay for it.
public fun new_sword(game: &mut Game, payment: Coin<MYS>, ctx: &mut TxContext): Sword {
...
public fun take_payment(admin: &Admin, game: &mut Game, ctx: &mut TxContext): Coin<MYS> {
