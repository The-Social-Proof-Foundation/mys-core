...
module examples::sword {
    ...
    use mys::token::{Self, Token, ActionRequest};
...
/// MYS and used to buy swords (in the `sword` module).
module examples::gem {
    ...
    /// 10 MYS is the price of a small bundle of Gems.
    const SMALL_BUNDLE: u64 = 10_000_000_000;
    const SMALL_AMOUNT: u64 = 100;

    /// 100 MYS is the price of a medium bundle of Gems.
    const MEDIUM_BUNDLE: u64 = 100_000_000_000;
    const MEDIUM_AMOUNT: u64 = 5_000;

    /// 1000 MYS is the price of a large bundle of Gems.
