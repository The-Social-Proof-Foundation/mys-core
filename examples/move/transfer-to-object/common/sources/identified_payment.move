...
use mys::{coin::{Self, Coin}, dynamic_field, event, mys::MYS, transfer::Receiving};
...
public fun make_payment(payment_id: u64, coin: Coin<MYS>, to: address, ctx: &mut TxContext) {
...
public fun unpack(identified_payment: IdentifiedPayment): (u64, Coin<MYS>) {
...
/// `mys::transfer::receive` function can only be called on the object from
