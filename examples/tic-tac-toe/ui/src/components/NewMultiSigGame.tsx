...
export function NewMultiSigGame(): ReactElement {
	...
	return (
		<>
			...
			/>
			<ComputedField
				value={opponent ? opponent.toMysAddress() : undefined}
			...
			<Em>
				...
				<Text as="div">
					...
					Although addresses on Mys are derived from public keys, the derivation cannot be reversed,
...
/**
 * If `key` is a valid base64 encoded Mys public key, return it as a
