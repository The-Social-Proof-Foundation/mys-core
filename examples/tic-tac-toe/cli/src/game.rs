...
/// Rust representation of a Move `shared::Game`, ttttable for deserializing from their BCS
/// representation.
#[derive(Deserialize)]
...
/// Rust representation of a Move `owned::Game`, ttttable for deserializing from their BCS
/// representation.
#[derive(Deserialize)]
