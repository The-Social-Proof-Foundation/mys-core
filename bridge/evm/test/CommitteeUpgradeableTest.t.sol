...
contract CommitteeUpgradeableTest is BridgeBaseTest {
    ...
    function setUp() public {
        ...
        address _config = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                ...
                (_committee, _chainID, supportedTokens, tokenPrices, tokenIds, mysDecimals, _supportedDestinationChains, address(0))
            ),
            opts
        );
        ...
        address _bridge = Upgrades.deployUUPSProxy(
            "MysBridge.sol",
            abi.encodeCall(MysBridge.initialize, (_committee, address(0), address(0))),
            opts
        );

        bridge = MysBridge(_bridge);
        bridgeV2 = new MockMysBridgeV2();
    }

    function testUpgradeWithSignaturesSuccess() public {
        bytes memory initializer = abi.encodeCall(MockMysBridgeV2.initializeV2, ());
    ...
    function testUpgradeRegressionTestWith1CalldataArg() public {
        ...
        MockMysBridgeV2 newBridgeV2 = MockMysBridgeV2(address(bridge));
    ...
    function testUpgradeRegressionTestWithNoCalldata() public {
        ...
        MockMysBridgeV2(address(bridge));
        assertEq(Upgrades.getImplementationAddress(address(bridge)), address(bridgeV2));
    }
}
