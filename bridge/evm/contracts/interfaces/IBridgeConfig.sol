...
interface IBridgeConfig {
    ...
    function tokenMysDecimalOf(uint8 tokenID) external view returns (uint8);
    ...
    /// @param mysDecimals The added token's decimal places on MySocial.
    ...
    event TokenAdded(uint8 tokenID, address tokenAddress, uint8 mysDecimal, uint64 tokenPrice);
