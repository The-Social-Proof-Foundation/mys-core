...
/// (intended to be the MysBridge contract) to transfer tokens to a target address. It also supports
...
/// transferred to the MysBridge contract after the bridge contract is deployed.
contract BridgeVault is Ownable, IBridgeVault, ReentrancyGuard {
    ...
    /// @dev This function is intended to only be called by the MysBridge contract.
