...
struct MysVerifierMeterBounds {
    name: String,
    ticks: u128,
    max_ticks: Option<u128>,
}

impl MysVerifierMeterBounds {
...
pub struct MysVerifierMeter {
    transaction_bounds: MysVerifierMeterBounds,
    package_bounds: MysVerifierMeterBounds,
    module_bounds: MysVerifierMeterBounds,
    function_bounds: MysVerifierMeterBounds,
}

impl MysVerifierMeter {
    ...
    fn get_bounds_mut(&mut self, scope: Scope) -> &mut MysVerifierMeterBounds {
        match scope {
    ...
    fn get_bounds(&self, scope: Scope) -> &MysVerifierMeterBounds {
        match scope {
...
impl Meter for MysVerifierMeter {
