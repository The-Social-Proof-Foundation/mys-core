...
pub fn all_natives(silent: bool, protocol_config: &ProtocolConfig) -> NativeFunctionTable {
    let mys_framework_natives: &[(&str, &str, NativeFunction)] = &[
    ...
    let mys_framework_natives_iter =
        mys_framework_natives
            .iter()
            .cloned()
    ...
    let mys_system_natives: &[(&str, &str, NativeFunction)] = &[(
        "validator",
    ...
    mys_system_natives
        ...
        .chain(mys_framework_natives_iter)
        ...
        _ => {
            return Err(
                PartialVMError::new(StatusCode::UNKNOWN_INVARIANT_VIOLATION_ERROR)
                    .with_message("Mys verifier guarantees this is a struct".to_string()),
            )
        }
    };
