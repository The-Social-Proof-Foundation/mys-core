...
pub fn secp256k1_sign(
    ...
    // The corresponding Move function, mys::ecdsa_k1::secp256k1_sign, is only used for testing, so
...
pub fn secp256k1_keypair_from_seed(
    ...
    // The corresponding Move function, mys::ecdsa_k1::secp256k1_keypair_from_seed, is only used for
