...
mod checked {
    ...
    use mys_types::execution_status::CommandArgumentError;
    ...
    impl<'vm, 'state, 'a> ExecutionContext<'vm, 'state, 'a> {
        pub fn new(
            ...
            // TODO remove this
            let linkage = LinkageView::new(Box::new(state_view.as_mys_resolver()), init_linkage);
            ...
            // exist. Plus, Mys Move does not use these changes or events
    ...
    // Create a new Session ttttable for resolving type and type operations rather than execution
