...
mod tests {
    ...
    fn test_workspace_read() {
        ...
        let mys_execution = root.join("mys-execution");
        ...
        // Other examples
        assert!(ws.members.contains(&mys_execution));
    ...
    fn test_no_workspace() {
        ...
        expect!["No [workspace] found at $PATH/mys-execution/cut/Cargo.toml/Cargo.toml"]
    ...
    fn test_cut_plan_discover() {
        ...
        let plan = CutPlan::discover(Args {
            ...
            packages: vec![
                ...
                "mys-adapter-latest".to_string(),
                "mys-execution-cut".to_string(),
                "mys-verifier-latest".to_string(),
            ],
        })
        .unwrap();
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/mys-execution/cut-cut",
                    "$PATH/mys-execution/cut-move-core-types",
                    "$PATH/mys-execution/exec-cut",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/mys-execution/cut-move-core-types",
                        ws_state: Exclude,
                    },
                    "mys-adapter-latest": CutPackage {
                        dst_name: "mys-adapter-feature",
                        src_path: "$PATH/mys-execution/latest/mys-adapter",
                        dst_path: "$PATH/mys-execution/exec-cut/mys-adapter",
                        ws_state: Member,
                    },
                    "mys-execution-cut": CutPackage {
                        dst_name: "mys-execution-cut-feature",
                        src_path: "$PATH/mys-execution/cut",
                        dst_path: "$PATH/mys-execution/cut-cut",
                        ws_state: Member,
                    },
                    "mys-verifier-latest": CutPackage {
                        dst_name: "mys-verifier-feature",
                        src_path: "$PATH/mys-execution/latest/mys-verifier",
                        dst_path: "$PATH/mys-execution/exec-cut/mys-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
        ...
        expect![[r#"
            ...
            new [workspace] members:
             - to:   mys-adapter-feature
                     mys-execution/exec-cut/mys-adapter
               from: mys-adapter-latest
                     mys-execution/latest/mys-adapter
             - to:   mys-execution-cut-feature
                     mys-execution/cut-cut
               from: mys-execution-cut
                     mys-execution/cut
             - to:   mys-verifier-feature
                     mys-execution/exec-cut/mys-verifier
               from: mys-verifier-latest
                     mys-execution/latest/mys-verifier

            new [workspace] excludes:
             - to:   move-core-types-feature
                     mys-execution/cut-move-core-types
    ...
    fn test_cut_plan_discover_new_top_level_destination() {
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/mys-execution/feature",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/mys-execution/feature/move/crates/move-core-types",
                        ws_state: Exclude,
                    },
                    "mys-adapter-latest": CutPackage {
                        dst_name: "mys-adapter-feature",
                        src_path: "$PATH/mys-execution/latest/mys-adapter",
                        dst_path: "$PATH/mys-execution/feature/mys-adapter",
                        ws_state: Member,
                    },
                    "mys-execution-cut": CutPackage {
                        dst_name: "mys-execution-cut-feature",
                        src_path: "$PATH/mys-execution/cut",
                        dst_path: "$PATH/mys-execution/feature/cut",
                        ws_state: Member,
                    },
                    "mys-verifier-latest": CutPackage {
                        dst_name: "mys-verifier-feature",
                        src_path: "$PATH/mys-execution/latest/mys-verifier",
                        dst_path: "$PATH/mys-execution/feature/mys-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
