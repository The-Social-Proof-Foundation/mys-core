...
parameters:
  ...
  chain_start_timestamp_ms: 1761670800000 # $(( $(date +%s) * 1000 ))
...
accounts:
  ...
  - address: "$SOCIAL_PROOF_FOUNDATION_ADDRESS"
    gas_amounts:
      - 745200000000000000 # 745,200,000 MySo (24% from the Social Proof Foundation + 51% from the Community - 3 mill from Validators)
  # Core Team
