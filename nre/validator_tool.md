...
3. Run the following command to set up your MySocial account and CLI environment. 
    ...
    If at this point you can't find where `client.yaml` or `mys.keystore` is or have other questions, read [MySocial Client CLI tutorial](https://docs.mysocial.network/devnet/build/cli-client).
